    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                if (!method.equals(H5Param.DEFAULT_LONG_WEBVIEW_OPENURL_METHOD) && !method.equals("HEAD")) {
                    return null;
                }
            } else if (code == 401) {
                ...
                if (code != 503) {
                    if (code == 407) {
                        ...
                        switch (code) {
                            case 300:
                            case KeyList.IntentRequestKey.INTENT_REQUEST_CHOOSE_MEDIA:
                            case KeyList.IntentRequestKey.INTENT_REQUEST_CHOOSE_FILE:
                            case KeyList.IntentRequestKey.INTENT_REQUEST_CHOOSE_AUDIO:
                                break;
                            default:
                                return null;
                        }
