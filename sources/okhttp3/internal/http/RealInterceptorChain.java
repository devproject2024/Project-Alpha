...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public final Interceptor.Chain withConnectTimeout(int i2, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, (long) i2, timeUnit), this.readTimeout, this.writeTimeout);
    }
    ...
    public final Interceptor.Chain withReadTimeout(int i2, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, (long) i2, timeUnit), this.writeTimeout);
    }
    ...
    public final Interceptor.Chain withWriteTimeout(int i2, TimeUnit timeUnit) {
        return new RealInterceptorChain(this.interceptors, this.streamAllocation, this.httpCodec, this.connection, this.index, this.request, this.call, this.eventListener, this.connectTimeout, this.readTimeout, Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, (long) i2, timeUnit));
    }
