...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x00f3:
            ...
            i.v r8 = i.n.b((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            i.e r8 = i.n.a((i.v) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            i.u r8 = i.n.a((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            i.d r8 = i.n.a((i.u) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
    ...
    private Request createTunnel(int i2, int i3, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            } else if (this.source.a().d() && this.sink.a().d()) {
                return null;
            } else {
