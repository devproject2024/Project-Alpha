...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = i.n.a(i.n.a());
         */
        ...
        public void run() {
            ...
            L_0x0033:
                ...
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                i.u r2 = i.n.a()     // Catch:{ all -> 0x0045 }
                i.d r2 = i.n.a((i.u) r2)     // Catch:{ all -> 0x0045 }
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            i.v r1 = r1.source(r2)
            i.e r1 = i.n.a((i.v) r1)
            java.lang.String r2 = r1.r()     // Catch:{ all -> 0x00a5 }
            java.lang.String r3 = r1.r()     // Catch:{ all -> 0x00a5 }
            java.lang.String r4 = r1.r()     // Catch:{ all -> 0x00a5 }
            java.lang.String r5 = r1.r()     // Catch:{ all -> 0x00a5 }
            java.lang.String r6 = r1.r()     // Catch:{ all -> 0x00a5 }
        ...
        L_0x005d:
            ...
            boolean r0 = r1.d()     // Catch:{ all -> 0x00a5 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00a5 }
            goto L_0x0076
        L_0x0070:
            i.d r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a5 }
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        ...
        L_0x0022:
            ...
            i.d r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            i.d r1 = r1.b(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            i.d r1 = r1.j(r2)     // Catch:{ all -> 0x0050 }
            i.d r4 = r1.b(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            i.d r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            i.d r7 = r7.b(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            i.d r7 = r7.j(r8)     // Catch:{ all -> 0x0074 }
            i.d r7 = r7.b(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
    ...
    public final synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        ...
        L_0x0078:
            ...
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r1 = "CLEAN"
            i.d r10 = r10.b(r1)     // Catch:{ all -> 0x00f4 }
            r10.j(r3)     // Catch:{ all -> 0x00f4 }
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x00f4 }
            r10.b(r1)     // Catch:{ all -> 0x00f4 }
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r0.writeLengths(r10)     // Catch:{ all -> 0x00f4 }
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r10.j(r2)     // Catch:{ all -> 0x00f4 }
        ...
        L_0x00b4:
            ...
            i.d r10 = r10.b(r11)     // Catch:{ all -> 0x00f4 }
            r10.j(r3)     // Catch:{ all -> 0x00f4 }
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00f4 }
            r10.b(r11)     // Catch:{ all -> 0x00f4 }
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r10.j(r2)     // Catch:{ all -> 0x00f4 }
        L_0x00d2:
            i.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
    ...
    public final class Editor {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final i.v newSource(int r5) {
            /*
                r4 = this;
                okhttp3.internal.cache.DiskLruCache r0 = okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
            ...
            L_0x0015:
                ...
                i.v r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
            ...
            L_0x002f:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.Editor.newSource(int):i.v");
        }

        public final u newSink(int i2) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
