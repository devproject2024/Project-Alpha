                            ...
                            if (!this.closed) {
                                if (Http2Stream.this.headersQueue.isEmpty() || Http2Stream.this.headersListener == null) {
                                    if (this.readBuffer.f46277b > 0) {
                                        j2 = this.readBuffer.read(cVar, Math.min(j3, this.readBuffer.f46277b));
    ...
    final class FramingSink implements u {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            synchronized (Http2Stream.this) {
                ...
                min = Math.min(Http2Stream.this.bytesLeftInWriteWindow, this.sendBuffer.f46277b);
                Http2Stream.this.bytesLeftInWriteWindow -= min;
            }
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.id, z && min == this.sendBuffer.f46277b, this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0023, code lost:
            if (r8.sendBuffer.f46277b <= 0) goto L_0x0038;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0025, code lost:
            emitFrame(true);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0029, code lost:
            r8.this$0.connection.writeData(r8.this$0.id, true, (i.c) null, 0);
         */
