...
class Huffman {
    ...
    public void encode(i.f r9, i.d r10) throws java.io.IOException {
        /*
            r8 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Huffman.encode(i.f, i.d):void");
    }
    ...
    public byte[] decode(byte[] bArr) {
        ...
        for (byte b3 : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                node = node.children[(b2 >>> (i2 - 8)) & PriceRangeSeekBar.INVALID_POINTER_ID];
        ...
        while (i2 > 0) {
            Node node2 = node.children[(b2 << (8 - i2)) & PriceRangeSeekBar.INVALID_POINTER_ID];
    ...
    static final class Node {
        ...
        Node() {
            this.children = new Node[UpiConstants.REQUEST_OPEN_APP_PERMISSION_READ_SMS];
            this.symbol = 0;
            this.terminalBits = 0;
        }
