...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final synchronized void onReadPing(i.f r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<i.f> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.ws.RealWebSocket.onReadPing(i.f):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized boolean send(i.f r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.ws.RealWebSocket.send(i.f, int):boolean");
    }
    ...
    public final synchronized boolean close(int i2, String str, long j) {
        ...
        if (!this.failed) {
            if (!this.enqueuedClose) {
                ...
                this.messageAndCloseQueue.add(new Close(i2, fVar, j));
                runWriter();
                return true;
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0059, code lost:
        ...
        r0 = i.n.a(r0.newMessageSink(((okhttp3.internal.ws.RealWebSocket.Message) r4).formatOpcode, (long) r1.size()));
        r0.d(r1);
        r0.close();
     */
    ...
    public final boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            java.util.ArrayDeque<i.f> r2 = r11.pongQueue     // Catch:{ all -> 0x00a9 }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00a9 }
            i.f r2 = (i.f) r2     // Catch:{ all -> 0x00a9 }
            r3 = 0
        ...
        L_0x0055:
            ...
            i.f r1 = r1.data     // Catch:{ all -> 0x00a4 }
            ...
            i.u r0 = r0.newMessageSink(r2, r4)     // Catch:{ all -> 0x00a4 }
            i.d r0 = i.n.a((i.u) r0)     // Catch:{ all -> 0x00a4 }
            r0.d(r1)     // Catch:{ all -> 0x00a4 }
        ...
        L_0x0085:
            ...
            i.f r4 = r4.reason     // Catch:{ all -> 0x00a4 }
    ...
    public final void writePingFrame() {
        ...
        L_0x0012:
            ...
            return
        L_0x0045:
            i.f r1 = i.f.EMPTY     // Catch:{ IOException -> 0x004b }
