...
public final class Util {
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String str;
        if (httpUrl.host().contains(AppConstants.COLON)) {
            str = "[" + httpUrl.host() + "]";
        } else {
            str = httpUrl.host();
        }
        ...
        return str + AppConstants.COLON + httpUrl.port();
    }
    ...
    public static Charset bomAwareCharset(e eVar, Charset charset) throws IOException {
        if (eVar.a(0, UTF_8_BOM)) {
            eVar.i((long) UTF_8_BOM.size());
            return UTF_8;
        } else if (eVar.a(0, UTF_16_BE_BOM)) {
            eVar.i((long) UTF_16_BE_BOM.size());
            return UTF_16_BE;
        } else if (eVar.a(0, UTF_16_LE_BOM)) {
            eVar.i((long) UTF_16_LE_BOM.size());
            return UTF_16_LE;
        } else if (eVar.a(0, UTF_32_BE_BOM)) {
            eVar.i((long) UTF_32_BE_BOM.size());
            return UTF_32_BE;
        } else if (!eVar.a(0, UTF_32_LE_BOM)) {
            return charset;
        } else {
            eVar.i((long) UTF_32_LE_BOM.size());
            return UTF_32_LE;
        }
    }
