...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public final Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (charAt == 65535 || charAt == c3 || charAt == '/' || charAt == '\\' || charAt == c2) {
                        ...
                        if (!z) {
                            ...
                            if (i6 != i2) {
                                this.encodedPassword = HttpUrl.canonicalize(str, i6 + 1, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                z = true;
                            }
                            z2 = true;
                        } else {
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i3, portColonOffset2) + '\"');
                }
            } else {
        ...
        private void push(String str, int i2, int i3, boolean z, boolean z2) {
            String canonicalize = HttpUrl.canonicalize(str, i2, i3, HttpUrl.PATH_SEGMENT_ENCODE_SET, z2, false, false, true, (Charset) null);
        ...
        private static int parsePort(String str, int i2, int i3) {
            try {
                int parseInt = Integer.parseInt(HttpUrl.canonicalize(str, i2, i3, "", false, false, false, true, (Charset) null));
    ...
    static void percentDecode(c cVar, String str, int i2, int i3, boolean z) {
        int i4;
        while (i2 < i3) {
    ...
    static String canonicalize(String str, int i2, int i3, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i5 < i4) {
            ...
            int i6 = i2;
            cVar.b(str, i2, i5);
            canonicalize(cVar, str, i5, i3, str2, z, z2, z3, z4, charset);
            return cVar.q();
        }
        int i7 = i2;
        return str.substring(i2, i3);
    ...
    static void canonicalize(c cVar, String str, int i2, int i3, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        c cVar2 = null;
        while (i2 < i3) {
            int codePointAt = str.codePointAt(i2);
