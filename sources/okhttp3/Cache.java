...
public final class Cache implements Closeable, Flushable {
    ...
    static final class Entry {
        ...
        public final void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            a2.b(this.url).j(10);
            a2.b(this.requestMethod).j(10);
            a2.n((long) this.varyHeaders.size()).j(10);
            int size = this.varyHeaders.size();
            for (int i2 = 0; i2 < size; i2++) {
                a2.b(this.varyHeaders.name(i2)).b(": ").b(this.varyHeaders.value(i2)).j(10);
            }
            a2.b(new StatusLine(this.protocol, this.code, this.message).toString()).j(10);
            a2.n((long) (this.responseHeaders.size() + 2)).j(10);
            int size2 = this.responseHeaders.size();
            for (int i3 = 0; i3 < size2; i3++) {
                a2.b(this.responseHeaders.name(i3)).b(": ").b(this.responseHeaders.value(i3)).j(10);
            }
            a2.b(SENT_MILLIS).b(": ").n(this.sentRequestMillis).j(10);
            a2.b(RECEIVED_MILLIS).b(": ").n(this.receivedResponseMillis).j(10);
            if (isHttps()) {
                a2.j(10);
                a2.b(this.handshake.cipherSuite().javaName()).j(10);
                writeCertList(a2, this.handshake.peerCertificates());
                writeCertList(a2, this.handshake.localCertificates());
                a2.b(this.handshake.tlsVersion().javaName()).j(10);
            }
            a2.close();
        }
        ...
        private void writeCertList(d dVar, List<Certificate> list) throws IOException {
            try {
                dVar.n((long) list.size()).j(10);
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    dVar.b(f.of(list.get(i2).getEncoded()).base64()).j(10);
                }
