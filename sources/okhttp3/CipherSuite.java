...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", Constants.ACTION_INCORRECT_OTP);
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = init("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", Constants.ACTION_NB_NEXT_BTN_CLICKED);
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", PriceRangeSeekBar.INVALID_POINTER_ID);
    ...
    public static final CipherSuite TLS_RSA_WITH_AES_128_GCM_SHA256 = init("TLS_RSA_WITH_AES_128_GCM_SHA256", Constants.ACTION_DELAY_PASSWORD_FOUND);
    ...
    public static final CipherSuite TLS_RSA_WITH_AES_256_GCM_SHA384 = init("TLS_RSA_WITH_AES_256_GCM_SHA384", Constants.ACTION_SAVE_CUST_ID);
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", H5Param.WEBVIEW_FONT_SIZE_LARGER);
