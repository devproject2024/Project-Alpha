...
public abstract class BaseDaoImpl<T, ID> implements Dao<T, ID> {
            ...
            return ((Integer) callBatchTasks(new Callable<Integer>() {
                public Integer call() throws SQLException {
                    ...
                    for (Object create : collection) {
                        i2 += BaseDaoImpl.this.statementExecutor.create(readWriteConnection, create, BaseDaoImpl.this.objectCache);
                    }
    ...
    public GenericRawResults<String[]> queryRaw(String str, String... strArr) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not perform raw query for ".concat(String.valueOf(str)), e2);
        }
    }
    ...
    public long queryRawValue(String str, String... strArr) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not perform raw value query for ".concat(String.valueOf(str)), e2);
        } catch (Throwable th) {
            this.connectionSource.releaseConnection(readOnlyConnection);
            throw th;
        }
    ...
    public int executeRaw(String str, String... strArr) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not run raw execute statement ".concat(String.valueOf(str)), e2);
        } catch (Throwable th) {
            this.connectionSource.releaseConnection(readWriteConnection);
            throw th;
        }
    ...
    public int updateRaw(String str, String... strArr) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not run raw update statement ".concat(String.valueOf(str)), e2);
        } catch (Throwable th) {
            this.connectionSource.releaseConnection(readWriteConnection);
            throw th;
        }
