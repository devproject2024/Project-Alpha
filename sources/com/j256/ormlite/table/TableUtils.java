...
public class TableUtils {
        ...
        for (String next : list) {
            ...
            try {
                ...
                try {
                    ...
                    logger.info("executing create table after-query got {} results: {}", (Object) Integer.valueOf(i3), (Object) next);
    ...
    private static <T, ID> void addCreateTableStatements(DatabaseType databaseType, TableInfo<T, ID> tableInfo, List<String> list, List<String> list2, boolean z) throws SQLException {
        ...
        boolean z3 = z;
        StringBuilder sb = new StringBuilder(UpiConstants.REQUEST_OPEN_APP_PERMISSION_READ_SMS);
