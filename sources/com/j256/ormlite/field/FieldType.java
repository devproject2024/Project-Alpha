                    ...
                    try {
                        ...
                        if (invoke != null) {
                            try {
                                ...
                                throw SqlExceptionUtil.create("Could not cast result of static getSingleton method to DataPersister from class ".concat(String.valueOf(persisterClass)), e2);
                            }
                        } else {
                        ...
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class ".concat(String.valueOf(persisterClass)), e3.getTargetException());
                    } catch (Exception e4) {
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class ".concat(String.valueOf(persisterClass)), e4);
                    }
                } catch (Exception e5) {
                    throw SqlExceptionUtil.create("Could not find getSingleton static method on class ".concat(String.valueOf(persisterClass)), e5);
                }
            }
        } else {
    ...
    public <FV> FV extractRawJavaFieldValue(Object obj) throws SQLException {
        ...
        if (method == null) {
            try {
                ...
                throw SqlExceptionUtil.create("Could not get field value for ".concat(String.valueOf(this)), e2);
            }
        } else {
            try {
