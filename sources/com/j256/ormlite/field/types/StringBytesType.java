...
public class StringBytesType extends BaseDataType {
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not convert default string: ".concat(String.valueOf(str)), e2);
        }
    }
    ...
    public Object sqlArgToJava(FieldType fieldType, Object obj, int i2) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not convert string with charset name: ".concat(String.valueOf(charsetName)), e2);
        }
    }
