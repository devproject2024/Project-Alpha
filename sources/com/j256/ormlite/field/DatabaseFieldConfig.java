...
public class DatabaseFieldConfig {
    ...
    public DatabaseFieldConfig(String str, String str2, DataType dataType2, String str3, int i2, boolean z, boolean z2, boolean z3, String str4, boolean z4, DatabaseTableConfig<?> databaseTableConfig, boolean z5, Enum<?> enumR, boolean z6, String str5, boolean z7, String str6, String str7, boolean z8, int i3, int i4) {
        this.fieldName = str;
    ...
    public static Method findGetMethod(Field field, boolean z) throws IllegalArgumentException {
        ...
        if (Locale.ENGLISH.equals(Locale.getDefault())) {
            method = findMethodFromNames(field, true, z, methodFromField(field, "get", (Locale) null), methodFromField(field, "is", (Locale) null));
        } else {
            method = findMethodFromNames(field, true, z, methodFromField(field, "get", (Locale) null), methodFromField(field, "get", Locale.ENGLISH), methodFromField(field, "is", (Locale) null), methodFromField(field, "is", Locale.ENGLISH));
        }
        if (method == null) {
            return null;
        }
        ...
        throw new IllegalArgumentException("Return type of get method " + method.getName() + " does not return " + field.getType());
    }
    ...
    public static Method findSetMethod(Field field, boolean z) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException("Return type of set method " + method.getName() + " returns " + method.getReturnType() + " instead of void");
    }
