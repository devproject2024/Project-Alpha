...
public class DatabaseTableConfigUtil {
    ...
    private static int[] lookupClasses() {
        /*
            ...
            java.lang.Class r1 = java.lang.Class.forName(r1)     // Catch:{  }
            java.lang.Class<?> r2 = annotationFactoryClazz     // Catch:{ ClassNotFoundException -> 0x008b }
            java.lang.String r3 = "elements"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r3)     // Catch:{ ClassNotFoundException -> 0x008b }
            elementsField = r2     // Catch:{ ClassNotFoundException -> 0x008b }
            r3 = 1
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008b }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x008b }
            java.lang.String r4 = "name"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x008b }
            nameField = r2     // Catch:{ ClassNotFoundException -> 0x008b }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008b }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x008b }
            java.lang.String r4 = "value"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x008b }
            valueField = r2     // Catch:{ ClassNotFoundException -> 0x008b }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008b }
    ...
    private static int configFieldNameToNum(String str) {
        ...
        if (str.equals(H5StartParamManager.index)) {
            return 17;
        }
    ...
    private static void assignConfigField(int i2, DatabaseFieldConfig databaseFieldConfig, Field field, Object obj) {
        switch (i2) {
            ...
            case 29:
                ...
                return;
            default:
                throw new IllegalStateException("Could not find support for DatabaseField number ".concat(String.valueOf(i2)));
        }
    }
