...
public class StatementExecutor<T, ID> implements GenericRowMapper<String[]> {
    ...
    public com.j256.ormlite.stmt.SelectIterator<T, ID> buildIterator(com.j256.ormlite.dao.BaseDaoImpl<T, ID> r17, com.j256.ormlite.support.ConnectionSource r18, com.j256.ormlite.stmt.PreparedStmt<T> r19, com.j256.ormlite.dao.ObjectCache r20, int r21) throws java.sql.SQLException {
        /*
            ...
            r14 = 0
            com.j256.ormlite.stmt.StatementBuilder$StatementType r0 = com.j256.ormlite.stmt.StatementBuilder.StatementType.SELECT     // Catch:{ all -> 0x003b }
            r5 = r19
            r2 = r21
            com.j256.ormlite.support.CompiledStatement r15 = r5.compile(r13, r0, r2)     // Catch:{ all -> 0x003b }
        ...
        L_0x003b:
            ...
            r15 = r14
        L_0x003d:
            com.j256.ormlite.misc.IOUtils.closeThrowSqlException(r15, r12)
    ...
    public com.j256.ormlite.dao.GenericRawResults<java.lang.String[]> queryRaw(com.j256.ormlite.support.ConnectionSource r17, java.lang.String r18, java.lang.String[] r19, com.j256.ormlite.dao.ObjectCache r20) throws java.sql.SQLException {
        ...
        L_0x001b:
            ...
            r14 = 0
            com.j256.ormlite.stmt.StatementBuilder$StatementType r5 = com.j256.ormlite.stmt.StatementBuilder.StatementType.SELECT     // Catch:{ all -> 0x004e }
            com.j256.ormlite.field.FieldType[] r6 = noFieldTypes     // Catch:{ all -> 0x004e }
            r7 = -1
            r8 = 0
            r3 = r13
            r4 = r18
            com.j256.ormlite.support.CompiledStatement r15 = r3.compileStatement(r4, r5, r6, r7, r8)     // Catch:{ all -> 0x004e }
        ...
        L_0x004e:
            ...
            r15 = r14
        L_0x0050:
            com.j256.ormlite.misc.IOUtils.closeThrowSqlException(r15, r11)
    ...
    public <UO> com.j256.ormlite.dao.GenericRawResults<UO> queryRaw(com.j256.ormlite.support.ConnectionSource r17, java.lang.String r18, com.j256.ormlite.dao.RawRowMapper<UO> r19, java.lang.String[] r20, com.j256.ormlite.dao.ObjectCache r21) throws java.sql.SQLException {
        ...
        L_0x001b:
            ...
            r14 = 0
            com.j256.ormlite.stmt.StatementBuilder$StatementType r6 = com.j256.ormlite.stmt.StatementBuilder.StatementType.SELECT     // Catch:{ all -> 0x0053 }
            com.j256.ormlite.field.FieldType[] r7 = noFieldTypes     // Catch:{ all -> 0x0053 }
            r8 = -1
            r9 = 0
            r4 = r13
            r5 = r18
            com.j256.ormlite.support.CompiledStatement r15 = r4.compileStatement(r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0053 }
    ...
    public <UO> com.j256.ormlite.dao.GenericRawResults<UO> queryRaw(com.j256.ormlite.support.ConnectionSource r17, java.lang.String r18, com.j256.ormlite.field.DataType[] r19, com.j256.ormlite.dao.RawRowObjectMapper<UO> r20, java.lang.String[] r21, com.j256.ormlite.dao.ObjectCache r22) throws java.sql.SQLException {
        ...
        L_0x001b:
            ...
            com.j256.ormlite.support.DatabaseConnection r13 = r10.getReadOnlyConnection(r2)
            r14 = 0
            com.j256.ormlite.stmt.StatementBuilder$StatementType r6 = com.j256.ormlite.stmt.StatementBuilder.StatementType.SELECT     // Catch:{ all -> 0x0055 }
            com.j256.ormlite.field.FieldType[] r7 = noFieldTypes     // Catch:{ all -> 0x0055 }
            r8 = -1
            r9 = 0
            r4 = r13
            r5 = r18
            com.j256.ormlite.support.CompiledStatement r15 = r4.compileStatement(r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0055 }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private <CT> CT doCallBatchTasks(com.j256.ormlite.support.DatabaseConnection r5, boolean r6, java.util.concurrent.Callable<CT> r7) throws java.sql.SQLException {
        /*
            r4 = this;
            java.lang.String r0 = "re-enabled auto-commit on table {} after batch tasks"
            com.j256.ormlite.db.DatabaseType r1 = r4.databaseType
            boolean r1 = r1.isBatchUseTransaction()
            if (r1 == 0) goto L_0x0011
            com.j256.ormlite.db.DatabaseType r0 = r4.databaseType
            java.lang.Object r5 = com.j256.ormlite.misc.TransactionManager.callInTransaction(r5, r6, r0, r7)
            return r5
        L_0x0011:
            r6 = 0
            r1 = 1
            boolean r2 = r5.isAutoCommitSupported()     // Catch:{ all -> 0x0054 }
            if (r2 == 0) goto L_0x0035
            boolean r2 = r5.isAutoCommit()     // Catch:{ all -> 0x0054 }
            if (r2 == 0) goto L_0x0035
            r5.setAutoCommit(r6)     // Catch:{ all -> 0x0054 }
            ...
            com.j256.ormlite.table.TableInfo<T, ID> r3 = r4.tableInfo     // Catch:{ all -> 0x0031 }
            java.lang.String r3 = r3.getTableName()     // Catch:{ all -> 0x0031 }
            r6.debug((java.lang.String) r2, (java.lang.Object) r3)     // Catch:{ all -> 0x0031 }
            r6 = 1
            goto L_0x0035
        L_0x0031:
            r6 = move-exception
            ...
            goto L_0x0055
        L_0x0035:
            java.lang.Object r7 = r7.call()     // Catch:{ SQLException -> 0x0052, Exception -> 0x004a }
            if (r6 == 0) goto L_0x0049
            r5.setAutoCommit(r1)
            com.j256.ormlite.logger.Logger r5 = logger
            com.j256.ormlite.table.TableInfo<T, ID> r6 = r4.tableInfo
            java.lang.String r6 = r6.getTableName()
            r5.debug((java.lang.String) r0, (java.lang.Object) r6)
        L_0x0049:
            return r7
        L_0x004a:
            r7 = move-exception
            java.lang.String r2 = "Batch tasks callable threw non-SQL exception"
            java.sql.SQLException r7 = com.j256.ormlite.misc.SqlExceptionUtil.create(r2, r7)     // Catch:{ all -> 0x0054 }
        ...
        public UO mapRow(DatabaseResults databaseResults) throws SQLException {
            ...
            for (int i2 = 0; i2 < columnCount; i2++) {
                ...
                if (i2 >= dataTypeArr.length) {
                    ...
                    objArr[i2] = dataTypeArr[i2].getDataPersister().resultToJava((FieldType) null, databaseResults, i2);
                }
            }
    ...
    static class ObjectArrayRowMapper implements GenericRowMapper<Object[]> {
        ...
        public Object[] mapRow(DatabaseResults databaseResults) throws SQLException {
            ...
            for (int i2 = 0; i2 < columnCount; i2++) {
                ...
                objArr[i2] = dataType.getDataPersister().resultToJava((FieldType) null, databaseResults, i2);
            }
            return objArr;
        }
    }
