...
final class p {
    ...
    private static final c.a f6045a = c.a.a("x", "y");
    ...
    static int a(c cVar) throws IOException {
        ...
        cVar.b();
        return Color.argb(PriceRangeSeekBar.INVALID_POINTER_ID, k, k2, k3);
    }

    static List<PointF> a(c cVar, float f2) throws IOException {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f6046a = new int[c.b.values().length];
    ...
    static PointF b(c cVar, float f2) throws IOException {
        int i2 = AnonymousClass1.f6046a[cVar.f().ordinal()];
        if (i2 == 1) {
            return c(cVar, f2);
        }
        if (i2 == 2) {
    ...
    private static PointF c(c cVar, float f2) throws IOException {
    ...
    private static PointF d(c cVar, float f2) throws IOException {
        cVar.a();
        float k = (float) cVar.k();
        float k2 = (float) cVar.k();
    ...
    private static PointF e(c cVar, float f2) throws IOException {
        cVar.c();
        float f3 = 0.0f;
        float f4 = 0.0f;
        while (cVar.e()) {
            int a2 = cVar.a(f6045a);
            if (a2 == 0) {
                f3 = b(cVar);
            } else if (a2 != 1) {
                cVar.h();
    ...
    static float b(c cVar) throws IOException {
        c.b f2 = cVar.f();
        int i2 = AnonymousClass1.f6046a[f2.ordinal()];
        if (i2 == 1) {
            return (float) cVar.k();
        }
        if (i2 == 2) {
