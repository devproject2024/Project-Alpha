...
public class BasicNetwork implements Network {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00c1, code lost:
        ...
        r1 = new java.lang.Object[]{java.lang.Integer.valueOf(r0), r29.getUrl()};
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x0130, code lost:
        attemptRetryOnException(com.paytm.contactsSdk.constant.ContactsConstant.NETWORK, r8, new com.android.volley.NetworkError());
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:75:0x0142 A[ExcHandler: MalformedURLException (r0v1 'e' java.net.MalformedURLException A[CUSTOM_DECLARE]), Splitter:B:2:0x000e] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:86:0x013c A[SYNTHETIC] */
    ...
    public com.android.volley.NetworkResponse performRequest(com.android.volley.Request<?> r29) throws com.android.volley.VolleyError {
        ...
        L_0x0008:
            ...
            r11 = 0
            r2 = 0
            com.android.volley.Cache$Entry r0 = r29.getCacheEntry()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ba }
            java.util.Map r0 = r7.getCacheHeaders(r0)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ba }
            com.android.volley.toolbox.BaseHttpStack r3 = r7.mBaseHttpStack     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ba }
            com.android.volley.toolbox.HttpResponse r12 = r3.executeRequest(r8, r0)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ba }
            int r14 = r12.getStatusCode()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00b5 }
            java.util.List r13 = r12.getHeaders()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00b5 }
            r0 = 304(0x130, float:4.26E-43)
            if (r14 != r0) goto L_0x0063
            com.android.volley.Cache$Entry r0 = r29.getCacheEntry()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            if (r0 != 0) goto L_0x0043
            com.android.volley.NetworkResponse r0 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            r16 = 304(0x130, float:4.26E-43)
            r17 = 0
            r18 = 1
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            long r19 = r3 - r9
            r15 = r0
            r21 = r13
            r15.<init>((int) r16, (byte[]) r17, (boolean) r18, (long) r19, (java.util.List<com.android.volley.Header>) r21)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            return r0
        L_0x0043:
            java.util.List r27 = combineHeaders(r13, r0)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            com.android.volley.NetworkResponse r1 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            r22 = 304(0x130, float:4.26E-43)
            byte[] r0 = r0.data     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            r24 = 1
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            long r25 = r3 - r9
            r21 = r1
            r23 = r0
            r21.<init>((int) r22, (byte[]) r23, (boolean) r24, (long) r25, (java.util.List<com.android.volley.Header>) r27)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            return r1
        L_0x005d:
            r0 = move-exception
            r15 = r2
            ...
            goto L_0x00bf
        L_0x0063:
            java.io.InputStream r0 = r12.getContent()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00b2 }
            if (r0 == 0) goto L_0x0072
            int r1 = r12.getContentLength()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            byte[] r0 = r7.inputStreamToBytes(r0, r1)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x005d }
            goto L_0x0074
        L_0x0072:
            byte[] r0 = new byte[r11]     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00b2 }
        L_0x0074:
            r20 = r0
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ab }
            long r2 = r0 - r9
            r1 = r28
            r4 = r29
            r5 = r20
            r6 = r14
            r1.logSlowRequests(r2, r4, r5, r6)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ab }
            r0 = 200(0xc8, float:2.8E-43)
            if (r14 < r0) goto L_0x00a2
            r0 = 299(0x12b, float:4.19E-43)
            if (r14 > r0) goto L_0x00a2
            com.android.volley.NetworkResponse r0 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ab }
            r16 = 0
            long r1 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00ab }
            long r17 = r1 - r9
            r1 = r13
            r13 = r0
            r15 = r20
            r19 = r1
            r13.<init>((int) r14, (byte[]) r15, (boolean) r16, (long) r17, (java.util.List<com.android.volley.Header>) r19)     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00a9 }
            return r0
        L_0x00a2:
            r1 = r13
            java.io.IOException r0 = new java.io.IOException     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00a9 }
            r0.<init>()     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00a9 }
            throw r0     // Catch:{ SocketTimeoutException -> 0x015b, MalformedURLException -> 0x0142, IOException -> 0x00a9 }
        L_0x00a9:
            r0 = move-exception
            goto L_0x00ad
        L_0x00ab:
    ...
    private void logSlowRequests(long j, Request<?> request, byte[] bArr, int i2) {
        if (DEBUG || j > 3000) {
    ...
    public void logError(String str, String str2, long j) {
        Object[] objArr = {str, Long.valueOf(SystemClock.elapsedRealtime() - j), str2};
    }
    ...
    private byte[] inputStreamToBytes(InputStream inputStream, int i2) throws IOException, ServerError {
        ...
        if (inputStream != null) {
            try {
                bArr = this.mPool.getBuf(TarConstants.EOF_BLOCK);
                while (true) {
