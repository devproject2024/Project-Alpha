...
public final class HashingSink extends ForwardingSink {
    ...
    public final void write(Buffer buffer, long j) throws IOException {
        ...
        long j2 = 0;
        while (j2 < j) {
            int min = (int) Math.min(j - j2, (long) (dVar.f45275c - dVar.f45274b));
            MessageDigest messageDigest2 = this.messageDigest;
            if (messageDigest2 != null) {
                messageDigest2.update(dVar.f45273a, dVar.f45274b, min);
            } else {
                this.mac.update(dVar.f45273a, dVar.f45274b, min);
            }
            j2 += (long) min;
            dVar = dVar.f45278f;
        }
