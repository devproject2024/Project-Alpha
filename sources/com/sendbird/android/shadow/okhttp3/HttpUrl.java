...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private void resolvePath(java.lang.String r11, int r12, int r13) {
            ...
            L_0x002a:
                ...
                int r12 = com.sendbird.android.shadow.okhttp3.internal.Util.delimiterOffset((java.lang.String) r11, (int) r6, (int) r13, (java.lang.String) r12)
    ...
    static String canonicalize(String str, int i2, int i3, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i5 < i4) {
            ...
            canonicalize(buffer, str, i5, i3, str2, z, z2, z3, z4, charset);
            return buffer.readUtf8();
        }
        int i7 = i2;
        return str.substring(i2, i3);
