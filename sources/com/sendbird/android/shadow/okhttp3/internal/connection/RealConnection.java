...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    public final void connect(int r17, int r18, int r19, int r20, boolean r21, com.sendbird.android.shadow.okhttp3.Call r22, com.sendbird.android.shadow.okhttp3.EventListener r23) {
        /*
            r16 = this;
            r7 = r16
            r8 = r22
            r9 = r23
            com.sendbird.android.shadow.okhttp3.Protocol r0 = r7.protocol
            if (r0 != 0) goto L_0x014e
            com.sendbird.android.shadow.okhttp3.Route r0 = r7.route
            com.sendbird.android.shadow.okhttp3.Address r0 = r0.address()
            java.util.List r0 = r0.connectionSpecs()
            com.sendbird.android.shadow.okhttp3.internal.connection.ConnectionSpecSelector r10 = new com.sendbird.android.shadow.okhttp3.internal.connection.ConnectionSpecSelector
            r10.<init>(r0)
            com.sendbird.android.shadow.okhttp3.Route r1 = r7.route
            com.sendbird.android.shadow.okhttp3.Address r1 = r1.address()
            javax.net.ssl.SSLSocketFactory r1 = r1.sslSocketFactory()
            if (r1 != 0) goto L_0x0071
            com.sendbird.android.shadow.okhttp3.ConnectionSpec r1 = com.sendbird.android.shadow.okhttp3.ConnectionSpec.CLEARTEXT
            boolean r0 = r0.contains(r1)
            if (r0 == 0) goto L_0x0064
            com.sendbird.android.shadow.okhttp3.Route r0 = r7.route
            com.sendbird.android.shadow.okhttp3.Address r0 = r0.address()
            com.sendbird.android.shadow.okhttp3.HttpUrl r0 = r0.url()
            java.lang.String r0 = r0.host()
            com.sendbird.android.shadow.okhttp3.internal.platform.Platform r1 = com.sendbird.android.shadow.okhttp3.internal.platform.Platform.get()
            boolean r1 = r1.isCleartextTrafficPermitted(r0)
            if (r1 == 0) goto L_0x0046
            goto L_0x0083
        L_0x0046:
            com.sendbird.android.shadow.okhttp3.internal.connection.RouteException r1 = new com.sendbird.android.shadow.okhttp3.internal.connection.RouteException
            ...
            throw r1
        L_0x0064:
            com.sendbird.android.shadow.okhttp3.internal.connection.RouteException r0 = new com.sendbird.android.shadow.okhttp3.internal.connection.RouteException
        ...
        L_0x0071:
            ...
            com.sendbird.android.shadow.okhttp3.Protocol r1 = com.sendbird.android.shadow.okhttp3.Protocol.H2_PRIOR_KNOWLEDGE
            boolean r0 = r0.contains(r1)
        ...
        L_0x0083:
            ...
            r12 = r11
        L_0x0085:
            com.sendbird.android.shadow.okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f6 }
        ...
        L_0x00ad:
            ...
            com.sendbird.android.shadow.okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f2 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00f2 }
            com.sendbird.android.shadow.okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00f2 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00f2 }
            com.sendbird.android.shadow.okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00f2 }
        ...
        L_0x00d0:
            ...
            throw r1
        L_0x00dd:
            com.sendbird.android.shadow.okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection
            if (r0 == 0) goto L_0x00f1
            com.sendbird.android.shadow.okhttp3.ConnectionPool r1 = r7.connectionPool
            monitor-enter(r1)
            com.sendbird.android.shadow.okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00ee }
        ...
        L_0x00fd:
            ...
            com.sendbird.android.shadow.okhttp3.internal.Util.closeQuietly((java.net.Socket) r1)
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void connectTls(com.sendbird.android.shadow.okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            r7 = this;
            com.sendbird.android.shadow.okhttp3.Route r0 = r7.route
            com.sendbird.android.shadow.okhttp3.Address r0 = r0.address()
            ...
            com.sendbird.android.shadow.okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012c }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x012c }
            com.sendbird.android.shadow.okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x012c }
            ...
            com.sendbird.android.shadow.okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            if (r3 == 0) goto L_0x0041
            com.sendbird.android.shadow.okhttp3.internal.platform.Platform r3 = com.sendbird.android.shadow.okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
        ...
        L_0x0041:
            ...
            com.sendbird.android.shadow.okhttp3.Handshake r4 = com.sendbird.android.shadow.okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            ...
            com.sendbird.android.shadow.okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.lang.String r0 = com.sendbird.android.shadow.okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            r4.append(r0)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.util.List r8 = com.sendbird.android.shadow.okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
        ...
        L_0x00d2:
            com.sendbird.android.shadow.okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            ...
            com.sendbird.android.shadow.okhttp3.internal.platform.Platform r8 = com.sendbird.android.shadow.okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
        ...
        L_0x00f3:
            ...
            com.sendbird.android.shadow.okio.Source r8 = com.sendbird.android.shadow.okio.Okio.source((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okio.BufferedSource r8 = com.sendbird.android.shadow.okio.Okio.buffer((com.sendbird.android.shadow.okio.Source) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okio.Sink r8 = com.sendbird.android.shadow.okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            com.sendbird.android.shadow.okio.BufferedSink r8 = com.sendbird.android.shadow.okio.Okio.buffer((com.sendbird.android.shadow.okio.Sink) r8)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            if (r2 == 0) goto L_0x0116
            com.sendbird.android.shadow.okhttp3.Protocol r8 = com.sendbird.android.shadow.okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            goto L_0x0118
        L_0x0116:
            com.sendbird.android.shadow.okhttp3.Protocol r8 = com.sendbird.android.shadow.okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
        L_0x0118:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x0126, all -> 0x0124 }
            if (r1 == 0) goto L_0x0123
            com.sendbird.android.shadow.okhttp3.internal.platform.Platform r8 = com.sendbird.android.shadow.okhttp3.internal.platform.Platform.get()
        ...
        L_0x012c:
            r8 = move-exception
        L_0x012d:
            boolean r0 = com.sendbird.android.shadow.okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x0129 }
        ...
        L_0x013a:
            ...
            com.sendbird.android.shadow.okhttp3.internal.platform.Platform r0 = com.sendbird.android.shadow.okhttp3.internal.platform.Platform.get()
            r0.afterHandshake(r1)
        L_0x0143:
            com.sendbird.android.shadow.okhttp3.internal.Util.closeQuietly((java.net.Socket) r1)
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sendbird.android.shadow.okhttp3.internal.connection.RealConnection.connectTls(com.sendbird.android.shadow.okhttp3.internal.connection.ConnectionSpecSelector):void");
    }
    ...
    public final RealWebSocket.Streams newWebSocketStreams(final StreamAllocation streamAllocation) {
        return new RealWebSocket.Streams(this.source, this.sink) {
