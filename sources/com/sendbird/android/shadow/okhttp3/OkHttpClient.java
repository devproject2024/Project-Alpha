...
public class OkHttpClient implements Call.Factory, WebSocket.Factory, Cloneable {
    ...
    static {
        Internal.instance = new Internal() {
            ...
            public final StreamAllocation streamAllocation(Call call) {
                return ((a) call).f45040b.streamAllocation();
            }
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.callTimeout = 0;
            this.connectTimeout = AppConstants.START_OTP_FLOW;
            this.readTimeout = AppConstants.START_OTP_FLOW;
            this.writeTimeout = AppConstants.START_OTP_FLOW;
            this.pingInterval = 0;
        }
        ...
        public final Builder callTimeout(long j, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, j, timeUnit);
            return this;
        }

        public final Builder callTimeout(Duration duration) {
            this.callTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public final Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, j, timeUnit);
            return this;
        }

        public final Builder connectTimeout(Duration duration) {
            this.connectTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public final Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, j, timeUnit);
            return this;
        }

        public final Builder readTimeout(Duration duration) {
            this.readTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public final Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, j, timeUnit);
            return this;
        }

        public final Builder writeTimeout(Duration duration) {
            this.writeTimeout = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public final Builder pingInterval(long j, TimeUnit timeUnit) {
            this.pingInterval = Util.checkDuration(StringSet.interval, j, timeUnit);
            return this;
        }

        public final Builder pingInterval(Duration duration) {
            this.pingInterval = Util.checkDuration(H5RpcPlugin.RpcRequest.RpcParam.TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
