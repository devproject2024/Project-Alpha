...
final class BitmapUtils {
    ...
    static com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.RotateBitmapResult rotateBitmapByExif(android.graphics.Bitmap r1, android.content.Context r2, android.net.Uri r3) {
        /*
            r0 = 0
            ...
            androidx.exifinterface.a.a r3 = new androidx.exifinterface.a.a     // Catch:{ Exception -> 0x0016 }
            r3.<init>((java.io.InputStream) r2)     // Catch:{ Exception -> 0x0016 }
        ...
        L_0x0017:
            ...
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$RotateBitmapResult r1 = rotateBitmapByExif(r1, r3)
            return r1
        L_0x001e:
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$RotateBitmapResult r2 = new com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$RotateBitmapResult
            r3 = 0
            r2.<init>(r1, r3)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.rotateBitmapByExif(android.graphics.Bitmap, android.content.Context, android.net.Uri):com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$RotateBitmapResult");
    }

    static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, a aVar) {
        int a2 = aVar.a("Orientation");
        return new RotateBitmapResult(bitmap, a2 != 3 ? a2 != 6 ? a2 != 8 ? 0 : 270 : 90 : AppConstants.READ_TIME_OUT);
    }

    static BitmapSampled decodeSampledBitmap(Context context, Uri uri, int i2, int i3) {
        try {
    ...
    static BitmapSampled cropBitmapObjectHandleOOM(Bitmap bitmap, float[] fArr, int i2, boolean z, int i3, int i4, boolean z2, boolean z3) {
        int i5 = 1;
        do {
            try {
                return new BitmapSampled(cropBitmapObjectWithScale(bitmap, fArr, i2, z, i3, i4, 1.0f / ((float) i5), z2, z3), i5);
    ...
    private static Bitmap cropBitmapObjectWithScale(Bitmap bitmap, float[] fArr, int i2, boolean z, int i3, int i4, float f2, boolean z2, boolean z3) {
        Bitmap bitmap2 = bitmap;
        int i5 = i2;
        float f3 = f2;
        Rect rectFromPoints = getRectFromPoints(fArr, bitmap.getWidth(), bitmap.getHeight(), z, i3, i4);
        ...
        return i5 % 90 != 0 ? cropForRotatedImage(createBitmap, fArr, rectFromPoints, i2, z, i3, i4) : createBitmap;
    }

    static BitmapSampled cropBitmap(Context context, Uri uri, float[] fArr, int i2, int i3, int i4, boolean z, int i5, int i6, int i7, int i8, boolean z2, boolean z3) {
        OutOfMemoryError outOfMemoryError;
        int i9 = 1;
        do {
            try {
                return cropBitmap(context, uri, fArr, i2, i3, i4, z, i5, i6, i7, i8, z2, z3, i9);
            } catch (OutOfMemoryError e2) {
                outOfMemoryError = e2;
                i9 *= 2;
                if (i9 > 16) {
    ...
    static Rect getRectFromPoints(float[] fArr, int i2, int i3, boolean z, int i4, int i5) {
        Rect rect = new Rect(Math.round(Math.max(0.0f, getRectLeft(fArr))), Math.round(Math.max(0.0f, getRectTop(fArr))), Math.round(Math.min((float) i2, getRectRight(fArr))), Math.round(Math.min((float) i3, getRectBottom(fArr))));
        if (z) {
    ...
    private static void fixRectForAspectRatio(Rect rect, int i2, int i3) {
    ...
    static void writeBitmapToUri(Context context, Bitmap bitmap, Uri uri, Bitmap.CompressFormat compressFormat, int i2) throws FileNotFoundException {
    ...
    static Bitmap resizeBitmap(Bitmap bitmap, int i2, int i3, CropImageView.RequestSizeOptions requestSizeOptions) {
        if (i2 > 0 && i3 > 0) {
            try {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.BitmapSampled cropBitmap(android.content.Context r14, android.net.Uri r15, float[] r16, int r17, int r18, int r19, boolean r20, int r21, int r22, int r23, int r24, boolean r25, boolean r26, int r27) {
        /*
            r0 = r17
            r1 = r16
            r2 = r18
        ...
        L_0x0026:
            ...
            r6 = r11
            r7 = r27
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled r2 = decodeSampledBitmapRegion(r2, r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x0038 }
        ...
        L_0x0057:
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled r0 = new com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled
            r0.<init>(r10, r8)
            return r0
        L_0x005d:
            r0 = move-exception
        ...
        L_0x0067:
            ...
            r7 = r22
            r8 = r27
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled r0 = cropBitmap((android.content.Context) r1, (android.net.Uri) r2, (float[]) r3, (int) r4, (boolean) r5, (int) r6, (int) r7, (int) r8, (android.graphics.Rect) r9, (int) r10, (int) r11, (boolean) r12, (boolean) r13)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.cropBitmap(android.content.Context, android.net.Uri, float[], int, int, int, boolean, int, int, int, int, boolean, boolean, int):com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled");
    }

    private static BitmapSampled cropBitmap(Context context, Uri uri, float[] fArr, int i2, boolean z, int i3, int i4, int i5, Rect rect, int i6, int i7, boolean z2, boolean z3) {
        Bitmap decodeImage;
        Uri uri2 = uri;
        float[] fArr2 = fArr;
        Bitmap bitmap = null;
        try {
            ...
            int calculateInSampleSizeByReqestedSize = calculateInSampleSizeByReqestedSize(rect.width(), rect.height(), i6, i7) * i5;
            ...
            if (decodeImage != null) {
                ...
                bitmap = cropBitmapObjectWithScale(decodeImage, fArr3, i2, z, i3, i4, 1.0f, z2, z3);
    ...
    private static android.graphics.Bitmap decodeImage(android.content.ContentResolver r2, android.net.Uri r3, android.graphics.BitmapFactory.Options r4) throws java.io.FileNotFoundException {
        ...
        L_0x0031:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.decodeImage(android.content.ContentResolver, android.net.Uri, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.BitmapSampled decodeSampledBitmapRegion(android.content.Context r4, android.net.Uri r5, android.graphics.Rect r6, int r7, int r8, int r9) {
        /*
            r0 = 0
        ...
        L_0x0023:
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled r8 = new com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled     // Catch:{ OutOfMemoryError -> 0x003b }
        ...
        L_0x003b:
            ...
            r7.recycle()
        L_0x004f:
            com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled r4 = new com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled
            r5 = 1
            r4.<init>(r0, r5)
            return r4
        L_0x0056:
        ...
        L_0x008c:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils.decodeSampledBitmapRegion(android.content.Context, android.net.Uri, android.graphics.Rect, int, int, int):com.sheroes.final_sdk.appliedlife.pvtltd.SHEROES.views.cutomeviews.BitmapUtils$BitmapSampled");
    }

    private static Bitmap cropForRotatedImage(Bitmap bitmap, float[] fArr, Rect rect, int i2, boolean z, int i3, int i4) {
        int i5;
        int i6;
        int i7;
        if (i2 % 90 == 0) {
    ...
    private static Bitmap rotateAndFlipBitmapInt(Bitmap bitmap, int i2, boolean z, boolean z2) {
        if (i2 <= 0 && !z && !z2) {
            return bitmap;
        }
        Matrix matrix = new Matrix();
    ...
    static final class BitmapSampled {
        ...
        BitmapSampled(Bitmap bitmap2, int i2) {
            this.bitmap = bitmap2;
            this.sampleSize = i2;
        }
    }
    ...
    static final class RotateBitmapResult {
        ...
        RotateBitmapResult(Bitmap bitmap2, int i2) {
            this.bitmap = bitmap2;
            this.degrees = i2;
        }
    }
