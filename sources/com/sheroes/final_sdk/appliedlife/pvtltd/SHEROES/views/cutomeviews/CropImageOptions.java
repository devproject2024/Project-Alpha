...
public class CropImageOptions implements Parcelable {
    ...
    public CropImageOptions() {
        ...
        this.borderLineColor = Color.argb(170, PriceRangeSeekBar.INVALID_POINTER_ID, PriceRangeSeekBar.INVALID_POINTER_ID, PriceRangeSeekBar.INVALID_POINTER_ID);
        ...
        this.guidelinesColor = Color.argb(170, PriceRangeSeekBar.INVALID_POINTER_ID, PriceRangeSeekBar.INVALID_POINTER_ID, PriceRangeSeekBar.INVALID_POINTER_ID);
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        TextUtils.writeToParcel(this.activityTitle, parcel, i2);
        ...
        parcel.writeParcelable(this.initialCropWindowRectangle, i2);
    ...
    public void validate() {
        if (this.maxZoom < 0) {
            ...
            float f2 = this.initialCropWindowPaddingRatio;
            if (f2 < 0.0f || ((double) f2) >= 0.5d) {
                ...
                if (i2 >= 0) {
                    ...
                    } else if (this.maxCropResultWidth < i2) {
                        throw new IllegalArgumentException("Cannot set max crop result width to smaller value than min crop result width");
                    } else if (this.maxCropResultHeight < i3) {
