...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, Result> {
    ...
    public BitmapLoadingWorkerTask(CropImageView cropImageView, Uri uri) {
        ...
        this.mWidth = (int) (((double) displayMetrics.widthPixels) * d2);
        this.mHeight = (int) (((double) displayMetrics.heightPixels) * d2);
    }
    ...
    public final Result doInBackground(Void... voidArr) {
        try {
            ...
            return new Result(this.mUri, e2);
        }
    }
    ...
    public static final class Result {
        ...
        Result(Uri uri2, Bitmap bitmap2, int i2, int i3) {
            this.uri = uri2;
            this.bitmap = bitmap2;
