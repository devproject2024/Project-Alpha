...
public class DialogUtility {
    ...
    public static void showDialog(Context context, String str, String str2, DialogInterface.OnClickListener onClickListener) {
        try {
            ...
            aVar.a((CharSequence) context.getString(R.string.mp_ok), onClickListener);
            aVar.b();
        } catch (Exception e2) {
    ...
    public static void showDialog(Context context, String str, String str2) {
        try {
            ...
            aVar.a((CharSequence) str);
            aVar.b((CharSequence) str2);
            aVar.a((CharSequence) context.getString(R.string.mp_ok), (DialogInterface.OnClickListener) null);
            aVar.b();
        } catch (Exception e2) {
            LogUtility.e(LOG_TAG, "error showing dialog");
            LogUtility.printStackTrace(e2);
    ...
    public static void showAlert(Context context, String str, String str2) {
        if (!isDialogShowing && !((Activity) context).isFinishing()) {
            ...
            aVar.a((CharSequence) context.getResources().getString(R.string.mp_ok), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
