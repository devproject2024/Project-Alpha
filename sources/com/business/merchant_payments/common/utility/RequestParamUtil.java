...
public class RequestParamUtil {
    ...
    public static HashMap<String, Object> getAuthDefaultHeaders(Context context) {
        ...
        c.a aVar3 = c.f7365a;
        hashMap.put("sim1", c.a.b(context));
        ...
        hashMap.put("language", b.a((Context) PaymentsConfig.getInstance().getApplication()));
        hashMap.put("applanguage", b.a((Context) PaymentsConfig.getInstance().getApplication()));
    ...
    public static HashMap<String, Object> getUPSHeaders(UUID uuid) {
        ...
        hashMap.put("Content-Type", "application/json");
        c.a aVar = c.f7365a;
        hashMap.put("deviceId", c.a.b(appContext));
