...
public class DateUtility {
    ...
    public static String getBWalletDetailDateHeader(String str) {
        ...
        if (str2.equalsIgnoreCase(valueOf) && str3.equalsIgnoreCase(displayName) && str4.equalsIgnoreCase(valueOf2)) {
            return PaymentsConfig.getInstance().getAppContext().getString(R.string.mp_today) + ", " + addSuffixToDate(str4) + " " + str3;
            ...
            return PaymentsConfig.getInstance().getAppContext().getString(R.string.mp_yesterday) + ", " + addSuffixToDate(str4) + " " + str3;
        }
    }
    ...
    public static String getTransactionListDateHeader(String str) {
        ...
        String valueOf4 = String.valueOf(instance2.get(5));
        if (str2.equalsIgnoreCase(valueOf) && displayName.equalsIgnoreCase(displayName2) && str4.equalsIgnoreCase(valueOf2)) {
            return PaymentsConfig.getInstance().getAppContext().getString(R.string.mp_today).toUpperCase() + ", " + addSuffixToDate(str4) + " " + displayName;
        } else if (!str2.equalsIgnoreCase(valueOf3) || !displayName.equalsIgnoreCase(displayName3) || !str4.equalsIgnoreCase(valueOf4)) {
            return addSuffixToDate(str4) + " " + displayName;
        } else {
            return PaymentsConfig.getInstance().getAppContext().getString(R.string.mp_yesterday).toUpperCase() + ", " + addSuffixToDate(str4) + " " + displayName;
        }
    }
    ...
    public static String getThisMonthRange(Context context) {
        ...
        return "(" + firstDateOfMonth + " " + context.getResources().getString(R.string.mp_to) + " " + currentFormattedDate + ")";
    }
    ...
    public static String getRelativeTimeTwoDaysFormat(String str, String str2, Context context) {
        ...
        try {
            ...
            if (i2 == 0) {
                ...
                if (j >= 0 && j < 60) {
                    return j + " " + context.getResources().getString(R.string.mp_sec_ago);
                } else if (j2 >= 0 && j2 < 60) {
                    return j2 + " " + context.getResources().getString(R.string.mp_min_ago);
                } else if (j3 > 0 && j3 == 1) {
                    return j3 + " " + context.getResources().getString(R.string.mp_hr_ago);
                } else if (j3 > 1) {
                    return j3 + " " + context.getResources().getString(R.string.mp_hrs_ago);
                } else {
                    return formattedDate + ", " + getFormattedDate(str5, "HH:mm:ss", "hh:mm a");
                }
            } else if (i2 == 1) {
                return context.getResources().getString(R.string.mp_yesterday_at) + " " + getFormattedDate(str5, "HH:mm:ss", "hh:mm a");
            } else {
                return formattedDate + ", " + getFormattedDate(str5, "HH:mm:ss", "hh:mm a");
            }
        } catch (Exception e2) {
    ...
    public static String getWeek() {
        ...
        return formattedDate + " " + PaymentsConfig.getInstance().getAppContext().getResources().getString(R.string.mp_to) + " " + formattedDate2;
    }
    ...
    public static String getWeek(String str) {
        ...
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat("dd", getAppLocale());
        return simpleDateFormat2.format(currentWeekDates.get(0)) + "-" + simpleDateFormat.format(currentWeekDates.get(1));
    }
    ...
    public static boolean checkDateIsTodayDate(long j) {
        Date date = new Date(j);
        Calendar instance = Calendar.getInstance();
        Calendar instance2 = Calendar.getInstance();
        instance2.setTime(date);
        if (instance.get(1) == instance2.get(1) && instance.get(2) == instance2.get(2) && instance.get(6) == instance2.get(6)) {
            return true;
        }
        return false;
    }
