...
public class ErrorUtil {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0031, code lost:
        if (r0.equalsIgnoreCase(com.business.merchant_payments.common.utility.AppConstants.INVALID_TOKEN) != false) goto L_0x0043;
     */
    ...
    public static void handleAPIError(java.lang.String r5, java.lang.String r6, retrofit2.Response<?> r7, java.lang.String r8, java.lang.Throwable r9, boolean r10) {
        ...
        L_0x00bf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.business.merchant_payments.common.ErrorUtil.handleAPIError(java.lang.String, java.lang.String, retrofit2.Response, java.lang.String, java.lang.Throwable, boolean):void");
    }
    ...
    public static String getErrorMessage(Response<?> response, Throwable th) {
        ...
        if (response != null) {
            ...
            if (code != 400) {
                if (code != 401) {
                    if (code == 403) {
                        str = appContext.getString(R.string.mp_error_msg_403);
                    } else if (code == 404) {
                        str = appContext.getString(R.string.mp_error_msg_404);
                    } else if (code == 408) {
                        str = appContext.getString(R.string.mp_error_msg_408);
                    } else if (code != 410) {
                        if (code == 429) {
                            str = appContext.getString(R.string.mp_error_msg_429);
                        } else if (code == 500) {
                            str = appContext.getString(R.string.mp_error_msg_500);
                        } else if (code != 503) {
                            str = appContext.getString(R.string.mp_something_went_wrong);
                        } else {
                            str = appContext.getString(R.string.mp_error_msg_503);
                        }
                    }
                }
                str = appContext.getString(R.string.mp_error_msg_401);
            } else {
                str = appContext.getString(R.string.mp_error_msg_400);
            }
            return str + " " + appContext.getString(R.string.mp_lbl_please_try_again_later);
        } else if (th instanceof UnknownHostException) {
            return appContext.getString(R.string.mp_error_msg_unknown_host);
        } else {
            if (th instanceof SocketTimeoutException) {
                return appContext.getString(R.string.mp_error_msg_socket_timeout);
            }
            return appContext.getString(R.string.mp_error_msg_default);
        }
    }
    ...
    public static boolean handleInvalidToken(Response<?> response) {
        ...
        boolean z = false;
        if (response != null) {
            if (response.code() == 401 || (response.code() == 400 && (parseError = parseError(response)) != null && parseError.equalsIgnoreCase(com.business.merchant_payments.common.utility.AppConstants.INVALID_TOKEN))) {
                z = true;
            }
            if (z) {
    ...
    public static boolean handleInvalidToken(String str, Response<?> response) {
        ...
        if (!TextUtils.isEmpty(str) && response != null) {
            if (response.code() == 401 || (!str.equals("UMP") || response.code() != 400 ? !(!str.equals("GG") || response.code() != 410) : !((parseError = parseError(response)) == null || !parseError.equalsIgnoreCase(com.business.merchant_payments.common.utility.AppConstants.INVALID_TOKEN)))) {
                z = true;
            }
            if (z) {
                c.a().c(new e((String) null));
