...
public class CustomRadioGroup extends LinearLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.MpCustomRadioGroup, 0, 0);
        try {
            this.mCheckedId = obtainStyledAttributes.getResourceId(R.styleable.MpCustomRadioGroup_RadioCheckedId, -1);
        } finally {
