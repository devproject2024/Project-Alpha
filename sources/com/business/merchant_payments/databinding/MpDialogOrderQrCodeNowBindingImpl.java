...
public class MpDialogOrderQrCodeNowBindingImpl extends MpDialogOrderQrCodeNowBinding implements OnCheckedChangeListener.Listener {
    public static final ViewDataBinding.b sIncludes = null;
    public static final SparseIntArray sViewsWithIds;
    public final CompoundButton.OnCheckedChangeListener mCallback10;
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_standee, 3);
        ...
        sViewsWithIds.put(R.id.btn_order_now, 10);
        sViewsWithIds.put(R.id.btn_do_it_later, 11);
        sViewsWithIds.put(R.id.view_dont_ask_again, 12);
    }

    public MpDialogOrderQrCodeNowBindingImpl(e eVar, View view) {
        this(eVar, view, ViewDataBinding.mapBindings(eVar, view, 13, sIncludes, sViewsWithIds));
    }

    public MpDialogOrderQrCodeNowBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.checkDontAskAgain.setOnCheckedChangeListener(this.mCallback10);
        }
    }
    ...
    public final void _internalCallbackOnCheckedChanged(int i2, CompoundButton compoundButton, boolean z) {
        ...
        if (homeDialogsManager != null) {
            homeDialogsManager.checkChangeListener(1, z);
        }
    }
}
