...
public class MpPaymentsHomeHeaderBindingImpl extends MpPaymentsHomeHeaderBinding {
    ...
    public MpPaymentsHomeHeaderBindingImpl(e eVar, View view) {
        this(eVar, view, ViewDataBinding.mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    public MpPaymentsHomeHeaderBindingImpl(e eVar, View view, Object[] objArr) {
