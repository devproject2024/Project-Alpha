...
public final class CustomDialogUtils$Companion$showCustomActionDialog$6 implements View.OnClickListener {
    ...
    public final /* synthetic */ a $negativeAction;
    public final /* synthetic */ String $negativeText;

    public CustomDialogUtils$Companion$showCustomActionDialog$6(a aVar, Dialog dialog, boolean z, String str, String str2, String str3) {
    ...
    public final void onClick(View view) {
        ...
        if (this.$isFireGaEvent) {
            ...
            singleInstance.sendEvent(instance.getAppContext(), this.$gaEventCategory, this.$gaEventAction, "", this.$negativeText);
        }
    }
}
