...
import com.business.merchant_payments.databinding.MpReversalDetailsViewNewBinding;
...
public class ReversalDetailsActivity extends BaseActivity {
    ...
    public MpReversalDetailsViewNewBinding refundDetailsBinding;
    public ReversalDetailsViewModel refundDetailsViewModel;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.refundDetailsBinding.ivClose.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                ReversalDetailsActivity.this.lambda$onCreate$0$ReversalDetailsActivity(view);
            }
        });
    ...
    public /* synthetic */ void lambda$onCreate$0$ReversalDetailsActivity(View view) {
        finish();
    }
    ...
    private void showSnackBar(String str) {
        ...
        if (this.retryCount > 0) {
            this.failureSnackBar = Snackbar.a((View) this.refundDetailsBinding.coordinatorLayout, (CharSequence) getApplicationContext().getString(R.string.mp_something_wrong_try_later), -2);
        } else {
            this.failureSnackBar = Snackbar.a((View) this.refundDetailsBinding.coordinatorLayout, (CharSequence) str, -2).a((CharSequence) getString(R.string.retry), (View.OnClickListener) new View.OnClickListener() {
                public final void onClick(View view) {
                    ReversalDetailsActivity.this.lambda$showSnackBar$1$ReversalDetailsActivity(view);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$showSnackBar$1$ReversalDetailsActivity(View view) {
        this.failureSnackBar.d();
        this.refundDetailsViewModel.callRefundDetails();
        this.refundDetailsViewModel.setProgress(true);
        this.retryCount++;
    }
    ...
    private void observeLiveData() {
        this.refundDetailsViewModel.snackBarCmd().observe(this, new z() {
            public final void onChanged(Object obj) {
                ReversalDetailsActivity.this.lambda$observeLiveData$2$ReversalDetailsActivity((String) obj);
            }
        });
        this.refundDetailsViewModel.getmObservableV2ResponseRefund().observe(this, new z() {
            public final void onChanged(Object obj) {
                ReversalDetailsActivity.this.lambda$observeLiveData$3$ReversalDetailsActivity((com.business.common_module.utilities.a.b) obj);
            }
        });
        this.refundDetailsViewModel.getObservableV2ResponseAcquiring().observe(this, new z() {
            public final void onChanged(Object obj) {
                ReversalDetailsActivity.this.lambda$observeLiveData$4$ReversalDetailsActivity((com.business.common_module.utilities.a.b) obj);
            }
        });
    }

    public /* synthetic */ void lambda$observeLiveData$2$ReversalDetailsActivity(String str) {
        if (!TextUtils.isEmpty(str)) {
            showSnackBar(str);
        }
    }

    public /* synthetic */ void lambda$observeLiveData$3$ReversalDetailsActivity(com.business.common_module.utilities.a.b bVar) {
        if (bVar == null || !bVar.f7357b.equals(e.SUCCESS)) {
            showSnackBar(getString(R.string.mp_something_went_wrong));
            return;
        }
        ...
        if (orderDetailV2Model2 != null) {
            this.refundDetailsViewModel.setV2RefundObject(orderDetailV2Model2);
        }
    }
    ...
    public /* synthetic */ void lambda$observeLiveData$4$ReversalDetailsActivity(com.business.common_module.utilities.a.b r5) {
        /*
            r4 = this;
            r0 = 0
            java.lang.String r1 = ""
            if (r5 == 0) goto L_0x0060
            com.business.merchant_payments.payment.viewmodel.ReversalDetailsViewModel r2 = r4.refundDetailsViewModel
            r2.setProgress(r0)
            T r5 = r5.f7358c
        ...
        L_0x0050:
            com.business.merchant_payments.model.v2.OrderDetailV2Model$AdditionalInfo r2 = r5.getAdditionalInfo()
            java.lang.String r2 = r2.getIssuingBankName()
            goto L_0x005a
        L_0x0059:
            r2 = r1
        L_0x005a:
            com.business.merchant_payments.payment.viewmodel.ReversalDetailsViewModel r3 = r4.refundDetailsViewModel
            r3.setV2AcquiringObject(r5)
            goto L_0x0061
        L_0x0060:
            r2 = r1
        L_0x0061:
            ...
            com.business.merchant_payments.databinding.MpReversalDetailsViewNewBinding r5 = r4.refundDetailsBinding
            com.business.merchant_payments.databinding.MpReversalDetailSubViewBinding r5 = r5.detailsContainer
            android.widget.TextView r5 = r5.profileLabelBankName
            android.view.ViewGroup$LayoutParams r5 = r5.getLayoutParams()
            androidx.constraintlayout.widget.ConstraintLayout$LayoutParams r5 = (androidx.constraintlayout.widget.ConstraintLayout.LayoutParams) r5
            r0 = 16
            int r0 = com.business.merchant_payments.common.utility.AppUtility.getValueInDp(r4, r0)
            r5.topMargin = r0
            r0 = -2
            r5.height = r0
            com.business.merchant_payments.databinding.MpReversalDetailsViewNewBinding r0 = r4.refundDetailsBinding
            com.business.merchant_payments.databinding.MpReversalDetailSubViewBinding r0 = r0.detailsContainer
            ...
            int r1 = com.business.merchant_payments.R.string.mp_bank_name
        ...
        L_0x00a8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.business.merchant_payments.payment.view.ReversalDetailsActivity.lambda$observeLiveData$4$ReversalDetailsActivity(com.business.common_module.utilities.a.b):void");
    }
    ...
    private void convertV2_AndLoadDetails() {
        ...
        if (this.orderDetailV2Model != null) {
            ...
            if (!TextUtils.isEmpty(this.orderDetailV2Model.getBizType())) {
                this.mOfflineTransDetailObject.setmTxnType(this.orderDetailV2Model.getBizType());
            }
    ...
    private void loadBusinessWalletOrderDetails() {
        ...
        if (i.a(PaymentsConfig.getInstance().getApplication())) {
            ...
            BWalletPassbookRepository.Companion.getInstance().loadOrderDetails(this.mBusinessWalletOrderItem.getTxnId()).observe(this, new z() {
                public final void onChanged(Object obj) {
                    ReversalDetailsActivity.this.handleBusinessOrderDetailsResponse((com.business.common_module.utilities.a.b) obj);
                }
            });
        }
    }
    ...
    public void handleBusinessOrderDetailsResponse(com.business.common_module.utilities.a.b<BWalletOrderDetails> bVar) {
        e eVar;
        T t;
    ...
    private void initDataBinding() {
        MpReversalDetailsViewNewBinding mpReversalDetailsViewNewBinding = (MpReversalDetailsViewNewBinding) f.a(this, R.layout.mp_reversal_details_view_new);
        this.refundDetailsBinding = mpReversalDetailsViewNewBinding;
        mpReversalDetailsViewNewBinding.detailsContainer.tvPaymentDescriptionText.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                ReversalDetailsActivity.this.lambda$initDataBinding$5$ReversalDetailsActivity(view);
            }
        });
        initToolBar();
        this.refundDetailsBinding.detailsContainer.tvOrderIdText.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ReversalDetailsActivity reversalDetailsActivity = ReversalDetailsActivity.this;
                reversalDetailsActivity.showDialogSheet(reversalDetailsActivity.getResources().getString(R.string.mp_Order_id_name), ReversalDetailsActivity.this.refundDetailsViewModel.getOrderId());
            }
        });
        this.refundDetailsBinding.rlNeedHelp.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                ReversalDetailsActivity.this.lambda$initDataBinding$6$ReversalDetailsActivity(view);
            }
        });
    }

    public /* synthetic */ void lambda$initDataBinding$5$ReversalDetailsActivity(View view) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ void lambda$initDataBinding$6$ReversalDetailsActivity(android.view.View r3) {
        /*
            r2 = this;
            com.business.merchant_payments.payment.viewmodel.ReversalDetailsViewModel r3 = r2.refundDetailsViewModel
        ...
        L_0x0058:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.business.merchant_payments.payment.view.ReversalDetailsActivity.lambda$initDataBinding$6$ReversalDetailsActivity(android.view.View):void");
    }

    private void showRefundUi() {
        ReversalDetailsViewModel reversalDetailsViewModel = new ReversalDetailsViewModel(this, this.mOfflineTransDetailObject);
        this.refundDetailsViewModel = reversalDetailsViewModel;
        this.refundDetailsBinding.setRefundDetailsViewModel(reversalDetailsViewModel);
        this.refundDetailsBinding.detailsContainer.setViewModel(this.refundDetailsViewModel);
    }
