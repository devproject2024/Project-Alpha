...
public final class HomeRVAdapter$BWSettlementSummaryCardViewHolder$setAlradySettledToBankContainer$$inlined$let$lambda$1 implements View.OnClickListener {
    ...
    public HomeRVAdapter$BWSettlementSummaryCardViewHolder$setAlradySettledToBankContainer$$inlined$let$lambda$1(HomeRVAdapter.BWSettlementSummaryCardViewHolder bWSettlementSummaryCardViewHolder, LabelModel labelModel, ArrayList arrayList) {
    ...
    public final void onClick(View view) {
        ...
        Intent access$getIntentForSettlementDetail = bWSettlementSummaryCardViewHolder.getIntentForSettlementDetail(labelModel, "SUCCESS", (arrayList != null ? (M2BOrderListItemModel) arrayList.get(0) : null).getOrderCreatedTime(), 0);
