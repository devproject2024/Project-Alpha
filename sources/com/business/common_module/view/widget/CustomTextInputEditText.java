...
public final class CustomTextInputEditText extends TextInputEditText {
    ...
    private final void a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.CustomTextInputEditText);
        k.b(obtainStyledAttributes, "context.obtainStyledAttr….CustomTextInputEditText)");
        try {
            int integer = obtainStyledAttributes.getInteger(R.styleable.CustomTextInputEditText_custom_tiet_font_name, 4);
