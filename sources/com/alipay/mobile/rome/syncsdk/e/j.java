...
public class j {
    ...
    private static final String f15100a = j.class.getSimpleName();
    ...
    public static java.lang.String a(android.content.Context r5) {
        ...
        L_0x0049:
            ...
            com.alipay.mobile.rome.syncsdk.e.h.d(r0, r5)
        L_0x0062:
            r0 = r2
        L_0x0063:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.mobile.rome.syncsdk.e.j.a(android.content.Context):java.lang.String");
    }
    ...
    public static boolean b(Context context) {
        try {
            ...
            String str = f15100a;
            h.d(str, "isNetAvailable: [ Exception " + e2 + " ]");
            return false;
        }
    }
    ...
    public static int c(Context context) {
        try {
            ...
            String str = f15100a;
            h.d(str, "getNetworkType: [ Exception " + e2 + " ]");
            return -1;
        }
    }
}
