...
public interface APWebViewClient {
    ...
    void onReceivedError(APWebView aPWebView, WebResourceRequest webResourceRequest, WebResourceError webResourceError);
    ...
    void onScaleChanged(APWebView aPWebView, float f2, float f3);
    ...
    void onWebViewEvent(APWebView aPWebView, int i2, Object obj);
