...
public class H5DevConfig {
    ...
    public static boolean getBooleanConfig(String str, boolean z) {
        try {
            ...
            return PreferenceManager.getDefaultSharedPreferences(H5Utils.getContext()).getBoolean(str, z);
    ...
    public static String getStringConfig(String str, String str2) {
        try {
            ...
            return PreferenceManager.getDefaultSharedPreferences(H5Utils.getContext()).getString(str, str2);
        } catch (Throwable unused) {
            return str2;
        }
    }
    ...
    public static void setStringConfig(String str, String str2) {
        if (H5Utils.getContext() == null) {
            H5Log.e(TAG, "h5DevGlobal.getContext is null");
        } else {
            PreferenceManager.getDefaultSharedPreferences(H5Utils.getContext()).edit().putString(str, str2).apply();
        }
    }
    ...
    public static void setBooleanConfig(String str, boolean z) {
        if (H5Utils.getContext() == null) {
            ...
            PreferenceManager.getDefaultSharedPreferences(H5Utils.getContext()).edit().putBoolean(str, z).apply();
        }
    }
    ...
    public static void debugSwitch(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(H5Utils.getContext());
        H5Log.d(TAG, "debugSwitch:".concat(String.valueOf(z)));
        boolean z6 = defaultSharedPreferences.getBoolean(H5_BUG_ME_DEBUG_SWITCH, false);
        ...
        if (z6 != z && (h5Service = (H5Service) H5Utils.findServiceByInterface(H5Service.class.getName())) != null) {
            h5Service.getBugMeManager().onBugMeSwitched(z);
        }
    }
    ...
    public static void resetBugMeSettings() {
        ...
        boolean z = defaultSharedPreferences.getBoolean(H5_BUG_ME_DEBUG_SWITCH, false);
        ...
        if (z && (h5Service = (H5Service) H5Utils.findServiceByInterface(H5Service.class.getName())) != null) {
            h5Service.getBugMeManager().onBugMeSwitched(false);
        }
    }
}
