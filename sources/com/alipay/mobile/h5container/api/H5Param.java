...
public interface H5Param {
    ...
    public static final String H5_DEV_BUG_ME = "h5devBugMe";
    ...
    public static final String HTTP_ADDITIONAL_HEADERS = "additionalHeaders";
    ...
    public static final String LONG_SHOW_TITLE_HORIZONTAL_DIVIDER = "titleHorizontalDivider";
    public static final String LONG_SHOW_TITLE_LOADING = "showTitleLoading";
    public static final String LONG_SHOW_TITLE_VERTICAL_DIVIDER = "titleVerticalDivider";
    ...
    public static final String SHORT_APP_POOL_LIMIT = "al";
    public static final String SHORT_LIMIT_REQ_RATE = "lr";
    public static final String SHORT_UPDATE_REQ_RATE = "ur";
    ...
    public static final String TITLEBAR_BACKGROUND_IMAGE_PATH = "titlebarBackgroundImagePath";
