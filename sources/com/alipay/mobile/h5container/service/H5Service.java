...
public abstract class H5Service extends H5ExternalService {
    ...
    public abstract e H5IApplicationInstaller();
    ...
    public abstract void fireUrgentUcInit();
    ...
    public abstract H5BaseFragment getTopH5BaseFragmentByViewId(int i2);
    ...
    public abstract void prepareApp(String str, String str2, H5AppInstallProcess h5AppInstallProcess);

    @Deprecated
    public abstract void prepareRNApp(String str, H5AppInstallProcess h5AppInstallProcess);
    ...
    public abstract void sendToWebFromMainProcess(String str, String str2, com.alibaba.a.e eVar);
    ...
    public abstract void startPage(f fVar, H5Bundle h5Bundle);

    public abstract void startPageFromActivity(Activity activity, H5Bundle h5Bundle);

    @Deprecated
    public abstract void startWebActivity(f fVar, Bundle bundle);

    @Deprecated
    public abstract void startWebActivity(f fVar, Bundle bundle, List<Object> list);
