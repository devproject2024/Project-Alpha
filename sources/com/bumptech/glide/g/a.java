...
public final class a {
    ...
    private static final AtomicReference<byte[]> f6595a = new AtomicReference<>();
    ...
    static class C0090a extends InputStream {

        /* renamed from: a  reason: collision with root package name */
        private final ByteBuffer f6596a;
        ...
        C0090a(ByteBuffer byteBuffer) {
            this.f6596a = byteBuffer;
        }

        public final int available() {
            return this.f6596a.remaining();
        }

        public final int read() {
            if (!this.f6596a.hasRemaining()) {
                return -1;
            }
            return this.f6596a.get() & 255;
        }

        public final synchronized void mark(int i2) {
            this.f6597b = this.f6596a.position();
        }
        ...
        public final int read(byte[] bArr, int i2, int i3) throws IOException {
            ...
            this.f6596a.get(bArr, i2, min);
            return min;
        }

        public final synchronized void reset() throws IOException {
            if (this.f6597b != -1) {
                this.f6596a.position(this.f6597b);
            } else {
        ...
        public final long skip(long j) throws IOException {
            ...
            ByteBuffer byteBuffer = this.f6596a;
    ...
    public static byte[] a(ByteBuffer byteBuffer) {
        ...
        if (bVar != null && bVar.f6602a == 0 && bVar.f6603b == bVar.f6604c.length) {
