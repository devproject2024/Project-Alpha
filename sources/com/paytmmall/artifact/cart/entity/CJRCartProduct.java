...
public class CJRCartProduct extends CJRProduct {
    ...
    public Double getmItemAggregateItemPrice() {
    ...
    public HashMap<String, ItemBreakup> getEmiOffers() {
        return this.emiOffers;
    }

    public void setEmiOffers(HashMap<String, ItemBreakup> hashMap) {
        this.emiOffers = hashMap;
    }
}
