...
public class MachineIntelligentRecent extends IJRPaytmDataModel {
    ...
    public static class weekday extends IJRPaytmDataModel {
        private int fri = 0;
        private int mon = 0;
        private int sat = 0;
        private int sun = 0;
    ...
    public static class Timeofday extends IJRPaytmDataModel {
