...
public class HomePortraitVH extends ClickableRVChildViewHolder {
    ...
    public HomePortraitVH(OptimizeLytRootRvBinding optimizeLytRootRvBinding, IGAHandlerListener iGAHandlerListener, CustomAction customAction2) {
        ...
        recyclerView.addItemDecoration(new ItemMarginDecoration(3, a.a(8)));
        recyclerView.setHasFixedSize(true);
        recyclerView.setNestedScrollingEnabled(false);
        if (CLPUtils.isHomeClient(iGAHandlerListener)) {
            CLPUtils.setHomeMargins(optimizeLytRootRvBinding.clParent);
            if (optimizeLytRootRvBinding.rvThinBanner.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                ((ViewGroup.MarginLayoutParams) optimizeLytRootRvBinding.rvThinBanner.getLayoutParams()).topMargin = 0;
            }
        }
    }
    ...
    public void doBinding(View view) {
        ...
        if (this.viewDataBinding != null) {
            view.setType(ViewHolderFactory.TYPE_PORTRAIT_3XN);
