...
public class VoucherViewModel extends a {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.paytmmall.clpartifact.view.viewmodel.VoucherViewModel.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    private String getAbsoluteGridURL() {
        return UrlUtils.appendGridQueryParameter(UrlUtils.appendGridQueryParameter(UrlUtils.appendGridQueryParameter(UrlUtils.appendChildSiteId(CLPArtifact.getInstance().getCommunicationListener().getDefaultParams(getApplication(), this.mUrl)), AppConstants.TAG_LANG_ID, CLPArtifact.getInstance().getCommunicationListener().getLangId(getApplication())), "page_count", this.pageNumber), "items_per_page", 16);
    }
