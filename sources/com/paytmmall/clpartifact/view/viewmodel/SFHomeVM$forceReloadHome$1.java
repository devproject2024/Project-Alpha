...
final class SFHomeVM$forceReloadHome$1<T> implements z<S> {
    final /* synthetic */ SFHomeVM this$0;

    SFHomeVM$forceReloadHome$1(SFHomeVM sFHomeVM) {
    ...
    public final void onChanged(Resource<HomeResponse> resource) {
        ...
        sFHomeVM.handleFilteredResponse(sFHomeVM.getResponseLiveData(), resource);
    }
}
