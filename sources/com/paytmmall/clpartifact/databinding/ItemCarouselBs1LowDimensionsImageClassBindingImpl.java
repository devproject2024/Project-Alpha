...
public class ItemCarouselBs1LowDimensionsImageClassBindingImpl extends ItemCarouselBs1LowDimensionsImageClassBinding implements OnClickListener.Listener {
    ...
    public ItemCarouselBs1LowDimensionsImageClassBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemCarouselBs1LowDimensionsImageClassBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if (i2 != 0) {
            ClickableRVChildViewHolder.setImageUrl(this.mboundView1, str, 17, false, false, 0, context);
        }
        if ((j & 9) != 0) {
