...
public class ItemBanner3xnHomeBindingImpl extends ItemBanner3xnHomeBinding implements OnClickListener.Listener {
    ...
    public ItemBanner3xnHomeBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    private ItemBanner3xnHomeBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if ((j & 8) != 0) {
            this.avatar.setOnClickListener(this.mCallback33);
        }
        if (i2 != 0) {
            ClickableRVChildViewHolder.setOnlyImageUrl(this.avatar, str, context);
        }
    }
