...
public class ItemCarouselFourBindingImpl extends ItemCarouselFourBinding implements OnClickListener.Listener {
    ...
    public ItemCarouselFourBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemCarouselFourBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1, objArr[1]);
        this.mDirtyFlags = -1;
        this.image1.setTag((Object) null);
    ...
    public void executeBindings() {
        ...
        if ((8 & j) != 0) {
            this.image1.setOnClickListener(this.mCallback41);
        }
        if (i2 != 0) {
            ClickableRVChildViewHolder.setImagePostMeasure(this.image1, item, 17, false, context);
        }
        if ((j & 9) != 0) {
            d.a((TextView) this.mboundView2, (CharSequence) str);
        }
    }
