...
public abstract class ItemFullWidthRootRvBinding extends ViewDataBinding {
    ...
    protected ItemFullWidthRootRvBinding(e eVar, android.view.View view, int i2, ImageView imageView, FrameLayout frameLayout, FrameLayout frameLayout2, LinearLayout linearLayout, RecyclerView recyclerView, FlashSaleView flashSaleView, CLPRobotoTextView cLPRobotoTextView, CLPRobotoTextView cLPRobotoTextView2) {
        super(eVar, view, i2);
    ...
    public static ItemFullWidthRootRvBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, e eVar) {
        return (ItemFullWidthRootRvBinding) f.a(layoutInflater, R.layout.item_full_width_root_rv, viewGroup, z, eVar);
    }
    ...
    public static ItemFullWidthRootRvBinding inflate(LayoutInflater layoutInflater, e eVar) {
        return (ItemFullWidthRootRvBinding) f.a(layoutInflater, R.layout.item_full_width_root_rv, (ViewGroup) null, false, eVar);
    }
    ...
    public static ItemFullWidthRootRvBinding bind(android.view.View view, e eVar) {
        return (ItemFullWidthRootRvBinding) bind(eVar, view, R.layout.item_full_width_root_rv);
    }
}
