...
public class ItemSmartIconGridBindingImpl extends ItemSmartIconGridBinding implements OnClickListener.Listener {
    ...
    public ItemSmartIconGridBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemSmartIconGridBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
