...
public class ItemCaroselFourLargeBindingImpl extends ItemCaroselFourLargeBinding implements OnClickListener.Listener {
    ...
    public ItemCaroselFourLargeBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemCaroselFourLargeBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if ((j & 9) != 0) {
            d.a((TextView) this.mboundView1, (CharSequence) str2);
        }
        if ((j & 8) != 0) {
            this.mboundView2.setOnClickListener(this.mCallback16);
        }
        if (i2 != 0) {
            ClickableRVChildViewHolder.setImageUrl(this.mboundView2, str, 4, false, false, 0, context);
        }
    }
