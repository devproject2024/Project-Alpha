...
public class ItemH1FullBannerBindingImpl extends ItemH1FullBannerBinding {
    private static final ViewDataBinding.b sIncludes = null;
    private static final SparseIntArray sViewsWithIds = null;
    private long mDirtyFlags;
    private final ConstraintLayout mboundView0;

    public ItemH1FullBannerBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    private ItemH1FullBannerBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if (i2 != 0) {
            ...
            ClickableRVChildViewHolder.setImageUrl(this.avatar, str, 0, false, false, 0, context);
            AddviewBindings.setAddView(this.avatar, item, str2);
        }
    }
}
