...
public class ItemThinBannerHomeBindingImpl extends ItemThinBannerHomeBinding {
    private static final ViewDataBinding.b sIncludes = null;
    private static final SparseIntArray sViewsWithIds = null;
    private long mDirtyFlags;
    private final ConstraintLayout mboundView0;

    public ItemThinBannerHomeBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    private ItemThinBannerHomeBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if (i2 != 0) {
            ...
            ClickableRVChildViewHolder.setImagePostMeasure(this.avatar, item, 32, false, context);
