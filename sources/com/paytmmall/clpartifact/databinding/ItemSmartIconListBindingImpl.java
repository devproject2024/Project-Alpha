...
public class ItemSmartIconListBindingImpl extends ItemSmartIconListBinding implements OnClickListener.Listener {
    ...
    public ItemSmartIconListBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemSmartIconListBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if (i2 != 0) {
            ...
            if (cLPItemRVViewHolder != null) {
                str2 = cLPItemRVViewHolder.getRequestId();
        ...
        if (i2 != 0) {
            ...
            AddviewBindings.setAddView(this.mboundView1, item, str2);
        }
        if ((j & 9) != 0) {
            d.a(this.mboundView2, (CharSequence) str3);
        }
    }
