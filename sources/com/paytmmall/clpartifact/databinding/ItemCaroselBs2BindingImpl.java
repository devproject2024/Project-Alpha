...
public class ItemCaroselBs2BindingImpl extends ItemCaroselBs2Binding implements OnClickListener.Listener {
    ...
    public ItemCaroselBs2BindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    private ItemCaroselBs2BindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
