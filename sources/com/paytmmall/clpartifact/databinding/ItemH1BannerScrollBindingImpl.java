...
public class ItemH1BannerScrollBindingImpl extends ItemH1BannerScrollBinding {
    ...
    public ItemH1BannerScrollBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemH1BannerScrollBindingImpl(e eVar, View view, Object[] objArr) {
