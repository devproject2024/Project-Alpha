...
public class ItemRow3xnBindingImpl extends ItemRow3xnBinding implements OnClickListener.Listener {
    ...
    public ItemRow3xnBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 6, sIncludes, sViewsWithIds));
    }

    private ItemRow3xnBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1, objArr[3], objArr[1], objArr[5], objArr[2], objArr[4]);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if ((j & 11) != 0) {
            ...
            if (i3 != 0) {
                ...
                str3 = StringUtils.getRupeesFormat(str3);
                if (!z) {
                    i2 = 8;
                }
                context = context2;
        ...
        if ((j & 9) != 0) {
            ...
            d.a((TextView) this.row1xnText, (CharSequence) str2);
        }
        if ((8 & j) != 0) {
            this.parentLayout.setOnClickListener(this.mCallback18);
        }
        if ((j & 11) != 0) {
