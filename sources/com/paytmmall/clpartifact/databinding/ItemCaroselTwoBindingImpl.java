...
public class ItemCaroselTwoBindingImpl extends ItemCaroselTwoBinding implements OnClickListener.Listener {
    ...
    public ItemCaroselTwoBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 3, sIncludes, sViewsWithIds));
    }

    private ItemCaroselTwoBindingImpl(e eVar, View view, Object[] objArr) {
