...
public class NewGroupGridRvBindingImpl extends NewGroupGridRvBinding implements OnClickListener.Listener {
    ...
    public NewGroupGridRvBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 4, sIncludes, sViewsWithIds));
    }

    private NewGroupGridRvBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if ((j & 16) != 0) {
            this.showMore.setOnClickListener(this.mCallback4);
        }
    }
