...
public class ExpandTreeBindingImpl extends ExpandTreeBinding implements OnClickListener.Listener {
    ...
    public ExpandTreeBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 4, sIncludes, sViewsWithIds));
    }

    private ExpandTreeBindingImpl(e eVar, View view, Object[] objArr) {
        super(eVar, view, 1);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        if ((j & 9) != 0) {
            d.a(this.mboundView2, (CharSequence) str2);
            d.a(this.mboundView3, (CharSequence) str3);
        }
    }
    ...
    public final void _internalCallbackOnClick(int i2, View view) {
        ...
        if (cLPTreeViewHolder != null) {
            cLPTreeViewHolder.handleDeepLink(item, num.intValue());
        }
    }
}
