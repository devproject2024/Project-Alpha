...
public class LytThinBannerSmallBindingImpl extends LytThinBannerSmallBinding {
    ...
    public LytThinBannerSmallBindingImpl(e eVar, View view) {
        this(eVar, view, mapBindings(eVar, view, 2, sIncludes, sViewsWithIds));
    }

    private LytThinBannerSmallBindingImpl(e eVar, View view, Object[] objArr) {
    ...
    public void executeBindings() {
        ...
        if ((j & 9) != 0) {
            ...
            ClickableRVChildViewHolder.setImagePostMeasure(this.avatar, item, 14, false, (Context) null);
