...
public final class ShowMoreRepository {
    private final Context context;
    private String loadUrl;

    public ShowMoreRepository(Context context2) {
    ...
    public final LiveData<Resource<HomeResponse>> getMoreResponse() {
        ...
        x.e eVar2 = new x.e();
        eVar2.element = null;
        Job unused = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getMain()), (f) null, (CoroutineStart) null, new ShowMoreRepository$getMoreResponse$1(this, eVar2, yVar, eVar, (d) null), 3, (Object) null);
        return yVar;
    }

    static /* synthetic */ void handleSucessResponse$default(ShowMoreRepository showMoreRepository, y yVar, HomeResponse homeResponse, RequestType requestType, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            requestType = RequestType.FRESH;
        }
        showMoreRepository.handleSucessResponse(yVar, homeResponse, requestType);
    }
    ...
    private final void hitApi(String str, HashMap<String, String> hashMap, y<Resource<HomeResponse>> yVar) {
        com.paytm.network.a l = new b().a(this.context).a(a.c.HOME).a(a.C0715a.POST).a(a.b.SILENT).c(this.context.getClass().getSimpleName()).a(str).a((Map<String, String>) hashMap).a((IJRPaytmDataModel) new StringResponseModel()).a((com.paytm.network.listener.b) new ShowMoreRepository$hitApi$networkCallBuilder$1(this, yVar)).l();
        l.b(false);
        l.a();
    }

    static /* synthetic */ void handleErrorResponse$default(ShowMoreRepository showMoreRepository, y yVar, RequestType requestType, Throwable th, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            requestType = RequestType.FRESH;
        }
        if ((i2 & 4) != 0) {
        ...
        showMoreRepository.handleErrorResponse(yVar, requestType, th);
    }
    ...
    public final String getUrl() {
        ...
        if (str == null) {
            ...
            str = instance.getCommunicationListener().getGTMUrl(CLPConstants.KEY_CATEGORY_SHOW_MORE_URL);
        }
    ...
    public final /* synthetic */ Object getNetworkCacheData(d<? super HomeResponse> dVar) {
        return BuildersKt.withContext(Dispatchers.getIO(), new ShowMoreRepository$getNetworkCacheData$2(this, (d) null), dVar);
    }
}
