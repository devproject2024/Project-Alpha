...
public final class a {
    ...
    private static final int[] f42684a = {1, 10, 100, 1000, AppConstants.START_OTP_FLOW, 100000, 1000000, 10000000, 100000000};
    ...
    private static String a(String str, String str2, String str3, String str4) {
        ...
        String num = Integer.toString(((a2[b2 + 3] & 255) | ((((a2[b2] & Byte.MAX_VALUE) << 24) | ((a2[b2 + 1] & 255) << 16)) | ((a2[b2 + 2] & 255) << 8))) % f42684a[intValue]);
        while (num.length() < intValue) {
            num = "0".concat(String.valueOf(num));
        }
        int parseInt = Integer.parseInt(num);
        String str5 = "ABCDE" + Integer.toString(parseInt, 16);
        return str5.substring(str5.length() - 5).toUpperCase();
    }
