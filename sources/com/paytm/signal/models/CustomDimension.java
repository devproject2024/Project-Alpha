...
public final class CustomDimension {
    ...
    public final Map<String, String> component1$paytmnotification_paytmRelease() {
    ...
    public final Map<String, String> getCustomDimension$paytmnotification_paytmRelease() {
        return this.customDimension;
    }

    public final void setCustomDimension$paytmnotification_paytmRelease(Map<String, String> map) {
        this.customDimension = map;
    }
}
