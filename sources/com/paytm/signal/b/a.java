...
public final class a {
    ...
    public Config f43603a;

    /* renamed from: b  reason: collision with root package name */
    private final c f43604b;

    /* renamed from: c  reason: collision with root package name */
    private final Context f43605c;
    ...
    public a(c cVar, Context context) {
        ...
        Config b2 = this.f43604b.b();
        this.f43603a = b2 == null ? new Config.Builder().build() : b2;
    }
    ...
    public final synchronized void a(com.paytm.signal.models.Config r5) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x001a:
            ...
            com.paytm.signal.models.Config r0 = r4.f43603a     // Catch:{ all -> 0x0159 }
        ...
        L_0x00b5:
            ...
            if (r0 != 0) goto L_0x00d0
            com.paytm.signal.models.Config r0 = r4.f43603a     // Catch:{ all -> 0x0159 }
            com.paytm.signal.c.c r1 = com.paytm.signal.c.c.f43630a     // Catch:{ all -> 0x0159 }
            android.content.Context r1 = r4.f43605c     // Catch:{ all -> 0x0159 }
            java.lang.String r1 = com.paytm.signal.c.c.b(r1)     // Catch:{ all -> 0x0159 }
            r0.setDeviceId(r1)     // Catch:{ all -> 0x0159 }
        L_0x00d0:
        ...
        L_0x0159:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paytm.signal.b.a.a(com.paytm.signal.models.Config):void");
    }

    private synchronized void b(Context context) {
        k.c(context, "context");
        Config config = this.f43603a;
        com.paytm.signal.c.c cVar = com.paytm.signal.c.c.f43630a;
        config.setIp$paytmnotification_paytmRelease(com.paytm.signal.c.c.a());
        Config config2 = this.f43603a;
        com.paytm.signal.c.c cVar2 = com.paytm.signal.c.c.f43630a;
        config2.setCarrier$paytmnotification_paytmRelease(com.paytm.signal.c.c.a(context));
        Config config3 = this.f43603a;
        b bVar = b.f43629a;
        config3.setConnectionType$paytmnotification_paytmRelease(b.a(context));
    }
    ...
    public final synchronized void a() {
        ...
        if (customDimension == null) {
            ...
            str = cVar.f43644a.b(new CustomDimension(customDimension));
        }
    ...
    public final synchronized void a(String str) {
        this.f43603a.setUserId$paytmnotification_paytmRelease(str);
        SharedPreferences.Editor edit = this.f43604b.a().edit();
        edit.putString("user_id", str);
        edit.apply();
    }

    public final synchronized void b() {
        this.f43603a.setUserId$paytmnotification_paytmRelease((String) null);
        SharedPreferences.Editor edit = this.f43604b.a().edit();
    ...
    public final synchronized void a(android.content.Context r7) {
        /*
            ...
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            com.paytm.signal.models.Config r1 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.Long r1 = r1.getLastAppOpenDate$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
        ...
        L_0x0033:
            r0.setLastAppOpenDate$paytmnotification_paytmRelease(r1)     // Catch:{ all -> 0x010a }
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r0 = r0.getOsVersion$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
            if (r0 != 0) goto L_0x0045
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r1 = android.os.Build.VERSION.RELEASE     // Catch:{ all -> 0x010a }
            r0.setOsVersion$paytmnotification_paytmRelease(r1)     // Catch:{ all -> 0x010a }
        L_0x0045:
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r0 = r0.getModel$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
            if (r0 != 0) goto L_0x0054
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r1 = android.os.Build.MODEL     // Catch:{ all -> 0x010a }
            r0.setModel$paytmnotification_paytmRelease(r1)     // Catch:{ all -> 0x010a }
        L_0x0054:
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r0 = r0.getBrand$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
            if (r0 != 0) goto L_0x0063
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r1 = android.os.Build.MANUFACTURER     // Catch:{ all -> 0x010a }
            r0.setBrand$paytmnotification_paytmRelease(r1)     // Catch:{ all -> 0x010a }
        L_0x0063:
            r6.b(r7)     // Catch:{ all -> 0x010a }
            com.paytm.signal.models.Config r0 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r0 = r0.getAdvertisementId$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
        ...
        L_0x007c:
            ...
            com.paytm.signal.models.Config r2 = r6.f43603a     // Catch:{ e -> 0x00d5, f -> 0x00ba, Exception -> 0x009f }
            java.lang.String r3 = r7.a()     // Catch:{ e -> 0x00d5, f -> 0x00ba, Exception -> 0x009f }
            r2.setAdvertisementId$paytmnotification_paytmRelease(r3)     // Catch:{ e -> 0x00d5, f -> 0x00ba, Exception -> 0x009f }
            com.paytm.signal.data.c r2 = r6.f43604b     // Catch:{ e -> 0x00d5, f -> 0x00ba, Exception -> 0x009f }
        ...
        L_0x009f:
            r7 = move-exception
            com.paytm.notification.b.e$b r2 = com.paytm.notification.b.e.f43014a     // Catch:{ all -> 0x010a }
        ...
        L_0x00d5:
            ...
            r2.c(r7, r1)     // Catch:{ all -> 0x010a }
        L_0x00ef:
            com.paytm.signal.models.Config r7 = r6.f43603a     // Catch:{ all -> 0x010a }
            java.lang.String r7 = r7.getAdvertisementId$paytmnotification_paytmRelease()     // Catch:{ all -> 0x010a }
            if (r7 != 0) goto L_0x0108
            com.paytm.signal.models.Config r7 = r6.f43603a     // Catch:{ all -> 0x010a }
            com.paytm.signal.data.c r1 = r6.f43604b     // Catch:{ all -> 0x010a }
            ...
            r7.setAdvertisementId$paytmnotification_paytmRelease(r0)     // Catch:{ all -> 0x010a }
        L_0x0108:
            monitor-exit(r6)
            return
        L_0x010a:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paytm.signal.b.a.a(android.content.Context):void");
    }
}
