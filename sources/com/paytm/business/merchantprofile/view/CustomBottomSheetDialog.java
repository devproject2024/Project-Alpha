...
public class CustomBottomSheetDialog extends f {
    ...
    private View wrapInBottomSheet(int i2, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), R.layout.pr_design_custom_bottom_sheet_dialog, (ViewGroup) null);
        ...
        frameLayout2.setOnTouchListener($$Lambda$CustomBottomSheetDialog$bgKyqseyJkXzjFXUj2hRF3qc0vE.INSTANCE);
        return frameLayout;
    }
