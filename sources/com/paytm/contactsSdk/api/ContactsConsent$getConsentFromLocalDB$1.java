...
@f(b = "ContactsConsent.kt", c = {}, d = "invokeSuspend", e = "com.paytm.contactsSdk.api.ContactsConsent$getConsentFromLocalDB$1")
final class ContactsConsent$getConsentFromLocalDB$1 extends k implements m<CoroutineScope, d<? super x>, Object> {
    ...
    ContactsConsent$getConsentFromLocalDB$1(q qVar, ContactsQueryCallback contactsQueryCallback, ContactsQuery contactsQuery, d dVar) {
        super(2, dVar);
    ...
    public final d<x> create(Object obj, d<?> dVar) {
        ...
        ContactsConsent$getConsentFromLocalDB$1 contactsConsent$getConsentFromLocalDB$1 = new ContactsConsent$getConsentFromLocalDB$1(this.$onConsentResultAvailable, this.$contactsQueryCallback, this.$contactsQuery, dVar);
        contactsConsent$getConsentFromLocalDB$1.p$ = (CoroutineScope) obj;
        return contactsConsent$getConsentFromLocalDB$1;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((ContactsConsent$getConsentFromLocalDB$1) create(obj, (d) obj2)).invokeSuspend(x.f47997a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (!checkConsentsAvailable.isEmpty()) {
                ...
                this.$onConsentResultAvailable.invoke(Boolean.FALSE, this.$contactsQueryCallback, this.$contactsQuery);
            }
            return x.f47997a;
        }
