...
public final class e implements d {
    ...
    private final j f40964a;

    /* renamed from: b  reason: collision with root package name */
    private final c<SignalEventDb> f40965b;

    public e(j jVar) {
        this.f40964a = jVar;
        this.f40965b = new c<SignalEventDb>(jVar) {
    ...
    public final void a(SignalEventDb signalEventDb) {
        this.f40964a.assertNotSuspendingTransaction();
        this.f40964a.beginTransaction();
        try {
            this.f40965b.insert(signalEventDb);
            this.f40964a.setTransactionSuccessful();
        } finally {
            this.f40964a.endTransaction();
        }
    }
    ...
    public final List<SignalEventDb> a() {
        ...
        a2.a(1, 10);
        this.f40964a.assertNotSuspendingTransaction();
        Cursor a3 = androidx.room.b.c.a(this.f40964a, a2, false);
        try {
            int b2 = b.b(a3, "id");
    ...
    public final void a(List<Long> list) {
        ...
        a2.append(")");
        f compileStatement = this.f40964a.compileStatement(a2.toString());
        int i2 = 1;
        for (Long next : list) {
            if (next == null) {
