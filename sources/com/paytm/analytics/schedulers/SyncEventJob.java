...
public final class SyncEventJob extends CoroutineWorker {
    ...
    public static final a f40967c = new a((byte) 0);
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public static int f40968e;
    /* access modifiers changed from: private */

    /* renamed from: d  reason: collision with root package name */
    public final Context f40969d;

    @f(b = "SyncEventJob.kt", c = {16}, d = "doWork", e = "com.paytm.analytics.schedulers.SyncEventJob")
    ...
    @f(b = "SyncEventJob.kt", c = {}, d = "invokeSuspend", e = "com.paytm.analytics.schedulers.SyncEventJob$doWork$2")
    static final class c extends kotlin.d.b.a.k implements m<CoroutineScope, kotlin.d.d<? super ListenableWorker.a>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.a(obj);
                try {
                    com.paytm.a.a.b.f40832a.a("Sync Event Job has started.. ", new Object[0]);
                    b.C0683b bVar = com.paytm.analytics.b.f40911e;
                    com.paytm.analytics.b a2 = b.C0683b.a(this.this$0.f40969d.getApplicationContext());
                    if (a2 != null) {
                        com.paytm.analytics.b.a aVar2 = a2.f40913a;
                        String str = null;
                        if (aVar2 != null) {
                        ...
                        com.paytm.analytics.data.a aVar3 = a2.f40915c;
                        if (config != null) {
                            str = config.getServerEndPoints();
                        }
                        if (str == null || aVar3 == null) {
                            SyncEventJob.f40968e = 0;
                            return ListenableWorker.a.c();
                        }
                        try {
                            b bVar2 = b.f40976a;
                            if (b.a(config, aVar3, a2.f40916d, false)) {
                                SyncEventJob.f40968e = 0;
                                return ListenableWorker.a.a();
                            } else if (SyncEventJob.f40968e < 3) {
                                SyncEventJob.f40968e = SyncEventJob.f40968e + 1;
                            ...
                            com.paytm.a.a.b.f40832a.a("Do not retry exception rescheduling cancelled", new Object[0]);
                            SyncEventJob.f40968e = 0;
                            return ListenableWorker.a.c();
                        }
                    } else {
    ...
    public final java.lang.Object a(kotlin.d.d<? super androidx.work.ListenableWorker.a> r6) {
        ...
        L_0x004c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paytm.analytics.schedulers.SyncEventJob.a(kotlin.d.d):java.lang.Object");
    }
}
