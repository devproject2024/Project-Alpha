...
public class IMCache<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paytm.android.chat.utils.IMCache.get(java.lang.Object):java.lang.Object");
    }
    ...
    private void trimToSize(int r6) {
        ...
        L_0x0000:
            ...
            java.util.LinkedHashMap<K, V> r0 = r5.map     // Catch:{ all -> 0x0077 }
        ...
        L_0x0011:
            ...
            java.util.LinkedHashMap<K, V> r0 = r5.map     // Catch:{ all -> 0x0077 }
            java.util.Set r0 = r0.entrySet()     // Catch:{ all -> 0x0077 }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ all -> 0x0077 }
            boolean r1 = r0.hasNext()     // Catch:{ all -> 0x0077 }
            r2 = 0
            if (r1 == 0) goto L_0x002d
            java.lang.Object r0 = r0.next()     // Catch:{ all -> 0x0077 }
            java.util.Map$Entry r0 = (java.util.Map.Entry) r0     // Catch:{ all -> 0x0077 }
            goto L_0x002e
        L_0x002d:
            r0 = r2
        L_0x002e:
            if (r0 == 0) goto L_0x0051
            java.lang.Object r1 = r0.getKey()     // Catch:{ all -> 0x0077 }
            java.lang.Object r0 = r0.getValue()     // Catch:{ all -> 0x0077 }
            java.util.LinkedHashMap<K, V> r3 = r5.map     // Catch:{ all -> 0x0077 }
            r3.remove(r1)     // Catch:{ all -> 0x0077 }
            int r3 = r5.size     // Catch:{ all -> 0x0077 }
            int r4 = r5.safeSizeOf(r1, r0)     // Catch:{ all -> 0x0077 }
            int r3 = r3 - r4
            r5.size = r3     // Catch:{ all -> 0x0077 }
            int r3 = r5.evictionCount     // Catch:{ all -> 0x0077 }
            r4 = 1
            int r3 = r3 + r4
            r5.evictionCount = r3     // Catch:{ all -> 0x0077 }
            monitor-exit(r5)     // Catch:{ all -> 0x0077 }
            r5.entryRemoved(r4, r1, r0, r2)
            goto L_0x0000
        L_0x0051:
            monitor-exit(r5)     // Catch:{ all -> 0x0077 }
            return
        L_0x0053:
            java.lang.IllegalStateException r6 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0077 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x0077 }
            r0.<init>()     // Catch:{ all -> 0x0077 }
            java.lang.Class r1 = r5.getClass()     // Catch:{ all -> 0x0077 }
            java.lang.String r1 = r1.getName()     // Catch:{ all -> 0x0077 }
            r0.append(r1)     // Catch:{ all -> 0x0077 }
            java.lang.String r1 = ".sizeOf() is reporting inconsistent results! size = "
            r0.append(r1)     // Catch:{ all -> 0x0077 }
            int r1 = r5.size     // Catch:{ all -> 0x0077 }
            r0.append(r1)     // Catch:{ all -> 0x0077 }
        ...
        L_0x0077:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.paytm.android.chat.utils.IMCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i2 != 0 ? (this.hitCount * 100) / i2 : 0)});
    }
}
