...
public final class ChatFastScrollerLinearLayout extends LinearLayout {
    ...
    public final RecyclerView getParentRv() {
        RecyclerView recyclerView = this.f41845a;
    ...
    public final void setParentRv(RecyclerView recyclerView) {
        ...
        this.f41845a = recyclerView;
    }

    public final String[] getSectionList() {
        String[] strArr = this.f41846b;
        if (strArr == null) {
            k.a("sectionList");
        }
        return strArr;
    ...
    public final void setUpWithRecyclerView(RecyclerView recyclerView, String[] strArr, a aVar) {
        ...
        while (i2 < length) {
            ...
            if (systemService != null) {
                View inflate = ((LayoutInflater) systemService).inflate(R.layout.chat_fast_scroll_item, (ViewGroup) null);
                k.a((Object) inflate, "(context.getSystemServic…t_fast_scroll_item, null)");
        ...
        a(0);
        RecyclerView recyclerView2 = this.f41845a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (i2 < childCount) {
            View childAt = getChildAt(i2);
            if (childAt != null) {
                if (round >= childAt.getTop() && round <= childAt.getBottom() && i2 != this.f41848d) {
                    View findViewById = childAt.findViewById(R.id.tv_fast_scroller_item);
                    k.a((Object) findViewById, "child.findViewById(R.id.tv_fast_scroller_item)");
                    TextView textView = (TextView) findViewById;
                    RecyclerView recyclerView = this.f41845a;
