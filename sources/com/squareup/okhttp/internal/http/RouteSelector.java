...
public final class RouteSelector {
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (i2 <= 0 || i2 > 65535) {
            throw new SocketException("No route to " + str + AppConstants.COLON + i2 + "; port is out of range");
        }
        for (InetAddress inetSocketAddress2 : this.network.resolveInetAddresses(str)) {
            this.inetSocketAddresses.add(new InetSocketAddress(inetSocketAddress2, i2));
        }
