...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private static List<String> getSubjectAltNames(X509Certificate x509Certificate, int i2) {
        ...
        try {
            ...
            for (List next : subjectAlternativeNames) {
                if (!(next == null || next.size() < 2 || (num = (Integer) next.get(0)) == null || num.intValue() != i2 || (str = (String) next.get(1)) == null)) {
                    arrayList.add(str);
                }
            }
            return arrayList;
    ...
    private boolean verifyHostName(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(AppUtility.CENTER_DOT) && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(AppUtility.CENTER_DOT) && !str2.endsWith("..")) {
            if (!str.endsWith(AppUtility.CENTER_DOT)) {
                str = str + '.';
            }
            if (!str2.endsWith(AppUtility.CENTER_DOT)) {
                str2 = str2 + '.';
            }
