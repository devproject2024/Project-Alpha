    ...
    static {
        Internal.instance = new Internal() {
            ...
            public final void setNetwork(OkHttpClient okHttpClient, Network network) {
                Network unused = okHttpClient.network = network;
            }
            ...
            public final e connectionRawSource(Connection connection) {
                return connection.rawSource();
            }

            public final d connectionRawSink(Connection connection) {
