...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (i4 < childCount) {
            ...
            childAt.measure(View.MeasureSpec.makeMeasureSpec(i6, 1073741824), this.f45578a ? View.MeasureSpec.makeMeasureSpec(i6, Integer.MIN_VALUE) : i3);
    ...
    public void onClick(View view) {
        MonthView.a aVar = this.f45579b;
        if (aVar != null) {
            aVar.a((d) view.getTag());
        }
    }
    ...
    public int getCellHeight() {
        return Math.round((float) ((getContext().getResources().getDisplayMetrics().densityDpi / 160) * 40));
    }
}
