...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    private boolean f45523a;

    /* renamed from: b  reason: collision with root package name */
    private MonthView.b f45524b;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (i4 < childCount) {
            ...
            childAt.measure(makeMeasureSpec, this.f45523a ? View.MeasureSpec.makeMeasureSpec(i6, Integer.MIN_VALUE) : makeMeasureSpec);
