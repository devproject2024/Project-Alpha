...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (i4 < childCount) {
            ...
            childAt.measure(makeMeasureSpec, this.f45629a ? View.MeasureSpec.makeMeasureSpec(i6, Integer.MIN_VALUE) : makeMeasureSpec);
