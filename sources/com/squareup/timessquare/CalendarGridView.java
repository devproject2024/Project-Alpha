...
public class CalendarGridView extends ViewGroup {
    ...
    private final Paint f45503a = new Paint();
    ...
    public CalendarGridView(Context context, AttributeSet attributeSet) {
        ...
        this.f45503a.setStrokeWidth(5.0f);
        this.f45503a.setColor(getResources().getColor(R.color.creamy_white));
    }

    public void setDividerColor(int i2) {
        this.f45503a.setStrokeWidth(5.0f);
        this.f45503a.setColor(i2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(f2, f3, f2, f4, this.f45503a);
        for (int i2 = 0; i2 < 7; i2++) {
            float right = ((float) (viewGroup.getChildAt(i2).getRight() + left)) - 0.5f;
            canvas.drawLine(right, f3, right, f4, this.f45503a);
        }
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        canvas.drawLine((float) view.getLeft(), bottom, (float) (view.getRight() - 2), bottom, this.f45503a);
        return drawChild;
    }
