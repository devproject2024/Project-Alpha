...
public class CalendarPickerView extends ListView {
    ...
    final MonthView.b f45506a = new b(this, (byte) 0);

    /* renamed from: b  reason: collision with root package name */
    final List<e> f45507b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    final List<d> f45508c = new ArrayList();

    /* renamed from: d  reason: collision with root package name */
    final List<d> f45509d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    final List<Calendar> f45510e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    final List<Calendar> f45511f = new ArrayList();

    /* renamed from: g  reason: collision with root package name */
    j f45512g;

    /* renamed from: h  reason: collision with root package name */
    public Calendar f45513h;

    /* renamed from: i  reason: collision with root package name */
    Map<Date, String> f45514i = new HashMap();
    private final f j;
    /* access modifiers changed from: private */
    ...
    public CalendarPickerView(Context context, AttributeSet attributeSet) {
        ...
        this.f45513h = Calendar.getInstance(this.l);
        ...
        if (isInEditMode()) {
            ...
            instance.add(1, 1);
            a(new Date(), instance.getTime(), new Locale(getDefaultLanguage())).a(new Date());
        }
    }
    ...
    public final e a(Date date, Date date2, Locale locale) {
        if (date == null || date2 == null) {
            ...
            this.l = locale;
            this.f45513h = Calendar.getInstance(locale);
            ...
            for (e next : this.f45507b) {
                String format = this.m.format(next.f45545c);
                next.f45546d = format;
                String substring = format.substring(0, format.indexOf(" "));
                String substring2 = format.substring(format.indexOf(" "), format.length());
                next.f45547e = new SpannableStringBuilder(substring + substring2);
                next.f45547e.setSpan(new StyleSpan(1), 0, substring.length(), 33);
            }
    ...
    public class e {
        ...
        public final e a(j jVar) {
            ...
            calendarPickerView.f45512g = jVar;
        ...
        private e a(Collection<Date> collection) {
            if (CalendarPickerView.this.f45512g == j.SINGLE && collection.size() > 1) {
                throw new IllegalArgumentException("SINGLE mode can't be used with multiple selectedDates");
            } else if (CalendarPickerView.this.f45512g != j.RANGE || collection.size() <= 2) {
                if (collection != null) {
                    for (Date b2 : collection) {
                        CalendarPickerView.this.b(b2);
                    }
                }
    ...
    public final boolean a(Date date) {
        ...
        int i2 = 0;
        while (true) {
            if (i2 >= this.f45507b.size()) {
                num = null;
                break;
            } else if (a(instance, this.f45507b.get(i2))) {
    ...
    public Date getSelectedDate() {
        if (this.f45510e.size() > 0) {
            return this.f45510e.get(0).getTime();
        }
        return null;
    }
    ...
    public List<Date> getSelectedDates() {
        ...
        for (d dVar : this.f45508c) {
            arrayList.add(dVar.f45535a);
        }
    ...
    class b implements MonthView.b {
        ...
        public final void a(d dVar) {
            ...
            if (CalendarPickerView.a(date, CalendarPickerView.this.p, CalendarPickerView.this.q) && CalendarPickerView.this.c()) {
                ...
                CalendarPickerView.this.D.onInvalidDateSelected(date);
            }
        }
    }
    ...
    public boolean a(Date date, d dVar) {
        ...
        for (d dVar2 : this.f45508c) {
            dVar2.f45542h = d.a.NONE;
        }
        int i2 = AnonymousClass1.f45515a[this.f45512g.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                ...
                throw new IllegalStateException("Unknown selectionMode " + this.f45512g);
            }
        } else if (this.f45510e.size() > 1) {
            b();
        } else if (this.f45510e.size() == 1 && instance.before(this.f45510e.get(0))) {
            b();
        }
        if (date != null) {
            if (this.f45508c.size() == 0 || !this.f45508c.get(0).equals(dVar)) {
                this.f45508c.add(dVar);
                dVar.f45538d = true;
            }
            this.f45510e.add(instance);
            if (this.f45512g == j.RANGE && this.f45508c.size() > 1) {
                Date date2 = this.f45508c.get(0).f45535a;
                Date date3 = this.f45508c.get(1).f45535a;
                this.f45508c.get(0).f45542h = d.a.FIRST;
                this.f45508c.get(1).f45542h = d.a.LAST;
                for (List<List<d>> it2 : this.k) {
                    for (List<d> it3 : it2) {
                        for (d dVar3 : it3) {
                            if (dVar3.f45535a.after(date2) && dVar3.f45535a.before(date3) && dVar3.f45540f) {
                                dVar3.f45538d = true;
                                dVar3.f45542h = d.a.MIDDLE;
                                this.f45508c.add(dVar3);
                            }
                        }
                    }
                }
    ...
    /* renamed from: com.squareup.timessquare.CalendarPickerView$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f45515a = new int[j.values().length];
        ...
        static {
            /*
                com.squareup.timessquare.CalendarPickerView$j[] r0 = com.squareup.timessquare.CalendarPickerView.j.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f45515a = r0
                int[] r0 = f45515a     // Catch:{ NoSuchFieldError -> 0x0014 }
                com.squareup.timessquare.CalendarPickerView$j r1 = com.squareup.timessquare.CalendarPickerView.j.RANGE     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f45515a     // Catch:{ NoSuchFieldError -> 0x001f }
                com.squareup.timessquare.CalendarPickerView$j r1 = com.squareup.timessquare.CalendarPickerView.j.MULTIPLE     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = f45515a     // Catch:{ NoSuchFieldError -> 0x002a }
                com.squareup.timessquare.CalendarPickerView$j r1 = com.squareup.timessquare.CalendarPickerView.j.SINGLE     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.timessquare.CalendarPickerView.AnonymousClass1.<clinit>():void");
        }
    }

    private void b() {
        for (d next : this.f45508c) {
            next.f45538d = false;
            if (this.B != null) {
                Date date = next.f45535a;
                if (this.f45512g == j.RANGE) {
                    int indexOf = this.f45508c.indexOf(next);
                    if (indexOf == 0 || indexOf == this.f45508c.size() - 1) {
                        this.B.b(date);
                    }
                } else {
                    this.B.b(date);
    ...
    private Date a(Date date, Calendar calendar) {
        Iterator<d> it2 = this.f45508c.iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
            d next = it2.next();
            if (next.f45535a.equals(date)) {
                next.f45538d = false;
                this.f45508c.remove(next);
                date = null;
                break;
            }
        }
        Iterator<Calendar> it3 = this.f45510e.iterator();
        while (true) {
            if (!it3.hasNext()) {
                break;
            }
    ...
    class f extends BaseAdapter {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final LayoutInflater f45520b;
        ...
        private f() {
            this.f45520b = LayoutInflater.from(CalendarPickerView.this.getContext());
        }

        public final int getCount() {
            return CalendarPickerView.this.f45507b.size();
        }

        public final Object getItem(int i2) {
            return CalendarPickerView.this.f45507b.get(i2);
        }
        ...
        public final View getView(int i2, View view, ViewGroup viewGroup) {
            ...
            if (monthView == null || !monthView.getTag(R.id.day_view_adapter_class).equals(CalendarPickerView.this.G.getClass())) {
                monthView = MonthView.a(viewGroup, this.f45520b, CalendarPickerView.this.n, CalendarPickerView.this.f45506a, CalendarPickerView.this.f45513h, CalendarPickerView.this.t, CalendarPickerView.this.u, CalendarPickerView.this.v, CalendarPickerView.this.w, CalendarPickerView.this.x, CalendarPickerView.this.y, CalendarPickerView.this.F, CalendarPickerView.this.l, CalendarPickerView.this.G);
            ...
            if (!CalendarPickerView.this.f45514i.isEmpty()) {
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMM dd");
                Calendar instance = Calendar.getInstance(CalendarPickerView.this.l);
                ArrayList arrayList = new ArrayList();
                for (Map.Entry next : CalendarPickerView.this.f45514i.entrySet()) {
                    instance.setTime((Date) next.getKey());
                    if (instance.get(2) == CalendarPickerView.this.f45507b.get(i3).f45543a && instance.get(1) == CalendarPickerView.this.f45507b.get(i3).f45544b) {
            ...
            monthView.a(CalendarPickerView.this.f45507b.get(i3), (List) CalendarPickerView.this.k.get(i3), CalendarPickerView.this.s, Typeface.create("sans-serif-medium", 0), CalendarPickerView.this.A);
            return monthView;
        }
    }
    ...
    private List<List<d>> a(e eVar, Calendar calendar) {
        ...
        List<Calendar> list = this.f45510e;
        ...
        Calendar a2 = a(this.f45510e);
        while (true) {
            if ((instance.get(2) < eVar2.f45543a + 1 || instance.get(1) < eVar2.f45544b) && instance.get(1) <= eVar2.f45544b) {
                ...
                while (i3 < i2) {
                    ...
                    boolean z2 = instance.get(2) == eVar2.f45543a;
                    boolean z3 = z2 && a(this.f45510e, instance);
                    boolean z4 = z2 && a(instance, this.p, this.q) && c();
                    boolean a3 = a(instance, this.f45513h);
                    boolean a4 = a(this.f45511f, instance);
                    int i4 = instance.get(5);
                    d.a aVar = d.a.NONE;
                    if (this.f45510e.size() > 1) {
                        if (a(calendar2, instance)) {
                            aVar = d.a.FIRST;
                        } else if (a(a(this.f45510e), instance)) {
                            aVar = d.a.LAST;
                        } else if (a(instance, calendar2, a2)) {
                            aVar = d.a.MIDDLE;
                        }
                    }
                    arrayList2.add(new d(time, z2, z4, z3, a3, a4, i4, aVar));
                    instance.add(5, 1);
                    i3++;
                    i2 = 7;
                }
    ...
    private static boolean a(Calendar calendar, e eVar) {
        if (calendar.get(2) == eVar.f45543a && calendar.get(1) == eVar.f45544b) {
            return true;
        }
        return false;
    }
    ...
    public final boolean b(Date date) {
            ...
            while (true) {
                ...
                for (List it3 : it2.next()) {
                    ...
                    while (true) {
                        if (it4.hasNext()) {
                            d dVar = (d) it4.next();
                            instance2.setTime(dVar.f45535a);
                            if (a(instance2, instance) && dVar.f45540f) {
                                gVar = new g(dVar, i2);
                                break loop0;
                            }
                        }
        ...
        boolean a2 = a(date, gVar.f45521a);
        if (a2) {
            a(gVar.f45522b);
        }
        return a2;
    ...
    static /* synthetic */ void b(CalendarPickerView calendarPickerView) {
        ...
        Integer num = null;
        Integer num2 = null;
        for (int i2 = 0; i2 < calendarPickerView.f45507b.size(); i2++) {
            e eVar = calendarPickerView.f45507b.get(i2);
            if (num == null) {
                Iterator<Calendar> it2 = calendarPickerView.f45510e.iterator();
                while (true) {
                    if (it2.hasNext()) {
                        if (a(it2.next(), eVar)) {
                            num = Integer.valueOf(i2);
