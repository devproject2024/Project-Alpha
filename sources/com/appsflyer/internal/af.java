...
public final class af {
    ...
    public static boolean m129(Context context) {
        ...
        try {
            ...
            if (AndroidUtils.m34(context, new Intent("com.google.firebase.MESSAGING_EVENT", (Uri) null, context, FirebaseMessagingServiceListener.class))) {
                return true;
            }
    ...
    public static void m128(Context context, String str) {
        if (str != null) {
            ...
            c.a.C0085c r0 = c.a.C0085c.m175(AppsFlyerProperties.getInstance().getString("afUninstallToken"));
            SharedPreferences sharedPreferences = AppsFlyerLibCore.getSharedPreferences(context);
            if (!sharedPreferences.getBoolean("sentRegisterRequestToAF", false) || r0.f235 == null || !r0.f235.equals(str)) {
