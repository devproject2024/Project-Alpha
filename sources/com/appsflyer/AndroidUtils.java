...
public class AndroidUtils {
    ...
    static Map<String, String> m35(Context context, Map<String, String> map, Uri uri) {
        boolean z;
        int i2;
        if (uri.getQuery() != null) {
            z = false;
            for (String str : uri.getQuery().split(AppConstants.AND_SIGN)) {
        ...
        if (path != null) {
            map.put(H5TabbarUtils.MATCH_TYPE_PATH, path);
        }
