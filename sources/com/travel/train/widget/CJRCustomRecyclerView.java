...
public class CJRCustomRecyclerView extends RecyclerView {
    ...
    private void a(Context context) {
        this.f28322b = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public void setOriginalMotionEvent(MotionEvent motionEvent) {
        this.f28323c = motionEvent.getX();
        this.f28324d = motionEvent.getY();
    }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0042:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.travel.train.widget.CJRCustomRecyclerView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
}
