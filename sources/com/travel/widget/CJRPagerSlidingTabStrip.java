...
public class CJRPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private static final int[] f28555b = {16842901, 16842904};
    private int A;
    private int B;
    private int C;
    private Typeface D;
    ...
    public ViewPager.e f28556a;

    /* renamed from: c  reason: collision with root package name */
    private LinearLayout.LayoutParams f28557c;

    /* renamed from: d  reason: collision with root package name */
    private LinearLayout.LayoutParams f28558d;

    /* renamed from: e  reason: collision with root package name */
    private final c f28559e;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public LinearLayout f28560f;
    /* access modifiers changed from: private */

    /* renamed from: g  reason: collision with root package name */
    public ViewPager f28561g;

    /* renamed from: h  reason: collision with root package name */
    private LayoutInflater f28562h;
    ...
    private void a(Context context) {
        this.f28562h = (LayoutInflater) context.getSystemService("layout_inflater");
    }

    public CJRPagerSlidingTabStrip(Context context, AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        this.f28559e = new c(this, (byte) 0);
        this.j = 0;
        this.k = 0;
        this.l = 0.0f;
        this.o = -10066330;
        ...
        this.E = 1;
        this.F = 0;
        this.G = R.drawable.pre_td_travel_travel_background_tab;
        setFillViewport(true);
        setWillNotDraw(false);
        this.f28560f = new LinearLayout(context);
        this.f28560f.setOrientation(0);
        this.f28560f.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
        addView(this.f28560f);
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f28555b);
        ...
        this.f28557c = new LinearLayout.LayoutParams(-2, -1);
        this.f28558d = new LinearLayout.LayoutParams(0, -1, 1.0f);
        if (this.H == null) {
    ...
    public void setViewPager(ViewPager viewPager) {
        this.f28561g = viewPager;
        if (viewPager.getAdapter() != null) {
            viewPager.setOnPageChangeListener(this.f28559e);
            a();
            return;
        }
    ...
    private void a() {
        this.f28560f.removeAllViews();
        this.f28563i = this.f28561g.getAdapter().getCount();
        for (int i2 = 0; i2 < this.f28563i; i2++) {
            if (this.f28561g.getAdapter() instanceof a) {
                int a2 = ((a) this.f28561g.getAdapter()).a();
                ImageButton imageButton = new ImageButton(getContext());
                imageButton.setImageResource(a2);
                a(i2, (View) imageButton);
            } else if (this.f28561g.getAdapter() instanceof b) {
                String charSequence = this.f28561g.getAdapter().getPageTitle(i2).toString();
                ((b) this.f28561g.getAdapter()).a(i2);
                View inflate = this.f28562h.inflate(R.layout.pre_td_lyt_tab_item, (ViewGroup) null);
                if (this.z > 0) {
                ...
                String charSequence2 = this.f28561g.getAdapter().getPageTitle(i2).toString();
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            public final void onGlobalLayout() {
                ...
                int unused = cJRPagerSlidingTabStrip.k = cJRPagerSlidingTabStrip.f28561g.getCurrentItem();
    ...
    private void a(final int i2, View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                CJRPagerSlidingTabStrip.this.f28561g.setCurrentItem(i2);
            }
        });
        int i3 = this.x;
        view.setPadding(i3, 0, i3, 0);
        this.f28560f.addView(view, i2, this.r ? this.f28558d : this.f28557c);
    }

    private void b() {
        for (int i2 = 0; i2 < this.f28563i; i2++) {
            View childAt = this.f28560f.getChildAt(i2);
    ...
    public void onDraw(Canvas canvas) {
        ...
        TextView textView;
        super.onDraw(canvas);
        if (!isInEditMode() && this.f28563i != 0) {
            int height = getHeight();
            this.m.setColor(this.o);
            int i3 = 0;
            while (true) {
                boolean z2 = true;
                if (i3 >= this.f28560f.getChildCount()) {
                    break;
                }
                View childAt = this.f28560f.getChildAt(i3);
            ...
            View childAt2 = this.f28560f.getChildAt(this.k);
            float left = (float) childAt2.getLeft();
            float right = (float) childAt2.getRight();
            if (this.l > 0.0f && (i2 = this.k) < this.f28563i - 1) {
                View childAt3 = this.f28560f.getChildAt(i2 + 1);
                float f2 = this.l;
            ...
            canvas.drawRect(0.0f, (float) (height - this.v), (float) this.f28560f.getWidth(), f3, this.m);
            this.n.setColor(this.q);
            for (int i4 = 0; i4 < this.f28563i - 1; i4++) {
                View childAt4 = this.f28560f.getChildAt(i4);
    ...
    class c implements ViewPager.e {
        ...
        public final void onPageScrolled(int i2, float f2, int i3) {
            ...
            CJRPagerSlidingTabStrip cJRPagerSlidingTabStrip = CJRPagerSlidingTabStrip.this;
            CJRPagerSlidingTabStrip.a(cJRPagerSlidingTabStrip, i2, (int) (((float) cJRPagerSlidingTabStrip.f28560f.getChildAt(i2).getWidth()) * f2));
            CJRPagerSlidingTabStrip.this.invalidate();
            if (CJRPagerSlidingTabStrip.this.f28556a != null) {
                CJRPagerSlidingTabStrip.this.f28556a.onPageScrolled(i2, f2, i3);
            }
        }
        ...
        public final void onPageScrollStateChanged(int i2) {
            if (i2 == 0) {
                CJRPagerSlidingTabStrip cJRPagerSlidingTabStrip = CJRPagerSlidingTabStrip.this;
                CJRPagerSlidingTabStrip.a(cJRPagerSlidingTabStrip, cJRPagerSlidingTabStrip.f28561g.getCurrentItem(), 0);
            }
            if (CJRPagerSlidingTabStrip.this.f28556a != null) {
                CJRPagerSlidingTabStrip.this.f28556a.onPageScrollStateChanged(i2);
            }
        }

        public final void onPageSelected(int i2) {
            if (CJRPagerSlidingTabStrip.this.f28556a != null) {
                CJRPagerSlidingTabStrip.this.f28556a.onPageSelected(i2);
            }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.k = savedState.f28567a;
        requestLayout();
    }

    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f28567a = this.k;
        return savedState;
    }
    ...
    static /* synthetic */ void a(CJRPagerSlidingTabStrip cJRPagerSlidingTabStrip, int i2, int i3) {
        if (cJRPagerSlidingTabStrip.f28563i != 0) {
            int left = cJRPagerSlidingTabStrip.f28560f.getChildAt(i2).getLeft() + i3;
            if (i2 > 0 || i3 > 0) {
