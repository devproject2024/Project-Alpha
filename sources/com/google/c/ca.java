...
interface ca {
    ...
    @Deprecated
    void b(int i2, Object obj, bm bmVar) throws IOException;

    void b(int i2, List<j> list) throws IOException;

    @Deprecated
    void b(int i2, List<?> list, bm bmVar) throws IOException;
