...
interface bk {
    ...
    <T> T a(bm<T> bmVar, r rVar) throws IOException;

    <T> T a(Class<T> cls, r rVar) throws IOException;

    void a(List<Double> list) throws IOException;

    <T> void a(List<T> list, bm<T> bmVar, r rVar) throws IOException;

    <K, V> void a(Map<K, V> map, am.a<K, V> aVar, r rVar) throws IOException;

    int b();

    @Deprecated
    <T> T b(bm<T> bmVar, r rVar) throws IOException;
    ...
    @Deprecated
    <T> void b(List<T> list, bm<T> bmVar, r rVar) throws IOException;
