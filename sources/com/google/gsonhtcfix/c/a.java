package com.google.gsonhtcfix.c;
...
public class a<T> {
    ...
    a(Type type2) {
        this.type = b.a((Type) com.google.gsonhtcfix.b.a.a(type2));
        this.rawType = b.b(this.type);
        this.hashCode = this.type.hashCode();
    }
    ...
    public boolean isAssignableFrom(Type type2) {
        ...
        if (type3 instanceof Class) {
            return this.rawType.isAssignableFrom(b.b(type2));
        }
        if (type3 instanceof ParameterizedType) {
            return isAssignableFrom(type2, (ParameterizedType) type3, new HashMap());
        }
        if (type3 instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(b.b(type2)) && isAssignableFrom(type2, (GenericArrayType) this.type);
        }
    ...
    private static boolean isAssignableFrom(Type type2, ParameterizedType parameterizedType, Map<String, Type> map) {
        while (true) {
            ...
            for (Type isAssignableFrom : b2.getGenericInterfaces()) {
                if (isAssignableFrom(isAssignableFrom, parameterizedType, new HashMap(map))) {
                    return true;
                }
            }
            type2 = b2.getGenericSuperclass();
            map = new HashMap<>(map);
        }
    }
