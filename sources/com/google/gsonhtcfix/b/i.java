...
public final class i {
    ...
    private static final Map<Class<?>, Class<?>> f39768a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f39769b;
    ...
    static {
        ...
        f39768a = Collections.unmodifiableMap(hashMap);
        f39769b = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public static boolean a(Type type) {
        return f39768a.containsKey(type);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = f39768a.get(a.a(cls));
