...
public final class b {
    ...
    private static final String[] f40302a = {"\nABCDEFGHIJKLMNOPQRSTUVWXYZ￺\u001c\u001d\u001e￻ ￼\"#$%&'()*+,-./0123456789:￱￲￳￴￸", "`abcdefghijklmnopqrstuvwxyz￺\u001c\u001d\u001e￻{￼}~;<=>?[\\]^_ ,./:@!|￼￵￶￼￰￲￳￴￷", "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚ￺\u001c\u001d\u001eÛÜÝÞßª¬±²³µ¹º¼½¾￷ ￹￳￴￸", "àáâãäåæçèéêëìíîïðñòóôõö÷øùú￺\u001c\u001d\u001e￻ûüýþÿ¡¨«¯°´·¸»¿￷ ￲￹￴￸", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a￺￼￼\u001b￻\u001c\u001d\u001e\u001f ¢£¤¥¦§©­®¶￷ ￲￳￹￸", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?"};
    ...
    public static e a(byte[] bArr, int i2) {
        ...
        if (i2 == 2 || i2 == 3) {
            if (i2 == 2) {
                str = new DecimalFormat("0000000000".substring(0, a(bArr, new byte[]{39, 40, 41, 42, 31, 32}))).format((long) a(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2}));
            } else {
                str = String.valueOf(new char[]{f40302a[0].charAt(a(bArr, new byte[]{39, 40, 41, 42, 31, 32})), f40302a[0].charAt(a(bArr, new byte[]{33, 34, 35, 36, 25, 26})), f40302a[0].charAt(a(bArr, new byte[]{27, 28, 29, 30, 19, 20})), f40302a[0].charAt(a(bArr, new byte[]{21, 22, 23, 24, 13, 14})), f40302a[0].charAt(a(bArr, new byte[]{15, 16, 17, 18, 7, 8})), f40302a[0].charAt(a(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
            }
            DecimalFormat decimalFormat = new DecimalFormat("000");
            String format = decimalFormat.format((long) a(bArr, new byte[]{TarHeader.LF_DIR, TarHeader.LF_FIFO, 43, 44, 45, 46, 47, TarHeader.LF_NORMAL, 37, 38}));
            String format2 = decimalFormat.format((long) a(bArr, new byte[]{TarHeader.LF_CONTIG, 56, 57, 58, 59, 60, TarHeader.LF_LINK, TarHeader.LF_SYMLINK, TarHeader.LF_CHR, TarHeader.LF_BLK}));
    ...
    private static java.lang.String a(byte[] r12, int r13, int r14) {
        ...
        L_0x0085:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.d.a.b.a(byte[], int, int):java.lang.String");
    }
}
