...
final class m {
    ...
    final List<int[]> f40380a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    final List<String> f40381b = new ArrayList();

    m() {
    }

    private void a(int[] iArr, String str) {
        this.f40380a.add(iArr);
        this.f40381b.add(str);
    }
    ...
    public final synchronized void a() {
        if (this.f40380a.isEmpty()) {
            ...
            a(new int[]{700, 709}, H5Param.DEFAULT_LONG_TRANSPARENT_TITLE_TEXTAUTO);
            a(new int[]{729}, "IL");
