...
public final class j {
    ...
    private static final int[] f40513d = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: e  reason: collision with root package name */
    private static final j[] f40514e = b();
    ...
    private final b[] f40518f;

    private j(int i2, int[] iArr, b... bVarArr) {
        this.f40515a = i2;
        this.f40516b = iArr;
        this.f40518f = bVarArr;
        int i3 = bVarArr[0].f40521a;
        int i4 = 0;
        for (a aVar : bVarArr[0].f40522b) {
            i4 += aVar.f40519a * (aVar.f40520b + i3);
        }
        this.f40517c = i4;
    }

    public final int a() {
        return (this.f40515a * 4) + 17;
    }

    public final b a(f fVar) {
        return this.f40518f[fVar.ordinal()];
    }

    public static j a(int i2) throws h {
        if (i2 % 4 == 1) {
            try {
                return b((i2 - 17) / 4);
    ...
    public static final class b {
        ...
        b(int i2, a... aVarArr) {
            this.f40521a = i2;
            this.f40522b = aVarArr;
        }

        public final int a() {
            int i2 = 0;
            for (a aVar : this.f40522b) {
                i2 += aVar.f40519a;
            }
            return i2;
        }
