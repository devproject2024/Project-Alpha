...
public final class z {
    static void a(Map<String, String> map, String str) {
        if ("af".equals(str)) {
        ...
        } else if (H5Param.ENABLE_SCROLLBAR.equals(str)) {
            ...
            map.put("update_youtube_app_action", "Actualizar YouTube");
        } else if (H5AppUtil.short_prepareTime.equals(str)) {
        ...
        } else if (H5Param.PREFETCH_LOCATION.equals(str)) {
        ...
        } else if (H5Param.SHOW_LOADING.equals(str)) {
        ...
        } else if (H5Param.SHOW_REPORT_BTN.equals(str)) {
        ...
        } else if (H5Param.SHOW_TITLE_LOADING.equals(str)) {
