...
public interface p extends IInterface {
    ...
    public static abstract class a extends Binder implements p {
        ...
        static class C0620a implements p {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f37575a;

            C0620a(IBinder iBinder) {
                this.f37575a = iBinder;
            }
            ...
            public final IBinder a() throws RemoteException {
                ...
                try {
                    ...
                    this.f37575a.transact(1, obtain, obtain2, 0);
            ...
            public final o a(m mVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IYouTubeService");
                    obtain.writeStrongBinder(mVar != null ? mVar.asBinder() : null);
                    this.f37575a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final void a(boolean z) throws RemoteException {
                ...
                try {
                    ...
                    this.f37575a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static p a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof p)) ? new C0620a(iBinder) : (p) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i2, Parcel parcel, Parcel parcel2, int i3) throws RemoteException {
            ...
            if (i2 == 1) {
                ...
                if (readStrongBinder == null) {
                    ...
                    mVar = (queryLocalInterface == null || !(queryLocalInterface instanceof m)) ? new m.a.C0618a(readStrongBinder) : (m) queryLocalInterface;
                }
                o a3 = a(mVar);
                parcel2.writeNoException();
                if (a3 != null) {
    ...
    o a(m mVar) throws RemoteException;
