...
final class er {
    ...
    private static final et f10225a;

    public static boolean a(byte[] bArr) {
        return f10225a.b(bArr, 0, bArr.length);
    }
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return f10225a.a(charSequence, bArr, i2, i3);
    }
