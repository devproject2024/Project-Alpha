...
interface fc {
    ...
    void a(int i2, at atVar) throws IOException;

    <K, V> void a(int i2, cu<K, V> cuVar, Map<K, V> map) throws IOException;

    void a(int i2, Object obj) throws IOException;

    void a(int i2, Object obj, dr drVar) throws IOException;

    void a(int i2, String str) throws IOException;

    void a(int i2, List<String> list) throws IOException;

    void a(int i2, List<?> list, dr drVar) throws IOException;
    ...
    @Deprecated
    void b(int i2, Object obj, dr drVar) throws IOException;

    void b(int i2, List<at> list) throws IOException;

    @Deprecated
    void b(int i2, List<?> list, dr drVar) throws IOException;
