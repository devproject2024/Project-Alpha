...
/* renamed from: com.google.android.gms.internal.firebase-perf.ha  reason: invalid package */
interface ha {
    int a();
    ...
    void a(int i2, co coVar) throws IOException;

    <K, V> void a(int i2, es<K, V> esVar, Map<K, V> map) throws IOException;

    void a(int i2, Object obj) throws IOException;

    void a(int i2, Object obj, fp fpVar) throws IOException;

    void a(int i2, String str) throws IOException;

    void a(int i2, List<String> list) throws IOException;

    void a(int i2, List<?> list, fp fpVar) throws IOException;
    ...
    @Deprecated
    void b(int i2, Object obj, fp fpVar) throws IOException;

    void b(int i2, List<co> list) throws IOException;

    @Deprecated
    void b(int i2, List<?> list, fp fpVar) throws IOException;
