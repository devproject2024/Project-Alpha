...
public class ao {
    ...
    public static final Uri f10445a = Uri.parse("content://com.google.android.gsf.gservices");

    /* renamed from: b  reason: collision with root package name */
    public static final Pattern f10446b = Pattern.compile("^(1|true|t|on|yes|y)$", 2);

    /* renamed from: c  reason: collision with root package name */
    public static final Pattern f10447c = Pattern.compile("^(0|false|f|off|no|n)$", 2);

    /* renamed from: d  reason: collision with root package name */
    private static final Uri f10448d = Uri.parse("content://com.google.android.gsf.gservices/prefix");
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public static final AtomicBoolean f10449e = new AtomicBoolean();

    /* renamed from: f  reason: collision with root package name */
    private static HashMap<String, String> f10450f;

    /* renamed from: g  reason: collision with root package name */
    private static final HashMap<String, Boolean> f10451g = new HashMap<>();

    /* renamed from: h  reason: collision with root package name */
    private static final HashMap<String, Integer> f10452h = new HashMap<>();

    /* renamed from: i  reason: collision with root package name */
    private static final HashMap<String, Long> f10453i = new HashMap<>();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00af, code lost:
        r12 = r12.query(f10445a, (java.lang.String[]) null, (java.lang.String) null, new java.lang.String[]{r13}, (java.lang.String) null);
     */
    ...
    public static java.lang.String a(android.content.ContentResolver r12, java.lang.String r13) {
        /*
            java.lang.Class<com.google.android.gms.internal.measurement.ao> r0 = com.google.android.gms.internal.measurement.ao.class
            monitor-enter(r0)
            java.util.HashMap<java.lang.String, java.lang.String> r1 = f10450f     // Catch:{ all -> 0x00f5 }
            r2 = 1
            r3 = 0
            if (r1 != 0) goto L_0x0029
            java.util.concurrent.atomic.AtomicBoolean r1 = f10449e     // Catch:{ all -> 0x00f5 }
            r1.set(r3)     // Catch:{ all -> 0x00f5 }
            java.util.HashMap r1 = new java.util.HashMap     // Catch:{ all -> 0x00f5 }
            r1.<init>()     // Catch:{ all -> 0x00f5 }
            f10450f = r1     // Catch:{ all -> 0x00f5 }
            java.lang.Object r1 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r1.<init>()     // Catch:{ all -> 0x00f5 }
            k = r1     // Catch:{ all -> 0x00f5 }
            l = r3     // Catch:{ all -> 0x00f5 }
            android.net.Uri r1 = f10445a     // Catch:{ all -> 0x00f5 }
            com.google.android.gms.internal.measurement.an r4 = new com.google.android.gms.internal.measurement.an     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0029:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r1 = f10451g     // Catch:{ all -> 0x00f5 }
            r1.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r1 = f10452h     // Catch:{ all -> 0x00f5 }
            r1.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Long> r1 = f10453i     // Catch:{ all -> 0x00f5 }
            r1.clear()     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0053:
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r4 = f10450f     // Catch:{ all -> 0x00f5 }
            boolean r4 = r4.containsKey(r13)     // Catch:{ all -> 0x00f5 }
            r5 = 0
            if (r4 == 0) goto L_0x006c
            java.util.HashMap<java.lang.String, java.lang.String> r12 = f10450f     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0086:
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r3 = f10450f     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00f5:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.ao.a(android.content.ContentResolver, java.lang.String):java.lang.String");
    }

    private static void a(Object obj, String str, String str2) {
        synchronized (ao.class) {
            if (obj == k) {
                f10450f.put(str, str2);
            }
        }
    }

    private static Map<String, String> a(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(f10448d, (String[]) null, (String) null, strArr, (String) null);
