...
final class hc extends gx {
    ...
    public final int b(byte[] r13, int r14, int r15) {
        ...
        L_0x0018:
            ...
            long r10 = r8 + r6
            byte r0 = com.google.android.gms.internal.measurement.gt.a((byte[]) r13, (long) r8)
        ...
        L_0x002c:
            ...
            long r8 = r4 + r6
            byte r14 = com.google.android.gms.internal.measurement.gt.a((byte[]) r13, (long) r4)
        ...
        L_0x0067:
            int r15 = r15 + -2
            long r10 = r4 + r6
            byte r4 = com.google.android.gms.internal.measurement.gt.a((byte[]) r13, (long) r4)
        ...
        L_0x007d:
            long r4 = r10 + r6
            byte r14 = com.google.android.gms.internal.measurement.gt.a((byte[]) r13, (long) r10)
        ...
        L_0x008d:
            int r15 = r15 + -3
            long r10 = r4 + r6
            byte r0 = com.google.android.gms.internal.measurement.gt.a((byte[]) r13, (long) r4)
        ...
        L_0x00b1:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.hc.b(byte[], int, int):int");
    }

    /* access modifiers changed from: package-private */
    public final String c(byte[] bArr, int i2, int i3) throws eg {
        if ((i2 | i3 | ((bArr.length - i2) - i3)) >= 0) {
            int i4 = i2 + i3;
            char[] cArr = new char[i3];
            int i5 = 0;
            while (r13 < i4) {
                byte a2 = gt.a(bArr, (long) r13);
                if (!(a2 >= 0)) {
                    break;
                }
                i2 = r13 + 1;
            ...
            while (r13 < i4) {
                int i7 = r13 + 1;
                byte a3 = gt.a(bArr, (long) r13);
                if (a3 >= 0) {
                    int i8 = i6 + 1;
                    cArr[i6] = (char) a3;
                    while (i7 < i4) {
                        byte a4 = gt.a(bArr, (long) i7);
                        if (!(a4 >= 0)) {
                            break;
                        }
                        i7++;
                    ...
                    if (i7 < i4) {
                        gy.a(a3, gt.a(bArr, (long) i7), cArr, i6);
                        r13 = i7 + 1;
                        i6++;
                    } else {
                        throw eg.zzh();
                    ...
                    if (i7 < i4 - 1) {
                        int i9 = i7 + 1;
                        gy.a(a3, gt.a(bArr, (long) i7), gt.a(bArr, (long) i9), cArr, i6);
                        r13 = i9 + 1;
                        i6++;
                    } else {
                        throw eg.zzh();
                    ...
                    int i10 = i7 + 1;
                    byte a5 = gt.a(bArr, (long) i7);
                    int i11 = i10 + 1;
                    gy.a(a3, a5, gt.a(bArr, (long) i10), gt.a(bArr, (long) i11), cArr, i6);
                    r13 = i11 + 1;
                    i6 = i6 + 1 + 1;
                } else {
                    throw eg.zzh();
    ...
    public final int a(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x001a:
            ...
            long r11 = r11 + r4
            byte r3 = (byte) r13
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r4, (byte) r3)
            int r2 = r2 + 1
            r4 = r11
            goto L_0x001a
        L_0x002f:
        ...
        L_0x0033:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r4, (byte) r13)
            r4 = r11
            r12 = r14
        L_0x0047:
        ...
        L_0x004b:
            ...
            r5 = r5 | r13
            byte r5 = (byte) r5
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r14, (byte) r5)
            r20 = r11
            r11 = 128(0x80, float:1.794E-43)
            r12 = r3
            r4 = r20
        ...
        L_0x007f:
            ...
            r5 = r5 | r11
            byte r5 = (byte) r5
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r3, (byte) r5)
            r12 = r18
            r4 = 1
            goto L_0x0047
        L_0x00ae:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r4, (byte) r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.measurement.gt.a((byte[]) r1, (long) r14, (byte) r2)
            r2 = r3
        L_0x00fb:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0106:
            r2 = r3
        L_0x0107:
            com.google.android.gms.internal.measurement.gz r0 = new com.google.android.gms.internal.measurement.gz
            int r2 = r2 + -1
            r0.<init>(r2, r8)
            throw r0
        L_0x010f:
        ...
        L_0x0146:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.hc.a(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    private static int a(byte[] bArr, int i2, long j, int i3) {
        ...
        if (i3 == 1) {
            return gw.b(i2, gt.a(bArr, j));
        }
        if (i3 == 2) {
            return gw.b(i2, (int) gt.a(bArr, j), (int) gt.a(bArr, j + 1));
        }
