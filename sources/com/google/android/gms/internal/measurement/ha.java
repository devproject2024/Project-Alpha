        ...
        if ((i2 | i3 | ((bArr.length - i2) - i3)) >= 0) {
            ...
            while (r13 < i4) {
                ...
                if (b3 >= 0) {
                    ...
                    if (i7 < i4 - 1) {
                        int i9 = i7 + 1;
                        gy.a(b3, bArr[i7], bArr[i9], cArr, i6);
                        r13 = i9 + 1;
                        i6++;
                    } else {
                        throw eg.zzh();
                    ...
                    byte b5 = bArr[i7];
                    int i11 = i10 + 1;
                    gy.a(b3, b5, bArr[i10], bArr[i11], cArr, i6);
                    r13 = i11 + 1;
                    i6 = i6 + 1 + 1;
                } else {
                    throw eg.zzh();
