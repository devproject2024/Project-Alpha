...
final class gw {
    ...
    private static final gx f10721a;

    public static boolean a(byte[] bArr) {
        return f10721a.a(bArr, 0, bArr.length);
    }
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return f10721a.a(charSequence, bArr, i2, i3);
    }

    static String b(byte[] bArr, int i2, int i3) throws eg {
        return f10721a.c(bArr, i2, i3);
    }
