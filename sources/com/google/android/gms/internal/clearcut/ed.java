...
final class ed {
    ...
    private static final ee f9339a = (eb.a() && eb.b() ? new eh() : new ef());
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return f9339a.a(charSequence, bArr, i2, i3);
    }
    ...
    static void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            eeVar.a(charSequence, byteBuffer);
        } else {
            ee.b(charSequence, byteBuffer);
        }
    }

    public static boolean a(byte[] bArr) {
        return f9339a.a(bArr, 0, bArr.length);
    }

    public static boolean a(byte[] bArr, int i2, int i3) {
        return f9339a.a(bArr, i2, i3);
    }
