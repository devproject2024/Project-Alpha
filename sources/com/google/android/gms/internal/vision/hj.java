...
final class hj {
    ...
    private static final hk f11227a;

    public static boolean a(byte[] bArr) {
        return f11227a.a(bArr, 0, bArr.length);
    }
    ...
    static int a(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return f11227a.a(charSequence, bArr, i2, i3);
    }

    static String b(byte[] bArr, int i2, int i3) throws eu {
        return f11227a.c(bArr, i2, i3);
    }
