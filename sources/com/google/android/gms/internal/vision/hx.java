...
interface hx {
    ...
    void a(int i2, cz czVar) throws IOException;

    <K, V> void a(int i2, fj<K, V> fjVar, Map<K, V> map) throws IOException;

    void a(int i2, Object obj) throws IOException;

    void a(int i2, Object obj, gi giVar) throws IOException;

    void a(int i2, String str) throws IOException;

    void a(int i2, List<String> list) throws IOException;

    void a(int i2, List<?> list, gi giVar) throws IOException;
    ...
    @Deprecated
    void b(int i2, Object obj, gi giVar) throws IOException;

    void b(int i2, List<cz> list) throws IOException;

    @Deprecated
    void b(int i2, List<?> list, gi giVar) throws IOException;
