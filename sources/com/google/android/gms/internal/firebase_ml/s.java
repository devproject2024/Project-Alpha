...
interface s {
    ...
    void a(int i2, fh fhVar) throws IOException;

    <K, V> void a(int i2, hi<K, V> hiVar, Map<K, V> map) throws IOException;

    void a(int i2, Object obj) throws IOException;

    void a(int i2, Object obj, ig igVar) throws IOException;

    void a(int i2, String str) throws IOException;

    void a(int i2, List<String> list) throws IOException;

    void a(int i2, List<?> list, ig igVar) throws IOException;
    ...
    @Deprecated
    void b(int i2, Object obj, ig igVar) throws IOException;

    void b(int i2, List<fh> list) throws IOException;

    @Deprecated
    void b(int i2, List<?> list, ig igVar) throws IOException;
