...
final class b {
    ...
    static final synchronized void b(Context context, Set<File> set) {
        synchronized (b.class) {
            ...
            for (File path : set) {
                int intValue = ((Integer) an.a((Object) assets, "addAssetPath", Integer.class, String.class, path.getPath())).intValue();
    ...
    public final synchronized boolean a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        ...
        L_0x0018:
            ...
            com.google.android.play.core.splitcompat.e r3 = r4.f37498a     // Catch:{ Exception -> 0x0041, all -> 0x0039 }
            java.io.File r2 = r3.a((java.lang.String) r2)     // Catch:{ Exception -> 0x0041, all -> 0x0039 }
        ...
        L_0x004a:
            ...
            goto L_0x0037
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.b.a(android.content.Context, java.util.Set):boolean");
    }
}
