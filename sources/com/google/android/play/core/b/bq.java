...
public final class bq {
    ...
    private static Pair<ByteBuffer, Long> a(RandomAccessFile randomAccessFile, int i2) throws IOException {
        int i3;
    ...
    private static void a(int i2, byte[] bArr) {
        bArr[1] = (byte) (i2 & PriceRangeSeekBar.INVALID_POINTER_ID);
        bArr[2] = (byte) ((i2 >>> 8) & PriceRangeSeekBar.INVALID_POINTER_ID);
        bArr[3] = (byte) ((i2 >>> 16) & PriceRangeSeekBar.INVALID_POINTER_ID);
        bArr[4] = (byte) (i2 >> 24);
    }
    ...
    private static void a(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            bc bcVar = new bc(fileChannel, 0, j);
            bc bcVar2 = new bc(fileChannel, j2, j3 - j2);
            ...
            try {
                byte[][] a2 = a(iArr, new ab[]{bcVar, bcVar2, aVar});
                while (i2 < iArr.length) {
                    int i4 = iArr[i2];
                    Map<Integer, byte[]> map2 = map;
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i4)), a2[i2])) {
                        i2++;
                    } else {
    ...
    private static java.security.cert.X509Certificate[] a(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = b((java.nio.ByteBuffer) r22)
            java.nio.ByteBuffer r1 = b((java.nio.ByteBuffer) r22)
            byte[] r2 = c((java.nio.ByteBuffer) r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = b((java.nio.ByteBuffer) r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            goto L_0x0016
        L_0x0055:
            byte[] r7 = c((java.nio.ByteBuffer) r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x013d:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = b((java.nio.ByteBuffer) r0)
        ...
        L_0x0153:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = b((java.nio.ByteBuffer) r1)     // Catch:{ IOException -> 0x0180, BufferUnderflowException -> 0x017e }
            ...
            byte[] r6 = c((java.nio.ByteBuffer) r8)     // Catch:{ IOException -> 0x0180, BufferUnderflowException -> 0x017e }
            goto L_0x0153
        L_0x0176:
        ...
        L_0x01b9:
            ...
            throw r0
        L_0x01c9:
            java.nio.ByteBuffer r0 = b((java.nio.ByteBuffer) r0)
        ...
        L_0x01d3:
            ...
            int r3 = r3 + r15
            byte[] r4 = c((java.nio.ByteBuffer) r0)
            ...
            com.google.android.play.core.b.bo r7 = new com.google.android.play.core.b.bo
            r7.<init>(r5, r4)
            r1.add(r7)
            goto L_0x01d3
        L_0x01f4:
    ...
    private static byte[][] a(int[] iArr, ab[] abVarArr) throws DigestException {
        long j;
        int i2;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (abVarArr[i3].a() + 1048575) / 1048576;
            i3++;
        }
        if (j3 < 2097151) {
            int i4 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((c(iArr2[i5]) * i4) + 5)];
                bArr2[0] = 90;
                a(i4, bArr2);
                bArr[i5] = bArr2;
                i5++;
            ...
            while (i7 < i2) {
                ...
                while (a2 > j2) {
                    ...
                    long j5 = j4;
                    try {
                        abVar.a(messageDigestArr, j5, min);
                        int i11 = 0;
                        while (i11 < iArr2.length) {
                            ...
                            int digest = messageDigest.digest(bArr5, (i10 * c2) + 5, c2);
                            if (digest == c2) {
                                i11++;
                                bArr3 = bArr4;
                                i7 = i13;
            ...
            while (i15 < iArr2.length) {
                ...
                String b3 = b(i16);
                try {
                    bArr7[i15] = MessageDigest.getInstance(b3).digest(bArr8);
                    i15++;
    ...
    public static X509Certificate[][] a(String str) throws bn, SecurityException, IOException {
        ...
        try {
            ...
            if (a2 != null) {
                ...
                a(byteBuffer2);
                long a3 = a(byteBuffer2, byteBuffer2.position() + 16);
                if (a3 < longValue) {
                    a(byteBuffer2);
                    if (a(byteBuffer2, byteBuffer2.position() + 12) + a3 != longValue) {
                                                ...
                                                while (slice.hasRemaining()) {
                                                    ...
                                                    if (slice.remaining() >= i2) {
                                                        ...
                                                        if (i5 > slice.remaining()) {
                                                            ...
                                                            X509Certificate[][] a4 = a(randomAccessFile.getChannel(), new bm(b(slice, i5 - 4), longValue2, a3, longValue, byteBuffer2));
    ...
    private static X509Certificate[][] a(FileChannel fileChannel, bm bmVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer b2 = b(bmVar.f37291a);
                int i2 = 0;
                while (b2.hasRemaining()) {
                    i2++;
                    try {
                        arrayList.add(a(b(b2), (Map<Integer, byte[]>) hashMap, instance));
                ...
                if (i2 <= 0) {
                    ...
                    a(hashMap, fileChannel, bmVar.f37292b, bmVar.f37293c, bmVar.f37294d, bmVar.f37295e);
