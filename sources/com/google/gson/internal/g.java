...
public final class g<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public final V remove(Object obj) {
        ...
        if (removeInternalByKey != null) {
            return removeInternalByKey.f39625g;
        }
        return null;
    }
    ...
    public final d<K, V> find(K k, boolean z) {
        ...
        if (dVar3 != null) {
            ...
            while (true) {
                if (comparable != null) {
                    i2 = comparable.compareTo(dVar3.f39624f);
                } else {
                    i2 = comparator2.compare(k, dVar3.f39624f);
                }
                if (i2 != 0) {
                    if (i2 < 0) {
                        dVar2 = dVar3.f39620b;
        ...
        if (dVar3 != null) {
            dVar = new d<>(dVar3, k, dVar4, dVar4.f39623e);
            if (i2 < 0) {
                dVar3.f39620b = dVar;
            } else {
                dVar3.f39621c = dVar;
    ...
    public final d<K, V> findByEntry(Map.Entry<?, ?> entry) {
        ...
        if (findByObject != null && equal(findByObject.f39625g, entry.getValue())) {
            return findByObject;
        }
        return null;
    }
    ...
    public final void removeInternal(d<K, V> dVar, boolean z) {
        int i2;
        if (z) {
            dVar.f39623e.f39622d = dVar.f39622d;
            dVar.f39622d.f39623e = dVar.f39623e;
        }
        d<K, V> dVar2 = dVar.f39620b;
        d<K, V> dVar3 = dVar.f39621c;
        d<K, V> dVar4 = dVar.f39619a;
        int i3 = 0;
        ...
        if (dVar2.f39626h > dVar3.f39626h) {
            d<K, V> dVar5 = dVar2.f39621c;
            while (true) {
                d<K, V> dVar6 = dVar5;
                dVar3 = dVar2;
                dVar2 = dVar6;
        ...
        dVar3.f39626h = Math.max(i2, i3) + 1;
        replaceInParent(dVar, dVar3);
    }
    ...
    private void rebalance(d<K, V> dVar, boolean z) {
        while (dVar != null) {
            ...
            d<K, V> dVar3 = dVar.f39621c;
            int i2 = 0;
            int i3 = dVar2 != null ? dVar2.f39626h : 0;
            int i4 = dVar3 != null ? dVar3.f39626h : 0;
            int i5 = i3 - i4;
            if (i5 == -2) {
                d<K, V> dVar4 = dVar3.f39620b;
                d<K, V> dVar5 = dVar3.f39621c;
                int i6 = dVar5 != null ? dVar5.f39626h : 0;
                if (dVar4 != null) {
                    i2 = dVar4.f39626h;
                }
                int i7 = i2 - i6;
                ...
                d<K, V> dVar6 = dVar2.f39620b;
                d<K, V> dVar7 = dVar2.f39621c;
                int i8 = dVar7 != null ? dVar7.f39626h : 0;
                if (dVar6 != null) {
                    i2 = dVar6.f39626h;
                }
                int i9 = i2 - i8;
    ...
    private void rotateLeft(d<K, V> dVar) {
        ...
        dVar.f39619a = dVar3;
        int i2 = 0;
        dVar.f39626h = Math.max(dVar2 != null ? dVar2.f39626h : 0, dVar4 != null ? dVar4.f39626h : 0) + 1;
        int i3 = dVar.f39626h;
        if (dVar5 != null) {
            i2 = dVar5.f39626h;
        }
        dVar3.f39626h = Math.max(i3, i2) + 1;
    }

    private void rotateRight(d<K, V> dVar) {
        d<K, V> dVar2 = dVar.f39620b;
        d<K, V> dVar3 = dVar.f39621c;
        d<K, V> dVar4 = dVar2.f39620b;
        d<K, V> dVar5 = dVar2.f39621c;
        dVar.f39620b = dVar5;
        if (dVar5 != null) {
            dVar5.f39619a = dVar;
        ...
        dVar.f39619a = dVar2;
        int i2 = 0;
        dVar.f39626h = Math.max(dVar3 != null ? dVar3.f39626h : 0, dVar5 != null ? dVar5.f39626h : 0) + 1;
        int i3 = dVar.f39626h;
        if (dVar4 != null) {
            i2 = dVar4.f39626h;
        }
        dVar2.f39626h = Math.max(i3, i2) + 1;
    }
    ...
    static final class d<K, V> implements Map.Entry<K, V> {
        ...
        public final String toString() {
            return this.f39624f + "=" + this.f39625g;
        }
    }
    ...
    abstract class c<T> implements Iterator<T> {
        ...
        /* renamed from: b  reason: collision with root package name */
        d<K, V> f39615b = g.this.header.f39622d;

        /* renamed from: c  reason: collision with root package name */
        d<K, V> f39616c = null;

        /* renamed from: d  reason: collision with root package name */
        int f39617d = g.this.modCount;

        c() {
        }

        public final boolean hasNext() {
            return this.f39615b != g.this.header;
        }

        /* access modifiers changed from: package-private */
        public final d<K, V> a() {
            d<K, V> dVar = this.f39615b;
            if (dVar == g.this.header) {
                throw new NoSuchElementException();
            } else if (g.this.modCount == this.f39617d) {
                this.f39615b = dVar.f39622d;
                this.f39616c = dVar;
                return dVar;
            } else {
        ...
        public final void remove() {
            d<K, V> dVar = this.f39616c;
            if (dVar != null) {
                g.this.removeInternal(dVar, true);
                this.f39616c = null;
                this.f39617d = g.this.modCount;
                return;
            }
