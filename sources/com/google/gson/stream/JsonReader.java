        ...
        e.INSTANCE = new e() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof c) {
                    c cVar = (c) jsonReader;
                    cVar.a(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) cVar.a()).next();
                    cVar.a(entry.getValue());
                    cVar.a((Object) new r((String) entry.getKey()));
                    return;
                }
