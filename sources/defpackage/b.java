...
public final class b {
    ...
    private static final String f14581b = f14581b;

    /* renamed from: c  reason: collision with root package name */
    private static final String f14582c = ".";
    ...
    public static byte[] a(String str, String str2) throws SignatureException, UnsupportedEncodingException, NoSuchProviderException {
        try {
            ...
            if (str2 != null) {
                ...
                Mac instance = Mac.getInstance(f14581b);
                k.a((Object) instance, "Mac.getInstance(\"HmacSHA256\")");
                instance.init(new SecretKeySpec(bytes, f14581b));
