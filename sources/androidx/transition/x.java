...
final class x {
    ...
    private static final boolean f4844a = (Build.VERSION.SDK_INT >= 19);

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f4845b = (Build.VERSION.SDK_INT >= 18);

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f4846c;
    ...
    static android.view.View a(android.view.ViewGroup r16, android.view.View r17, android.view.View r18) {
        /*
            ...
            androidx.transition.aj.a((android.view.View) r1, (android.graphics.Matrix) r2)
            androidx.transition.aj.b(r0, r2)
        ...
        L_0x0106:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.x.a(android.view.ViewGroup, android.view.View, android.view.View):android.view.View");
    }
    ...
    static class a implements TypeEvaluator<Matrix> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f4847a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f4848b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f4849c = new Matrix();

        a() {
        }

        public final /* synthetic */ Object evaluate(float f2, Object obj, Object obj2) {
            ((Matrix) obj).getValues(this.f4847a);
            ((Matrix) obj2).getValues(this.f4848b);
            for (int i2 = 0; i2 < 9; i2++) {
                float[] fArr = this.f4848b;
                float f3 = fArr[i2];
                float[] fArr2 = this.f4847a;
                fArr[i2] = fArr2[i2] + ((f3 - fArr2[i2]) * f2);
            }
            this.f4849c.setValues(this.f4848b);
            return this.f4849c;
        }
    }
}
