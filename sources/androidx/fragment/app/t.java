    ...
    public final void a(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        r.a(view, new Runnable() {
            public final void run() {
                for (int i2 = 0; i2 < size; i2++) {
                    u.a((View) arrayList5.get(i2), (String) arrayList6.get(i2));
                    u.a((View) arrayList7.get(i2), (String) arrayList4.get(i2));
                }
            }
        });
    }
    ...
    public final void a(ArrayList<View> arrayList, View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                z = ((bool == null || !bool.booleanValue()) && viewGroup.getBackground() == null && u.x(viewGroup) == null) ? false : true;
            }
            if (z) {
