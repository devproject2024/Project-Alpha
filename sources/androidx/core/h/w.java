...
public final class w {
    ...
    public static void a(ViewParent viewParent, View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        ...
        if (viewParent2 instanceof o) {
            ((o) viewParent2).a(view, i2, i3, i4, i5, i6, iArr);
            return;
        }
        iArr[0] = iArr[0] + i4;
        iArr[1] = iArr[1] + i5;
        if (viewParent2 instanceof n) {
            ((n) viewParent2).a(view, i2, i3, i4, i5, i6);
        } else if (i6 != 0) {
        } else {
            if (Build.VERSION.SDK_INT >= 21) {
                try {
            ...
            } else if (viewParent2 instanceof m) {
                ((m) viewParent2).onNestedScroll(view, i2, i3, i4, i5);
            }
        }
    }
