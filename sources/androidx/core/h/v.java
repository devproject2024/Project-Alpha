...
public final class v {
    ...
    private static Method f3138a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f3138a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float d(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f3138a) != null) {
            try {
