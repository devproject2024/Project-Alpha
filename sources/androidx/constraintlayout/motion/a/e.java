...
public final class e extends b {
    ...
    public e(double[] dArr, double[][] dArr2) {
        ...
        int i2 = length - 1;
        double[][] dArr5 = (double[][]) Array.newInstance(cls, new int[]{i2, length2});
    ...
    public final void a(double d2, double[] dArr) {
        double[] dArr2 = this.f2219a;
        int length = dArr2.length;
        int i2 = 0;
        int length2 = this.f2220b[0].length;
        if (d2 <= dArr2[0]) {
            for (int i3 = 0; i3 < length2; i3++) {
                dArr[i3] = this.f2220b[0][i3];
            }
            return;
        }
        int i4 = length - 1;
        ...
        int i5 = 0;
        while (i5 < i4) {
            if (d2 == this.f2219a[i5]) {
                for (int i6 = 0; i6 < length2; i6++) {
                    dArr[i6] = this.f2220b[i5][i6];
                }
            }
            double[] dArr3 = this.f2219a;
            int i7 = i5 + 1;
            if (d2 < dArr3[i7]) {
                double d3 = dArr3[i7] - dArr3[i5];
                double d4 = (d2 - dArr3[i5]) / d3;
                while (i2 < length2) {
                    double[][] dArr4 = this.f2220b;
                    double d5 = dArr4[i5][i2];
                    double d6 = dArr4[i7][i2];
                    double[][] dArr5 = this.f2221c;
    ...
    public final void a(double d2, float[] fArr) {
        double[] dArr = this.f2219a;
        int length = dArr.length;
        int i2 = 0;
        int length2 = this.f2220b[0].length;
        if (d2 <= dArr[0]) {
            for (int i3 = 0; i3 < length2; i3++) {
                fArr[i3] = (float) this.f2220b[0][i3];
            }
            return;
        }
        int i4 = length - 1;
        if (d2 >= dArr[i4]) {
            while (i2 < length2) {
                fArr[i2] = (float) this.f2220b[i4][i2];
                i2++;
            }
            return;
        }
        ...
        while (i5 < i4) {
            if (d2 == this.f2219a[i5]) {
                for (int i6 = 0; i6 < length2; i6++) {
                    fArr[i6] = (float) this.f2220b[i5][i6];
                }
            }
            double[] dArr2 = this.f2219a;
            int i7 = i5 + 1;
            if (d2 < dArr2[i7]) {
                ...
                while (i2 < length2) {
                    double[][] dArr3 = this.f2220b;
                    double d5 = dArr3[i5][i2];
                    double d6 = dArr3[i7][i2];
                    double[][] dArr4 = this.f2221c;
    ...
    public final double a(double d2) {
        ...
        int length = dArr.length;
        if (d2 <= dArr[0]) {
            return this.f2220b[0][0];
        }
        int i2 = length - 1;
        if (d2 >= dArr[i2]) {
            return this.f2220b[i2][0];
        }
        int i3 = 0;
        while (i3 < i2) {
            double[] dArr2 = this.f2219a;
            if (d2 == dArr2[i3]) {
                return this.f2220b[i3][0];
            }
            int i4 = i3 + 1;
            if (d2 < dArr2[i4]) {
                ...
                double[][] dArr4 = this.f2221c;
                return a(d3, (d2 - dArr2[i3]) / d3, d4, d5, dArr4[i3][0], dArr4[i4][0]);
            }
            i3 = i4;
        }
        return 0.0d;
    ...
    public final double b(double d2) {
        ...
        while (i3 < length - 1) {
            ...
            int i4 = i3 + 1;
            if (d3 <= dArr2[i4]) {
                double d4 = dArr2[i4] - dArr2[i3];
                double d5 = (d3 - dArr2[i3]) / d4;
                double[][] dArr3 = this.f2220b;
                double d6 = dArr3[i3][0];
                double d7 = dArr3[i4][0];
                double[][] dArr4 = this.f2221c;
                return b(d4, d5, d6, d7, dArr4[i3][0], dArr4[i4][0]) / d4;
            }
            i3 = i4;
        }
        return 0.0d;
