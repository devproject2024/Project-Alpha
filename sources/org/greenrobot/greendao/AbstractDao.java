...
public abstract class AbstractDao<T, K> {
    ...
    public java.util.List<T> loadAllFromCursor(android.database.Cursor r7) {
        ...
        L_0x005d:
            ...
            org.greenrobot.greendao.identityscope.IdentityScope<K, T> r0 = r6.identityScope     // Catch:{ all -> 0x007e }
            if (r0 == 0) goto L_0x0069
            r6.loadAllUnlockOnWindowBounds(r7, r2, r1)     // Catch:{ all -> 0x007e }
            goto L_0x0076
        L_0x0069:
            java.lang.Object r0 = r6.loadCurrent(r7, r4, r4)     // Catch:{ all -> 0x007e }
            r1.add(r0)     // Catch:{ all -> 0x007e }
            boolean r0 = r7.moveToNext()     // Catch:{ all -> 0x007e }
            if (r0 != 0) goto L_0x0069
        L_0x0076:
    ...
    /* access modifiers changed from: protected */
    public final T loadCurrent(Cursor cursor, int i2, boolean z) {
        if (this.identityScopeLong != null) {
            if (i2 != 0 && cursor.isNull(this.pkOrdinal + i2)) {
                return null;
            }
            long j = cursor.getLong(this.pkOrdinal + i2);
            ...
            return readEntity2;
        } else if (i2 != 0 && readKey(cursor, i2) == null) {
            return null;
        } else {
