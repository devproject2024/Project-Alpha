...
public class CountQuery<T> extends AbstractQuery<T> {
    ...
    public CountQuery<T> setParameter(int i2, Object obj) {
        return (CountQuery) super.setParameter(i2, obj);
    }

    public CountQuery<T> setParameter(int i2, Date date) {
        return (CountQuery) super.setParameter(i2, date);
    }

    public CountQuery<T> setParameter(int i2, Boolean bool) {
        return (CountQuery) super.setParameter(i2, bool);
    }
}
