    ...
    public static class PropertyCondition extends AbstractCondition {
            ...
            if (obj != null && obj.getClass().isArray()) {
                ...
                if (property2.type == Boolean.TYPE || property2.type == Boolean.class) {
                    ...
                    if (obj instanceof Number) {
                        ...
                        throw new DaoException("Illegal boolean value: Strings must be \"TRUE\" or \"FALSE\" (case insensitive), but was ".concat(String.valueOf(obj)));
                    }
                }
                return obj;
        ...
        private static Object[] checkValuesForType(Property property2, Object[] objArr) {
            for (int i2 = 0; i2 < objArr.length; i2++) {
                objArr[i2] = checkValueForType(property2, objArr[i2]);
            }
            return objArr;
        }
