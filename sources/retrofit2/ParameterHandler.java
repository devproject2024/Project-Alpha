...
abstract class ParameterHandler<T> {
    ...
    static final class Path<T> extends ParameterHandler<T> {
        ...
        Path(Method method2, int i2, String str, Converter<T, String> converter, boolean z) {
            this.method = method2;
            this.p = i2;
            this.name = (String) Objects.requireNonNull(str, "name == null");
            this.valueConverter = converter;
    ...
    static final class QueryMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        QueryMap(Method method2, int i2, Converter<T, String> converter, boolean z) {
            this.method = method2;
            this.p = i2;
            this.valueConverter = converter;
            this.encoded = z;
    ...
    static final class FieldMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        FieldMap(Method method2, int i2, Converter<T, String> converter, boolean z) {
            this.method = method2;
            this.p = i2;
            this.valueConverter = converter;
            this.encoded = z;
        ...
        public final void apply(RequestBuilder requestBuilder, T t) {
            if (t != null) {
                try {
                    ...
                    Method method2 = this.method;
                    int i2 = this.p;
                    throw Utils.parameterError(method2, i2, "Unable to convert " + t + " to RequestBody", e2);
                }
            }
        }
    }
        ...
        public final void apply(RequestBuilder requestBuilder, T t) {
            if (t != null) {
                try {
                    ...
                    Method method2 = this.method;
                    int i2 = this.p;
                    throw Utils.parameterError(method2, e2, i2, "Unable to convert " + t + " to RequestBody", new Object[0]);
                }
            } else {
