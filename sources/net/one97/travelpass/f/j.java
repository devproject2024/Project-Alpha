...
public final class j extends RecyclerView.v implements a {

    /* renamed from: a  reason: collision with root package name */
    private TextView f30374a;
    ...
    public j(View view) {
        ...
        if (textView != null) {
            this.f30374a = textView;
            RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycler_refund_details);
            if (recyclerView != null) {
                this.f30375b = recyclerView;
                return;
            }
    ...
    public final void a(Context context, int i2, net.one97.travelpass.ordersummary.g.a aVar, b bVar) {
        ...
        if (orderSummaryBodyItem != null) {
            this.f30374a.setText(orderSummaryBodyItem.getTopHeading());
            ...
            RecyclerView recyclerView = this.f30375b;
            if (recyclerView != null) {
                recyclerView.setLayoutManager(linearLayoutManager);
            }
            RecyclerView recyclerView2 = this.f30375b;
