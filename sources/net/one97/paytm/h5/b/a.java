...
import net.one97.paytm.h5paytmsdk.c.e;
...
public final class a implements e {
    public final Object a(Context context, int i2, int i3, Intent intent) {
        String stringExtra;
            ...
            if (i4 != 2112) {
                ...
                if (i4 != 3001) {
                    if (i4 != 9901) {
                        if (i4 != 10021) {
                            if (i4 == 20022) {
                                net.one97.paytm.marketplace.a.a((Activity) context2);
                            } else if (i4 == 1221) {
                                return t.b(context);
                            } else {
                                if (i4 == 1222) {
                                ...
                                switch (i4) {
                                    ...
                                    case 1230:
                                        return new f().a(FastagImageCropHelper.sendImagePickerResult(context, i5, intent2).toString(), com.alibaba.a.e.class);
                                }
                            }
                        }
        ...
        Object b2 = b(context, i2, i3, intent);
        if (b2 != null) {
            return b2;
        }
        Object c2 = c(context, i2, i3, intent);
        if (c2 != null) {
            return c2;
        }
        return null;
    ...
    private static Object b(Context context, int i2, int i3, Intent intent) {
        try {
    ...
    private static Object c(Context context, int i2, int i3, Intent intent) {
        try {
