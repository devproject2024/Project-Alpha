...
final class HotelHomeFragment$onCreateView$2 extends l implements b<View, x> {
    final /* synthetic */ HotelHomeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HotelHomeFragment$onCreateView$2(HotelHomeFragment hotelHomeFragment) {
        super(1);
    ...
    public final void invoke(View view) {
        k.c(view, "it");
        this.this$0.isCheckingDate = false;
