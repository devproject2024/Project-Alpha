...
public final class cf extends ce {
    ...
    private cf(e eVar, View view, Object[] objArr) {
        ...
        this.m = -1;
        this.f29347a.setTag((Object) null);
        this.f29349c.setTag((Object) null);
        this.f29350d.setTag((Object) null);
        this.f29351e.setTag((Object) null);
        this.f29352f.setTag((Object) null);
        this.f29353g.setTag((Object) null);
        this.f29354h.setTag((Object) null);
        this.f29355i.setTag((Object) null);
        View view2 = view;
        setRootTag(view);
        invalidateAll();
    }
    ...
    public final void executeBindings() {
        ...
        if (i2 != 0) {
            d.a(this.f29347a, (CharSequence) str2);
            net.one97.paytm.hotel4.utils.a.a(this.f29350d, str3, (com.paytm.utility.b.b.e) null, 240);
            d.a(this.f29351e, (CharSequence) str4);
            net.one97.paytm.hotel4.utils.a.b(this.f29352f, str);
            net.one97.paytm.hotel4.utils.a.a(this.f29353g, d3);
            net.one97.paytm.hotel4.utils.a.a(this.f29354h, d2);
            net.one97.paytm.hotel4.utils.a.c(this.f29354h, d3);
            net.one97.paytm.hotel4.utils.a.a(this.f29355i, list);
        }
        if ((j & 2) != 0) {
            net.one97.paytm.hotel4.utils.a.a(this.f29354h);
        }
    }
}
