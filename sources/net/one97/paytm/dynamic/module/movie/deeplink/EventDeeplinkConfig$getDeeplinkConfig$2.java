...
final class EventDeeplinkConfig$getDeeplinkConfig$2 extends l implements q<Boolean, DeepLinkData, HashMap<String, String>, Intent> {
    final /* synthetic */ EventDeeplinkConfig this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EventDeeplinkConfig$getDeeplinkConfig$2(EventDeeplinkConfig eventDeeplinkConfig) {
        super(3);
