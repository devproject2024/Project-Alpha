...
final class AmparkDeeplinkConfig$getDeeplinkConfig$2 extends l implements q<Boolean, DeepLinkData, HashMap<String, String>, Intent> {
    final /* synthetic */ AmparkDeeplinkConfig this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AmparkDeeplinkConfig$getDeeplinkConfig$2(AmparkDeeplinkConfig amparkDeeplinkConfig) {
        super(3);
