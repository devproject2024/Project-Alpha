...
final class MoviesDeeplinkConfig$getDeeplinkConfig$9 extends l implements q<Boolean, DeepLinkData, HashMap<String, String>, Intent> {
    final /* synthetic */ MoviesDeeplinkConfig this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MoviesDeeplinkConfig$getDeeplinkConfig$9(MoviesDeeplinkConfig moviesDeeplinkConfig) {
        super(3);
