...
final class MoviesDeeplinkConfig$getDeeplinkConfig$4 extends l implements q<Boolean, DeepLinkData, HashMap<String, String>, Intent> {
    final /* synthetic */ MoviesDeeplinkConfig this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MoviesDeeplinkConfig$getDeeplinkConfig$4(MoviesDeeplinkConfig moviesDeeplinkConfig) {
        super(3);
    ...
    public final Intent invoke(boolean z, DeepLinkData deepLinkData, HashMap<String, String> hashMap) {
        ...
        k.c(hashMap, "params");
        return this.this$0.deeplinkFunctions.contentPage(z, deepLinkData, hashMap);
    }
}
