...
final class PaymentRepository$makeOtpResendRequest$request$1<T> implements Response.Listener<OtpApiResponse> {
    final /* synthetic */ PaymentMethodDataSource.Callback $callback;

    PaymentRepository$makeOtpResendRequest$request$1(PaymentMethodDataSource.Callback callback) {
    ...
    public final void onResponse(net.one97.paytm.nativesdk.transcation.model.OtpApiResponse r4) {
        ...
        L_0x004b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.nativesdk.paymethods.datasource.PaymentRepository$makeOtpResendRequest$request$1.onResponse(net.one97.paytm.nativesdk.transcation.model.OtpApiResponse):void");
    }
}
