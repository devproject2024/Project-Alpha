...
final class PaymentRepository$makeUpiTransactionStatusRequest$request$1<T> implements Response.Listener<ProcessTransactionInfo> {
    final /* synthetic */ PaymentMethodDataSource.Callback $callback;

    PaymentRepository$makeUpiTransactionStatusRequest$request$1(PaymentMethodDataSource.Callback callback) {
    ...
    public final void onResponse(net.one97.paytm.nativesdk.paymethods.model.processtransaction.ProcessTransactionInfo r4) {
        ...
        L_0x004e:
            ...
            java.util.Map r1 = net.one97.paytm.nativesdk.Utils.SDKUtility.getAllInOneEventParams(r2, r1)
            net.one97.paytm.nativesdk.Utils.SDKUtility.sendGaEvents(r1)
        L_0x0057:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.nativesdk.paymethods.datasource.PaymentRepository$makeUpiTransactionStatusRequest$request$1.onResponse(net.one97.paytm.nativesdk.paymethods.model.processtransaction.ProcessTransactionInfo):void");
    }
}
