...
final class PaymentRepository$createOrder$request$2 implements Response.ErrorListener {
    final /* synthetic */ PaymentMethodDataSource.Callback $callback;

    PaymentRepository$createOrder$request$2(PaymentMethodDataSource.Callback callback) {
