...
public class DefaultCredit implements BaseDataModel {
    @c(a = "accRefNumber")
    @a
    ...
    @c(a = "credsAllowed")
    @a
    private List<CredsAllowed> credsAllowed = null;
    @c(a = "ifsc")
    @a
    private String ifsc;
    @c(a = "invalidVpa")
    ...
    public List<CredsAllowed> getCredsAllowed() {
        return this.credsAllowed;
    }

    public void setCredsAllowed(List<CredsAllowed> list) {
