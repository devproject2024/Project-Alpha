...
public class BankAccount implements BaseDataModel {
    @c(a = "accRefNumber")
    @a
    ...
    @c(a = "credsAllowed")
    @a
    private List<CredsAllowed__> credsAllowed = null;
    @c(a = "ifsc")
    @a
    private String ifsc;
    @c(a = "invalidVpa")
    ...
    public List<CredsAllowed__> getCredsAllowed() {
        return this.credsAllowed;
    }

    public void setCredsAllowed(List<CredsAllowed__> list) {
