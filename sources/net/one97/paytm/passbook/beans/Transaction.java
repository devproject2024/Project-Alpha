...
public class Transaction extends IJRDataModel {
    ...
    public static class ExtraInfo extends IJRDataModel {
        @b(a = "payerVPA")
        public String payerVPA;
        @b(a = "upiTranId")
        public String upiTranId;
    }
    ...
    public void setExtraInfo(ExtraInfo extraInfo2) {
