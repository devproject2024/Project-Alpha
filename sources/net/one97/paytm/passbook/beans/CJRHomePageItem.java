...
import net.one97.paytm.passbook.beans.AdspotDetails;
...
public class CJRHomePageItem extends CJRItem {
    ...
    public String getFormatedOfferPrice() {
        ...
        return f2 > 0.0f ? net.one97.paytm.passbook.mapping.a.x(String.valueOf(f2)) : "Free";
    }
    ...
    public class MetaData extends IJRDataModel {
    ...
    public class Weight extends IJRDataModel {
        @b(a = "weight")
        private int weight;
