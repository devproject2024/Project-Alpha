...
public class CJRLandingPageMetaData extends IJRDataModel {
    @b(a = "buttons")
    ...
    public class Buttons extends IJRDataModel {
        @b(a = "1")
    ...
    public class Details extends IJRDataModel {
        @b(a = "text")
        private String text;
        @b(a = "url")
        private String url;
    ...
    public class Doc extends IJRDataModel {
        @b(a = "heading")
    ...
    public class Subheadings extends IJRDataModel {
        @b(a = "1")
