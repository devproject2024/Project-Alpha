...
public class UPIInstantMoneyTransferCardViewV2 extends LinearLayout implements a.b {
    ...
    private ImageView f57866c;

    /* renamed from: d  reason: collision with root package name */
    private ImageView f57867d;

    /* renamed from: e  reason: collision with root package name */
    private ImageView f57868e;

    /* renamed from: f  reason: collision with root package name */
    private ImageView f57869f;

    /* renamed from: g  reason: collision with root package name */
    private TextView f57870g;

    /* renamed from: h  reason: collision with root package name */
    private TextView f57871h;

    /* renamed from: i  reason: collision with root package name */
    private TextView f57872i;
    private TextView j;
    ...
    public UPIInstantMoneyTransferCardViewV2(Context context, AttributeSet attributeSet, int i2) {
        ...
        View inflate = LayoutInflater.from(getContext()).inflate(R.layout.pass_layout_upi_instant_money_transfer_v2, this, false);
        removeAllViews();
        addView(inflate);
        this.f57865b = new b(this);
        ...
        this.f57866c = (ImageView) inflate.findViewById(R.id.icon1);
        this.f57867d = (ImageView) inflate.findViewById(R.id.icon2);
        this.f57868e = (ImageView) inflate.findViewById(R.id.icon3);
        this.f57869f = (ImageView) inflate.findViewById(R.id.icon4);
        this.f57870g = (TextView) inflate.findViewById(R.id.item1_tv);
        this.f57871h = (TextView) inflate.findViewById(R.id.item2_tv);
        this.f57872i = (TextView) inflate.findViewById(R.id.item3_tv);
    ...
    public void setFavoriteBanks(int i2, AccountProviderBody.AccountProvider accountProvider, int i3, AccountProviderBody.AccountProvider accountProvider2, int i4, AccountProviderBody.AccountProvider accountProvider3, int i5, AccountProviderBody.AccountProvider accountProvider4) {
        ...
        a(i2, accountProvider, this.f57866c, this.f57870g);
        a(i3, accountProvider2, this.f57867d, this.f57871h);
        a(i4, accountProvider3, this.f57868e, this.f57872i);
        a(i5, accountProvider4, this.f57869f, this.j);
    }
    ...
    public final void a(AccountProviderBody.AccountProvider accountProvider) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && androidx.core.content.b.a(getContext(), "android.permission.READ_PHONE_STATE") != 0) {
            ...
            } else if (this.f57864a != null) {
                d.b().a(this.f57864a.a(), this.o, this.q);
            }
        }
    }
    ...
    public final void a() {
        if (this.f57864a != null) {
            this.f57864a.a().startActivityForResult(new Intent(getContext(), d.b().t()), 2304);
        }
    }
}
