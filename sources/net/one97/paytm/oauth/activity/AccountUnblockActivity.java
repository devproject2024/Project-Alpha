...
public final class AccountUnblockActivity extends OAuthBaseActivity implements a {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.f52507a == null) {
            this.f52507a = new HashMap();
        }
        View view = (View) this.f52507a.get(Integer.valueOf(i2));
        if (view == null) {
            view = findViewById(i2);
            this.f52507a.put(Integer.valueOf(i2), view);
        }
        ...
        if (c2 != null) {
            ...
            m a3 = a2.d().a(R.navigation.account_unblock_nav_graph);
            k.a((Object) a3, "navController.navInflate…ccount_unblock_nav_graph)");
            Bundle bundle2 = new Bundle();
            bundle2.putString("mobileNumber", getIntent().getStringExtra("mobileNumber"));
            a3.b(R.id.accountUnblockMobileNumberFragment);
            a2.a(a3, bundle2);
            return;
        }
    ...
    public final void onBackPressed() {
        ...
        int i2 = R.id.accountUnblockVerifyOtpFragment;
        if (valueOf != null && valueOf.intValue() == i2) {
            a("/unblock_otp", "diy_unblock", "back_button_clicked", new ArrayList());
        } else {
            int i3 = R.id.accountUnblockSavedCardFragment;
            if (valueOf != null && valueOf.intValue() == i3) {
                a("/unblock_saved_card", "diy_unblock", "back_button_clicked", new ArrayList());
            }
        }
        finish();
    }
