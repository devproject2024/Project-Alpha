...
public class CJRCustomRecyclerView extends RecyclerView {
    ...
    private void a(Context context) {
        this.f69548b = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public void setOriginalMotionEvent(MotionEvent motionEvent) {
        this.f69549c = motionEvent.getX();
        this.f69550d = motionEvent.getY();
    }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0042:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.utils.CJRCustomRecyclerView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
}
