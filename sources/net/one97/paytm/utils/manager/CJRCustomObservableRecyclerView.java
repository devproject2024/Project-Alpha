...
public class CJRCustomObservableRecyclerView extends RecyclerView {
    ...
    private boolean f69763a = false;

    /* renamed from: b  reason: collision with root package name */
    private int f69764b;

    /* renamed from: c  reason: collision with root package name */
    private float f69765c;

    /* renamed from: d  reason: collision with root package name */
    private float f69766d;
    ...
    private void a(Context context) {
        this.f69764b = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public void setOriginalMotionEvent(MotionEvent motionEvent) {
        this.f69765c = motionEvent.getX();
        this.f69766d = motionEvent.getY();
    }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0042:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.utils.manager.CJRCustomObservableRecyclerView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
}
