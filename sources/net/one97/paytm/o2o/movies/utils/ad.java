...
public enum ad {
    ...
    CANCEL_MOVIE_TICKET_TNC_CLICK(KeyList.IntentRequestKey.INTENT_USER_CENTER_RESULT_ACTION_CLEAR, "cancel_movie_ticket_tnc_click"),
    ...
    public static ad fromIndex(int i2) {
        for (ad adVar : values()) {
            if (adVar.index == i2) {
                return adVar;
            }
