...
public class CJRMovieCart extends IJRPaytmDataModel implements IJRDataModel {
    ...
    public IJRPaytmDataModel parseResponse(String str, f fVar) throws Exception {
        CJRMovieCart cJRMovieCart = (CJRMovieCart) fVar.a(str, new CJRMovieCart().getClass());
        cJRMovieCart.setCartJsonResponse(str);
        return cJRMovieCart;
    }
}
