...
public final class i extends ab {
    ...
    public SRPFilterViewModel f28859b;

    /* renamed from: c  reason: collision with root package name */
    public SRPFilterLocalityAndHotelChainViewModel f28860c;

    /* renamed from: d  reason: collision with root package name */
    public SharedViewModel f28861d;

    /* renamed from: e  reason: collision with root package name */
    public net.one97.paytm.hotel4.view.a.c f28862e;
    ...
    static final class a<T> implements z<o<? extends String, ? extends Integer>> {
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            ...
            if (((Number) oVar.getSecond()).intValue() == -1) {
                net.one97.paytm.hotel4.view.a.c cVar = iVar.f28862e;
                if (cVar == null) {
                    k.a("adapter");
                }
                SRPFilterViewModel sRPFilterViewModel = iVar.f28859b;
                if (sRPFilterViewModel == null) {
                    k.a("srpFilterViewModel");
                }
                SharedViewModel sharedViewModel = iVar.f28861d;
                if (sharedViewModel == null) {
                    k.a("sharedViewModel");
                }
                cVar.a(sRPFilterViewModel.getFilterValues(sharedViewModel.getFilterHotelThemeString()));
                return;
            }
            String str = (String) oVar.getFirst();
            k.c(str, "id");
            net.one97.paytm.hotel4.view.a.c cVar2 = iVar.f28862e;
            if (cVar2 == null) {
                k.a("adapter");
            }
            List a2 = cVar2.a();
            ...
            if (i2 >= 0) {
                net.one97.paytm.hotel4.view.a.c cVar3 = iVar.f28862e;
                if (cVar3 == null) {
                    k.a("adapter");
                }
    ...
    static final class c<T> implements z<String> {
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            ...
            SRPFilterLocalityAndHotelChainViewModel sRPFilterLocalityAndHotelChainViewModel = iVar.f28860c;
            if (sRPFilterLocalityAndHotelChainViewModel == null) {
                k.a("viewModel");
            }
            SRPFilterViewModel sRPFilterViewModel2 = iVar.f28859b;
            if (sRPFilterViewModel2 == null) {
                k.a("srpFilterViewModel");
            }
            SharedViewModel sharedViewModel2 = iVar.f28861d;
            if (sharedViewModel2 == null) {
                k.a("sharedViewModel");
            }
            ArrayList<FilterValuesItem> filteredList = sRPFilterLocalityAndHotelChainViewModel.getFilteredList(sRPFilterViewModel2.getFilterValues(sharedViewModel2.getFilterHotelThemeString()), str);
            net.one97.paytm.hotel4.view.a.c cVar2 = iVar.f28862e;
            if (cVar2 == null) {
                k.a("adapter");
            }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (activity != null) {
            ...
            this.f28861d = (SharedViewModel) a2;
            SharedViewModel sharedViewModel = this.f28861d;
            if (sharedViewModel == null) {
                k.a("sharedViewModel");
            }
            ...
            this.f28859b = (SRPFilterViewModel) a3;
            SRPFilterViewModel sRPFilterViewModel = this.f28859b;
            if (sRPFilterViewModel == null) {
                k.a("srpFilterViewModel");
            }
            this.f28860c = new SRPFilterLocalityAndHotelChainViewModel(sRPFilterViewModel, "types");
            SRPFilterLocalityAndHotelChainViewModel sRPFilterLocalityAndHotelChainViewModel = this.f28860c;
            if (sRPFilterLocalityAndHotelChainViewModel == null) {
                k.a("viewModel");
            }
            String string = getString(R.string.h4_filter_by_hotel_theme);
            k.a((Object) string, "getString(R.string.h4_filter_by_hotel_theme)");
            sRPFilterLocalityAndHotelChainViewModel.setTitle(string);
            SRPFilterLocalityAndHotelChainViewModel sRPFilterLocalityAndHotelChainViewModel2 = this.f28860c;
            if (sRPFilterLocalityAndHotelChainViewModel2 == null) {
                k.a("viewModel");
            }
            String string2 = getString(R.string.h4_search_for_hotel_themes);
            k.a((Object) string2, "getString(R.string.h4_search_for_hotel_themes)");
            sRPFilterLocalityAndHotelChainViewModel2.setHint(string2);
            SRPFilterLocalityAndHotelChainViewModel sRPFilterLocalityAndHotelChainViewModel3 = this.f28860c;
            ...
            SRPFilterLocalityAndHotelChainViewModel sRPFilterLocalityAndHotelChainViewModel4 = this.f28860c;
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f28862e = new net.one97.paytm.hotel4.view.a.c(sRPFilterLocalityAndHotelChainViewModel2, "types");
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(1);
        am amVar3 = this.f28858a;
        if (amVar3 == null) {
            k.a("dataBinding");
        }
        ...
        am amVar4 = this.f28858a;
        if (amVar4 == null) {
            k.a("dataBinding");
        }
        RecyclerView recyclerView2 = amVar4.f29161d;
        k.a((Object) recyclerView2, "this.dataBinding.filterList");
        net.one97.paytm.hotel4.view.a.c cVar = this.f28862e;
        if (cVar == null) {
            k.a("adapter");
        }
        recyclerView2.setAdapter(cVar);
        net.one97.paytm.hotel4.view.a.c cVar2 = this.f28862e;
        if (cVar2 == null) {
            k.a("adapter");
        }
        SRPFilterViewModel sRPFilterViewModel = this.f28859b;
        ...
        cVar2.a(sRPFilterViewModel.getFilterValues(sharedViewModel.getFilterHotelThemeString()));
        am amVar5 = this.f28858a;
        if (amVar5 == null) {
            k.a("dataBinding");
        }
