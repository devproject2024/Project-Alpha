...
public final class o extends c<String> {
    ...
    public final /* synthetic */ void a(ViewDataBinding viewDataBinding, Object obj, int i2) {
        ...
        k.c(str, "item");
        if (viewDataBinding instanceof fy) {
    ...
    public final ViewDataBinding a(ViewGroup viewGroup) {
        ...
        this.f28713b = viewGroup.getContext();
        ViewDataBinding a2 = androidx.databinding.f.a(LayoutInflater.from(viewGroup.getContext()), R.layout.hotel4_room_selection_amenities_list_items, viewGroup, false);
