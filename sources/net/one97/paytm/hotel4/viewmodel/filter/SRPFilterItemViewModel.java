...
import net.one97.paytm.hotel4.viewmodel.BaseItemViewModel;

public final class SRPFilterItemViewModel extends BaseItemViewModel {
    ...
    public SRPFilterItemViewModel(SRPFilterViewModel sRPFilterViewModel) {
        super(sRPFilterViewModel);
    ...
    public final void setItemData(FilterValuesItem filterValuesItem, String str, int i2) {
        ...
        SRPFilterViewModel sRPFilterViewModel = this.srpfilterViewModel;
        FilterValuesItem filterValuesItem2 = this.filterItem;
        String str2 = null;
        lVar.setValue(Boolean.valueOf(sRPFilterViewModel.getFilterSelectedStatus(str, filterValuesItem2 != null ? filterValuesItem2.getId() : null)));
    ...
    public final void onFilterItemClick() {
        ...
        FilterValuesItem filterValuesItem2 = this.filterItem;
        sRPFilterViewModel.updateSelectedFilter(str, filterValuesItem2 != null ? filterValuesItem2.getId() : null, this.position, true);
    }
}
