...
import net.one97.paytm.landingpage.utils.croptool.f;
...
public class CropOverlayView extends View {
    ...
    private ScaleGestureDetector f52941b;
    ...
    public final e f52943d;

    /* renamed from: e  reason: collision with root package name */
    private a f52944e;

    /* renamed from: f  reason: collision with root package name */
    private final RectF f52945f;

    /* renamed from: g  reason: collision with root package name */
    private Paint f52946g;

    /* renamed from: h  reason: collision with root package name */
    private Paint f52947h;

    /* renamed from: i  reason: collision with root package name */
    private Paint f52948i;
    private Paint j;
    private Path k;
    ...
    public RectF getCropWindowRect() {
        return this.f52943d.a();
    }

    public void setCropWindowRect(RectF rectF) {
        this.f52943d.a(rectF);
    }

    public final void a() {
        RectF cropWindowRect = getCropWindowRect();
        a(cropWindowRect);
        this.f52943d.a(cropWindowRect);
    }
    ...
    public final boolean a(boolean z2) {
        ...
        this.f52942c = z2;
        if (!this.f52942c || this.f52941b != null) {
            return true;
        }
        this.f52941b = new ScaleGestureDetector(getContext(), new b(this, (byte) 0));
        return true;
    }

    public void setMinCropResultSize(int i2, int i3) {
        e eVar = this.f52943d;
        eVar.f52999f = (float) i2;
        eVar.f53000g = (float) i3;
    }

    public void setMaxCropResultSize(int i2, int i3) {
        e eVar = this.f52943d;
        eVar.f53001h = (float) i2;
        eVar.f53002i = (float) i3;
    }
    ...
    public void setInitialAttributeValues(CropImageOptions cropImageOptions) {
        e eVar = this.f52943d;
        eVar.f52995b = (float) cropImageOptions.x;
        eVar.f52996c = (float) cropImageOptions.y;
        eVar.f52999f = (float) cropImageOptions.z;
        eVar.f53000g = (float) cropImageOptions.A;
        eVar.f53001h = (float) cropImageOptions.B;
        eVar.f53002i = (float) cropImageOptions.C;
        setCropShape(cropImageOptions.f52912a);
        setSnapRadius(cropImageOptions.f52913b);
        setGuidelines(cropImageOptions.f52915d);
        setFixedAspectRatio(cropImageOptions.l);
        setAspectRatioX(cropImageOptions.m);
        setAspectRatioY(cropImageOptions.n);
        a(cropImageOptions.f52920i);
        this.s = cropImageOptions.f52914c;
        this.r = cropImageOptions.k;
        this.f52946g = a(cropImageOptions.o, cropImageOptions.p);
        this.p = cropImageOptions.r;
        this.q = cropImageOptions.s;
        this.f52947h = a(cropImageOptions.q, cropImageOptions.t);
        this.f52948i = a(cropImageOptions.u, cropImageOptions.v);
    ...
    private void c() {
        ...
        if (min > max && min2 > max2) {
            ...
            if (this.A.width() > 0 && this.A.height() > 0) {
                rectF.left = (((float) this.A.left) / this.f52943d.j) + max;
                rectF.top = (((float) this.A.top) / this.f52943d.k) + max2;
                rectF.right = rectF.left + (((float) this.A.width()) / this.f52943d.j);
                rectF.bottom = rectF.top + (((float) this.A.height()) / this.f52943d.k);
                rectF.left = Math.max(max, rectF.left);
                rectF.top = Math.max(max2, rectF.top);
                rectF.right = Math.min(min, rectF.right);
                rectF.bottom = Math.min(min2, rectF.bottom);
            } else if (!this.f52940a || min <= max || min2 <= max2) {
                rectF.left = max + f4;
                rectF.top = max2 + f6;
                rectF.right = min - f4;
                ...
                this.x = ((float) this.v) / ((float) this.w);
                float max3 = Math.max(this.f52943d.b(), rectF.height() * this.x) / 2.0f;
                ...
                float max4 = Math.max(this.f52943d.c(), rectF.width() / this.x) / 2.0f;
    ...
    private void a(RectF rectF) {
        if (rectF.width() < this.f52943d.b()) {
            float b2 = (this.f52943d.b() - rectF.width()) / 2.0f;
            rectF.left -= b2;
            rectF.right += b2;
        }
        if (rectF.height() < this.f52943d.c()) {
            float c2 = (this.f52943d.c() - rectF.height()) / 2.0f;
            rectF.top -= c2;
            rectF.bottom += c2;
        }
        if (rectF.width() > this.f52943d.d()) {
            float width = (rectF.width() - this.f52943d.d()) / 2.0f;
            rectF.left += width;
            rectF.right -= width;
        }
        if (rectF.height() > this.f52943d.e()) {
            float height = (rectF.height() - this.f52943d.e()) / 2.0f;
            rectF.top += height;
            rectF.bottom -= height;
        }
        b(rectF);
        ...
        if (this.f52940a && ((double) Math.abs(rectF.width() - (rectF.height() * this.x))) > 0.1d) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.z != CropImageView.b.RECTANGLE) {
            ...
            if (Build.VERSION.SDK_INT > 17 || this.z != CropImageView.b.OVAL) {
                this.f52945f.set(a2.left, a2.top, a2.right, a2.bottom);
            } else {
                this.f52945f.set(a2.left + 2.0f, a2.top + 2.0f, a2.right - 2.0f, a2.bottom - 2.0f);
            }
            this.k.addOval(this.f52945f, Path.Direction.CW);
            canvas.save();
        ...
        Paint paint = this.f52946g;
        if (paint != null) {
            float strokeWidth = paint.getStrokeWidth();
            RectF a3 = this.f52943d.a();
            float f5 = strokeWidth / 2.0f;
            a3.inset(f5, f5);
            if (this.z == CropImageView.b.RECTANGLE) {
                canvas.drawRect(a3, this.f52946g);
            } else {
                canvas.drawOval(a3, this.f52946g);
            }
        }
        if (this.f52947h != null) {
            Paint paint2 = this.f52946g;
            float strokeWidth2 = paint2 != null ? paint2.getStrokeWidth() : 0.0f;
            float strokeWidth3 = this.f52947h.getStrokeWidth();
            float f6 = strokeWidth3 / 2.0f;
            if (this.z == CropImageView.b.RECTANGLE) {
                f2 = this.p;
            }
            float f7 = f2 + f6;
            RectF a4 = this.f52943d.a();
            a4.inset(f7, f7);
            float f8 = (strokeWidth3 - strokeWidth2) / 2.0f;
            float f9 = f6 + f8;
            Canvas canvas3 = canvas;
            canvas3.drawLine(a4.left - f8, a4.top - f9, a4.left - f8, a4.top + this.q, this.f52947h);
            canvas3.drawLine(a4.left - f9, a4.top - f8, a4.left + this.q, a4.top - f8, this.f52947h);
            canvas3.drawLine(a4.right + f8, a4.top - f9, a4.right + f8, a4.top + this.q, this.f52947h);
            canvas3.drawLine(a4.right + f9, a4.top - f8, a4.right - this.q, a4.top - f8, this.f52947h);
            canvas3.drawLine(a4.left - f8, a4.bottom + f9, a4.left - f8, a4.bottom - this.q, this.f52947h);
            canvas3.drawLine(a4.left - f9, a4.bottom + f8, a4.left + this.q, a4.bottom + f8, this.f52947h);
            canvas3.drawLine(a4.right + f8, a4.bottom + f9, a4.right + f8, a4.bottom - this.q, this.f52947h);
            canvas3.drawLine(a4.right + f9, a4.bottom + f8, a4.right - this.q, a4.bottom + f8, this.f52947h);
        }
    }
    ...
    private void a(Canvas canvas) {
        if (this.f52948i != null) {
            ...
            if (this.z == CropImageView.b.OVAL) {
                ...
                canvas.drawLine(f2, (a2.top + height2) - sin, f2, (a2.bottom - height2) + sin, this.f52948i);
                canvas.drawLine(f3, (a2.top + height2) - sin, f3, (a2.bottom - height2) + sin, this.f52948i);
                ...
                canvas.drawLine((a2.left + width2) - cos, f4, (a2.right - width2) + cos, f4, this.f52948i);
                canvas.drawLine((a2.left + width2) - cos, f5, (a2.right - width2) + cos, f5, this.f52948i);
                return;
            }
            float f6 = a2.left + width;
            float f7 = a2.right - width;
            Canvas canvas2 = canvas;
            canvas2.drawLine(f6, a2.top, f6, a2.bottom, this.f52948i);
            canvas.drawLine(f7, a2.top, f7, a2.bottom, this.f52948i);
            float f8 = a2.top + height;
            float f9 = a2.bottom - height;
            canvas2.drawLine(a2.left, f8, a2.right, f8, this.f52948i);
            canvas.drawLine(a2.left, f9, a2.right, f9, this.f52948i);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f52942c) {
            this.f52941b.onTouchEvent(motionEvent);
        } else {
            ...
            if (action != 1) {
                if (action == 2) {
                    ...
                    if (this.u != null) {
                        ...
                        int i2 = this.n;
                        int i3 = this.o;
                        boolean z2 = this.f52940a;
                        float f3 = this.x;
                        float f4 = x2 + fVar2.f53005b.x;
                        float f5 = fVar2.f53005b.y + y2;
                        if (fVar2.f53004a != f.a.CENTER) {
                            if (!z2) {
                                switch (f.AnonymousClass1.f53010a[fVar2.f53004a.ordinal()]) {
                                    case 1:
                                        f fVar3 = fVar2;
                                        RectF rectF2 = a2;
                                        RectF rectF3 = rectF;
        ...
        float f14 = this.s;
        if (this.z == CropImageView.b.OVAL) {
            float width = eVar.f52994a.width() / 6.0f;
            float f15 = eVar.f52994a.left + width;
            float f16 = eVar.f52994a.left + (width * 5.0f);
            float height = eVar.f52994a.height() / 6.0f;
            float f17 = eVar.f52994a.top + height;
            float f18 = eVar.f52994a.top + (height * 5.0f);
            if (x3 < f15) {
                if (y3 < f17) {
                    aVar = f.a.TOP_LEFT;
                } else if (y3 < f18) {
        ...
        } else if (e.a(x3, y3, eVar.f52994a.left, eVar.f52994a.top, f14)) {
            aVar = f.a.TOP_LEFT;
        } else if (e.a(x3, y3, eVar.f52994a.right, eVar.f52994a.top, f14)) {
            aVar = f.a.TOP_RIGHT;
        } else if (e.a(x3, y3, eVar.f52994a.left, eVar.f52994a.bottom, f14)) {
            aVar = f.a.BOTTOM_LEFT;
        } else if (e.a(x3, y3, eVar.f52994a.right, eVar.f52994a.bottom, f14)) {
            aVar = f.a.BOTTOM_RIGHT;
        } else {
            if (!e.c(x3, y3, eVar.f52994a.left, eVar.f52994a.top, eVar.f52994a.right, eVar.f52994a.bottom) || !eVar.g()) {
                if (e.a(x3, y3, eVar.f52994a.left, eVar.f52994a.right, eVar.f52994a.top, f14)) {
                    aVar = f.a.TOP;
                } else {
                    if (e.a(x3, y3, eVar.f52994a.left, eVar.f52994a.right, eVar.f52994a.bottom, f14)) {
                        aVar = f.a.BOTTOM;
                    } else {
                        if (e.b(x3, y3, eVar.f52994a.left, eVar.f52994a.top, eVar.f52994a.bottom, f14)) {
                            aVar = f.a.LEFT;
                        } else {
                            if (e.b(x3, y3, eVar.f52994a.right, eVar.f52994a.top, eVar.f52994a.bottom, f14)) {
                                aVar = f.a.RIGHT;
                            } else {
                                if (!e.c(x3, y3, eVar.f52994a.left, eVar.f52994a.top, eVar.f52994a.right, eVar.f52994a.bottom) || eVar.g()) {
                                    aVar = null;
    ...
    class b extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            RectF a2 = CropOverlayView.this.f52943d.a();
            ...
            if (f3 >= f4 || f2 > f5 || f3 < 0.0f || f4 > CropOverlayView.this.f52943d.d() || f2 < 0.0f || f5 > CropOverlayView.this.f52943d.e()) {
                return true;
            }
            a2.set(f3, f2, f4, f5);
            CropOverlayView.this.f52943d.a(a2);
