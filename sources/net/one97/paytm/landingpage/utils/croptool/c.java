...
final class c {
    ...
    static final Rect f52974a = new Rect();

    /* renamed from: b  reason: collision with root package name */
    static final RectF f52975b = new RectF();

    /* renamed from: c  reason: collision with root package name */
    static final RectF f52976c = new RectF();

    /* renamed from: d  reason: collision with root package name */
    static final float[] f52977d = new float[6];

    /* renamed from: e  reason: collision with root package name */
    static final float[] f52978e = new float[6];

    /* renamed from: f  reason: collision with root package name */
    static Pair<String, WeakReference<Bitmap>> f52979f;

    /* renamed from: g  reason: collision with root package name */
    private static int f52980g;
    ...
    static a a(Context context, Uri uri, int i2, int i3) {
        try {
            ...
            if (f52980g > 0) {
                while (true) {
                    if (i5 / i6 <= f52980g && i4 / i6 <= f52980g) {
                        break;
                    }
                    i6 *= 2;
                }
    ...
    static Bitmap a(Bitmap bitmap, int i2, int i3, CropImageView.i iVar) {
        if (i2 > 0 && i3 > 0) {
            try {
    ...
    private static net.one97.paytm.landingpage.utils.croptool.c.a a(android.content.Context r19, android.net.Uri r20, float[] r21, int r22, int r23, int r24, boolean r25, int r26, int r27, int r28, int r29, boolean r30, boolean r31, int r32) {
        /*
            r0 = r22
            r1 = r21
            r2 = r23
        ...
        L_0x0026:
            ...
            r6 = r11
            r7 = r32
            net.one97.paytm.landingpage.utils.croptool.c$a r2 = a((android.content.Context) r2, (android.net.Uri) r3, (android.graphics.Rect) r4, (int) r5, (int) r6, (int) r7)     // Catch:{ Exception -> 0x003a }
            android.graphics.Bitmap r1 = r2.f52981a     // Catch:{ Exception -> 0x003a }
            int r8 = r2.f52982b     // Catch:{ Exception -> 0x003a }
            goto L_0x003b
        L_0x003a:
        L_0x003b:
        ...
        L_0x008f:
            net.one97.paytm.landingpage.utils.croptool.c$a r0 = new net.one97.paytm.landingpage.utils.croptool.c$a
            r0.<init>(r10, r8)
            return r0
        L_0x0095:
            r0 = move-exception
        ...
        L_0x009f:
            ...
            r12 = r30
            r13 = r31
            net.one97.paytm.landingpage.utils.croptool.c$a r0 = a((android.content.Context) r1, (android.net.Uri) r2, (float[]) r3, (int) r4, (boolean) r5, (int) r6, (int) r7, (int) r8, (android.graphics.Rect) r9, (int) r10, (int) r11, (boolean) r12, (boolean) r13)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.landingpage.utils.croptool.c.a(android.content.Context, android.net.Uri, float[], int, int, int, boolean, int, int, int, int, boolean, boolean, int):net.one97.paytm.landingpage.utils.croptool.c$a");
    }
    ...
    private static BitmapFactory.Options a(ContentResolver contentResolver, Uri uri) throws FileNotFoundException {
        ...
        try {
            ...
            try {
                ...
                BitmapFactory.decodeStream(inputStream, f52974a, options);
    ...
    private static android.graphics.Bitmap a(android.content.ContentResolver r2, android.net.Uri r3, android.graphics.BitmapFactory.Options r4) throws java.io.FileNotFoundException {
        ...
        L_0x0000:
            ...
            android.graphics.Rect r1 = f52974a     // Catch:{ OutOfMemoryError -> 0x0011 }
        ...
        L_0x0031:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.landingpage.utils.croptool.c.a(android.content.ContentResolver, android.net.Uri, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static net.one97.paytm.landingpage.utils.croptool.c.a a(android.content.Context r4, android.net.Uri r5, android.graphics.Rect r6, int r7, int r8, int r9) {
        /*
            r0 = 0
        ...
        L_0x0023:
            net.one97.paytm.landingpage.utils.croptool.c$a r8 = new net.one97.paytm.landingpage.utils.croptool.c$a     // Catch:{ OutOfMemoryError -> 0x003b }
        ...
        L_0x003b:
            ...
            r7.recycle()
        L_0x004f:
            net.one97.paytm.landingpage.utils.croptool.c$a r4 = new net.one97.paytm.landingpage.utils.croptool.c$a
            r5 = 1
            r4.<init>(r0, r5)
            return r4
        L_0x0056:
        ...
        L_0x008c:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.landingpage.utils.croptool.c.a(android.content.Context, android.net.Uri, android.graphics.Rect, int, int, int):net.one97.paytm.landingpage.utils.croptool.c$a");
    }
