...
public class CropImageOptions implements Parcelable {
    ...
    public CropImageView.b f52912a;

    /* renamed from: b  reason: collision with root package name */
    public float f52913b;

    /* renamed from: c  reason: collision with root package name */
    public float f52914c;

    /* renamed from: d  reason: collision with root package name */
    public CropImageView.c f52915d;

    /* renamed from: e  reason: collision with root package name */
    public CropImageView.j f52916e;
    ...
    public CropImageOptions() {
        ...
        this.f52912a = CropImageView.b.RECTANGLE;
        this.f52913b = TypedValue.applyDimension(1, 3.0f, displayMetrics);
        this.f52914c = TypedValue.applyDimension(1, 24.0f, displayMetrics);
        this.f52915d = CropImageView.c.ON_TOUCH;
        this.f52916e = CropImageView.j.FIT_CENTER;
        this.f52917f = true;
        this.f52918g = true;
        this.f52919h = true;
        this.f52920i = false;
    ...
    protected CropImageOptions(Parcel parcel) {
        this.f52912a = CropImageView.b.values()[parcel.readInt()];
        this.f52913b = parcel.readFloat();
        this.f52914c = parcel.readFloat();
        this.f52915d = CropImageView.c.values()[parcel.readInt()];
        this.f52916e = CropImageView.j.values()[parcel.readInt()];
        boolean z2 = true;
        this.f52917f = parcel.readByte() != 0;
        this.f52918g = parcel.readByte() != 0;
        this.f52919h = parcel.readByte() != 0;
        this.f52920i = parcel.readByte() != 0;
        ...
        this.J = parcel.readInt();
        this.K = CropImageView.i.values()[parcel.readInt()];
        this.L = parcel.readByte() != 0;
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        parcel.writeInt(this.f52912a.ordinal());
        parcel.writeFloat(this.f52913b);
        parcel.writeFloat(this.f52914c);
        parcel.writeInt(this.f52915d.ordinal());
        parcel.writeInt(this.f52916e.ordinal());
        parcel.writeByte(this.f52917f ? (byte) 1 : 0);
        parcel.writeByte(this.f52918g ? (byte) 1 : 0);
        parcel.writeByte(this.f52919h ? (byte) 1 : 0);
        parcel.writeByte(this.f52920i ? (byte) 1 : 0);
