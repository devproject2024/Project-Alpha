...
public class CJRCustomRecyclerView extends RecyclerView {
    ...
    private boolean f61449a = false;

    /* renamed from: b  reason: collision with root package name */
    private int f61450b;

    /* renamed from: c  reason: collision with root package name */
    private float f61451c;
    ...
    private void a(Context context) {
        this.f61450b = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public void setOriginalMotionEvent(MotionEvent motionEvent) {
        this.f61451c = motionEvent.getX();
        this.f61452d = motionEvent.getY();
    }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0042:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.recharge.common.utils.CJRCustomRecyclerView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
}
