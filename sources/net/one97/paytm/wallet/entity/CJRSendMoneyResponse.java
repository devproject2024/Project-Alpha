...
public class CJRSendMoneyResponse extends CJRDataModelItem {
    ...
    private CJRFastForwardResponse mFFResponse;
    @b(a = "heading")
    ...
    public CJRFastForwardResponse getmFFResponse() {
        if (this.mFFResponse == null) {
            this.mFFResponse = new CJRFastForwardResponse();
            try {
                this.mFFResponse = (CJRFastForwardResponse) new f().a(this.strFFResponse, CJRFastForwardResponse.class);
            } catch (Exception unused) {
            }
        }
        return this.mFFResponse;
    }
}
