...
public final class c extends RecyclerView.a<CLPBaseViewHolder> {
    ...
    public List<? extends View> f55816a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private IGAHandlerListener f55817b;

    public c(IGAHandlerListener iGAHandlerListener) {
        this.f55817b = iGAHandlerListener;
    }

    public final /* synthetic */ void onBindViewHolder(RecyclerView.v vVar, int i2) {
        CLPBaseViewHolder cLPBaseViewHolder = (CLPBaseViewHolder) vVar;
        k.c(cLPBaseViewHolder, "holder");
        View view = (View) this.f55816a.get(i2);
    ...
    public final /* synthetic */ RecyclerView.v onCreateViewHolder(ViewGroup viewGroup, int i2) {
        ...
        CLPBaseViewHolder viewHolder = ViewHolderFactory.getViewHolder(viewGroup, ViewHolderFactory.parseViewType(WidgetLayoutType.Companion.getLayoutTypeNameNameFromIndex(i2)), (j) null, this.f55817b);
        k.a((Object) viewHolder, "ViewHolderFactory.getVie…Type)), null, gaListener)");
        return viewHolder;
    }

    public final int getItemCount() {
        return this.f55816a.size();
    }

    public final int getItemViewType(int i2) {
        return WidgetLayoutType.Companion.getLayoutTypeIndexfromName((View) this.f55816a.get(i2));
    }
}
