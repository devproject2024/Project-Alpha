...
public class KYCStatusV3 extends IJRPaytmDataModel implements IJRDataModel {
    private static final long serialVersionUID = 1;
    @b(a = "aadharSubmittedAs")
    private String aadhaarSubmittedAs;
    ...
    public String getAadhaarSubmittedAs() {
        return this.aadhaarSubmittedAs;
    }

    public void setAadhaarSubmittedAs(String str) {
        this.aadhaarSubmittedAs = str;
    }
