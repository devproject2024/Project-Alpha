...
public class CJRRechargeOrderList extends CJRDataModelItem {
    ...
    public IJRPaytmDataModel parseResponse(String str, f fVar) throws Exception {
        CJRRechargeOrderList cJRRechargeOrderList = (CJRRechargeOrderList) fVar.a(str, CJRRechargeOrderList.class);
        cJRRechargeOrderList.pageType = this.pageType;
        return cJRRechargeOrderList;
    }
