...
import net.one97.paytm.bankCommon.model.AdspotDetails;
...
public class PBCJRHomePageItem extends PBCJRItem implements IJRDataModel {
    ...
    public String getFormatedOfferPrice() {
        ...
        return f2 > 0.0f ? net.one97.paytm.bankCommon.mapping.a.ad(String.valueOf(f2)) : "Free";
    }
    ...
    public String getDisplayFieldValue(String str) {
        return (String) new HashMap<String, String>() {
            {
                put(CLPConstants.BRAND_PARAMS, PBCJRHomePageItem.this.getBrand());
                put("image_url", PBCJRHomePageItem.this.getImageUrl());
                put("name", PBCJRHomePageItem.this.getName());
                put(Item.KEY_OFFER_PRICE, PBCJRHomePageItem.this.getFormatedOfferPrice());
                put(Item.KEY_ACTUAL_PRICE, PBCJRHomePageItem.this.getFormatedActualPrice());
                put(Item.KEY_DISCOUNT, PBCJRHomePageItem.this.getDiscountPercent());
            }
        }.get(str);
    }
