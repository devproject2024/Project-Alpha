package net.one97.paytm.bankCommon.e;
...
public class a extends g implements View.OnClickListener {
    ...
    public ProgressBar f16260a;

    /* renamed from: b  reason: collision with root package name */
    private C0225a f16261b;

    /* renamed from: net.one97.paytm.bankCommon.e.a$a  reason: collision with other inner class name */
    ...
    public final void a(C0225a aVar) {
        this.f16261b = aVar;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        this.f16260a = (ProgressBar) getView().findViewById(R.id.fragment_kyc_tnc_progress_bar);
        ...
        webView.setWebViewClient(new WebViewClient() {
            public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                a.this.f16260a.setVisibility(0);
                super.onPageStarted(webView, str, bitmap);
            }

            public final void onPageFinished(WebView webView, String str) {
                a.this.f16260a.setVisibility(8);
