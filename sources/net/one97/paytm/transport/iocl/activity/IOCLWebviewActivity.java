...
public class IOCLWebviewActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.f14266a = (ImageView) findViewById(R.id.iv_back_button);
            this.f14267b = (ProgressBar) findViewById(R.id.progress_bar);
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                public final void onProgressChanged(WebView webView, int i2) {
                    if (i2 == 100) {
                        IOCLWebviewActivity.this.f14267b.setVisibility(8);
                    }
