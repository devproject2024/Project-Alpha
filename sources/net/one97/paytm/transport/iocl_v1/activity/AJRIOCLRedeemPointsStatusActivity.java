...
import net.one97.paytm.transport.iocl_v1.others.HomeTabItem;
...
public class AJRIOCLRedeemPointsStatusActivity extends AppCompatActivity {
    ...
    public static final String f14397a = AJRIOCLRedeemPointsStatusActivity.class.getName();

    /* renamed from: b  reason: collision with root package name */
    private IOCLBaseModel f14398b;

    /* renamed from: c  reason: collision with root package name */
    private View f14399c;

    /* renamed from: d  reason: collision with root package name */
    private HashMap<String, View> f14400d = new HashMap<>();
    ...
    private View.OnClickListener f14403g = new View.OnClickListener() {
        public final void onClick(View view) {
            if (!view.isSelected()) {
                ...
                String unused = AJRIOCLRedeemPointsStatusActivity.f14397a;
                q.c();
            }
        }
    };
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.iocl_point_redeem_v1);
        ...
        try {
            ...
            if (!(intent == null || intent.getSerializableExtra("common_response") == null)) {
                this.f14398b = (IOCLBaseModel) intent.getSerializableExtra("common_response");
            }
            ...
            this.f14399c = findViewById(R.id.iocl_bottom_tab_bar);
            if (this.f14399c != null) {
                a.b().addBottomBarTab(this, (LinearLayout) this.f14399c.findViewById(R.id.parent_layout_bottom), this.f14403g);
            }
            ...
            if (!(this.f14398b == null || this.f14398b.getResponse() == null)) {
                textView4.setText(a(this.f14398b.getResponse().getTransactionTime().longValue()));
                textView3.setText(this.f14398b.getResponse().getPrimaryMessage());
                if (this.f14398b.getResponse().getIoclTxnNo() == null || TextUtils.isEmpty(this.f14398b.getResponse().getIoclTxnNo())) {
                    textView6.setVisibility(8);
                } else {
                    String ioclTxnNo = this.f14398b.getResponse().getIoclTxnNo();
                    textView6.setText(getString(R.string.iocl_txn_id) + " " + ioclTxnNo);
                    textView6.setVisibility(0);
                }
                String format = String.format("%.2f", new Object[]{this.f14398b.getResponse().getTransactionPoints()});
                if (this.f14398b.getResponse().getRedeemStatus().equalsIgnoreCase("SUCCESS")) {
                    this.f14401e = "success";
                    imageView.setBackground(b.a((Context) this, R.drawable.success_green_icon));
                    textView.setText(String.format(getString(R.string.iocl_status_text), new Object[]{format, getString(R.string.iocl_successful)}));
                    textView2.setText(new DecimalFormat("#,###.##").format(this.f14398b.getResponse().getTransactionAmount()));
                    if (this.f14398b.getResponse().getUpdatedWalletBalance() != null) {
                        textView5.setText(getString(R.string.iocl_updated_wallet_balance) + String.valueOf(this.f14398b.getResponse().getUpdatedWalletBalance()));
                ...
                } else if (this.f14398b.getResponse().getRedeemStatus().equalsIgnoreCase("PENDING")) {
                    this.f14401e = "pending_" + this.f14398b.getResponse().getPrimaryMessage();
                    imageView.setBackground(b.a((Context) this, R.drawable.iocl_ic_pending));
                    textView.setText(String.format(getString(R.string.iocl_status_text), new Object[]{format, getString(R.string.iocl_pending)}));
                ...
                } else if (this.f14398b.getResponse().getRedeemStatus().equalsIgnoreCase("FAILURE")) {
                    this.f14401e = "failed_" + this.f14398b.getResponse().getPrimaryMessage();
                    imageView.setBackground(b.a((Context) this, R.drawable.iocl_ic_failed));
                    textView.setText(String.format(getString(R.string.iocl_status_text), new Object[]{format, getString(R.string.iocl_failed)}));
                    findViewById.setVisibility(8);
                    textView5.setVisibility(8);
                    findViewById4.setVisibility(4);
                    findViewById2.setVisibility(8);
            ...
            c.a aVar = c.f14416a;
            c.a.a(this, "iocl_xtrarewards", "redemption_screen_loaded", "/iocl-xtrarewards-redemption", this.f14401e);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
    ...
    private void b() {
        if (!this.f14402f) {
            Intent intent = new Intent(this, a.b().getCSTOrderIssuesActivity());
            ...
            intent.putExtra(UpiConstants.INTENT_EXTRA_CST_ORDER_ITEM, (Serializable) null);
            intent.putExtra(UpiConstants.INTENT_EXTRA_CST_ORDER_REASONS, cJRReplacementReason);
            startActivity(intent);
