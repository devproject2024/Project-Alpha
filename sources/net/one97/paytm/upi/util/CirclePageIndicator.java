...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (!isInEditMode()) {
            ...
            int color2 = resources.getColor(R.color.upi_paytm_blue);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.mCurrentPage = savedState.f69509a;
        this.mSnapPage = savedState.f69509a;
        requestLayout();
    }

    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f69509a = this.mCurrentPage;
        return savedState;
    }
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        private SavedState(Parcel parcel) {
            super(parcel);
            this.f69509a = parcel.readInt();
        }

        public void writeToParcel(Parcel parcel, int i2) {
            super.writeToParcel(parcel, i2);
            parcel.writeInt(this.f69509a);
        }
    }
