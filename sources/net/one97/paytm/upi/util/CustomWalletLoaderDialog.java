...
public class CustomWalletLoaderDialog {
    ...
    public void showLoader() {
        ...
        if (dialog2 == null || !dialog2.isShowing()) {
            ...
            if (!(view == null || view.findViewById(R.id.wallet_loader) == null)) {
                AnimationFactory.startWalletLoader((LottieAnimationView) this.mProgressView.findViewById(R.id.wallet_loader));
            }
    ...
    public void dismissLoader() {
        ...
        if (dialog2 != null && dialog2.isShowing()) {
            View view = this.mProgressView;
            if (!(view == null || view.findViewById(R.id.wallet_loader) == null)) {
                AnimationFactory.stopWalletLoader((LottieAnimationView) this.mProgressView.findViewById(R.id.wallet_loader));
            }
            this.dialog.dismiss();
        }
    }
