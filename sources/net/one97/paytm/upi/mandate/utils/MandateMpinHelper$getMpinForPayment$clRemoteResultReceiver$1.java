...
public final class MandateMpinHelper$getMpinForPayment$clRemoteResultReceiver$1 extends ResultReceiver {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ i f67385a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MandateMpinHelper$getMpinForPayment$clRemoteResultReceiver$1(i iVar, Handler handler) {
        super(handler);
        this.f67385a = iVar;
    }
