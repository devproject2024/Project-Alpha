...
class SetMPINPresenter$4 extends ResultReceiver {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ String f67995a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ d f67996b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SetMPINPresenter$4(d dVar, Handler handler, String str) {
        super(handler);
        this.f67996b = dVar;
        this.f67995a = str;
    }
    ...
    public void onReceiveResult(int i2, Bundle bundle) {
        ...
        if (string == null || string.isEmpty()) {
            ...
            dVar2.f68033c.a((List<GetCredentialsResponse>) arrayList, str);
            return;
        }
        try {
