...
final class f {
    ...
    private static final Matrix f19744c = new Matrix();

    /* renamed from: a  reason: collision with root package name */
    final a f19745a;

    /* renamed from: b  reason: collision with root package name */
    final PointF f19746b = new PointF();

    /* renamed from: d  reason: collision with root package name */
    private final float f19747d;

    /* renamed from: e  reason: collision with root package name */
    private final float f19748e;

    /* renamed from: f  reason: collision with root package name */
    private final float f19749f;

    /* renamed from: g  reason: collision with root package name */
    private final float f19750g;
    ...
    public f(net.one97.paytm.paymentsBank.widget.croptool.f.a r2, net.one97.paytm.paymentsBank.widget.croptool.e r3, float r4, float r5) {
        /*
            r1 = this;
            r1.<init>()
            ...
            int[] r3 = net.one97.paytm.paymentsBank.widget.croptool.f.AnonymousClass1.f19751a
            net.one97.paytm.paymentsBank.widget.croptool.f$a r0 = r1.f19745a
            int r0 = r0.ordinal()
            r3 = r3[r0]
            r0 = 0
            switch(r3) {
        ...
        L_0x006c:
            float r2 = r2 - r5
        L_0x006d:
            android.graphics.PointF r3 = r1.f19746b
            r3.x = r0
            r3.y = r2
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.paymentsBank.widget.croptool.f.<init>(net.one97.paytm.paymentsBank.widget.croptool.f$a, net.one97.paytm.paymentsBank.widget.croptool.e, float, float):void");
    }
    ...
    public final void a(RectF rectF, float f2, RectF rectF2, float f3, float f4, boolean z, boolean z2) {
        if (f2 < 0.0f) {
            f2 /= 1.05f;
            this.f19746b.x -= f2 / 1.1f;
        }
        if (f2 < rectF2.left) {
            this.f19746b.x -= (f2 - rectF2.left) / 2.0f;
        }
        if (f2 - rectF2.left < f3) {
            f2 = rectF2.left;
        }
        if (rectF.right - f2 < this.f19747d) {
            f2 = rectF.right - this.f19747d;
        }
        if (rectF.right - f2 > this.f19749f) {
            f2 = rectF.right - this.f19749f;
        }
        if (f2 - rectF2.left < f3) {
            f2 = rectF2.left;
        }
        if (f4 > 0.0f) {
            ...
            if (f5 < this.f19748e) {
                f2 = Math.max(rectF2.left, rectF.right - (this.f19748e * f4));
                f5 = (rectF.right - f2) / f4;
            }
            if (f5 > this.f19750g) {
                f2 = Math.max(rectF2.left, rectF.right - (this.f19750g * f4));
                f5 = (rectF.right - f2) / f4;
            }
            if (!z || !z2) {
    ...
    public final void a(RectF rectF, float f2, RectF rectF2, int i2, float f3, float f4, boolean z, boolean z2) {
        ...
        if (f2 > f5) {
            f2 = ((f2 - f5) / 1.05f) + f5;
            this.f19746b.x -= (f2 - f5) / 1.1f;
        }
        if (f2 > rectF2.right) {
            this.f19746b.x -= (f2 - rectF2.right) / 2.0f;
        }
        if (rectF2.right - f2 < f3) {
            f2 = rectF2.right;
        }
        if (f2 - rectF.left < this.f19747d) {
            f2 = rectF.left + this.f19747d;
        }
        if (f2 - rectF.left > this.f19749f) {
            f2 = rectF.left + this.f19749f;
        }
        if (rectF2.right - f2 < f3) {
            f2 = rectF2.right;
        }
        if (f4 > 0.0f) {
            ...
            if (f6 < this.f19748e) {
                f2 = Math.min(rectF2.right, rectF.left + (this.f19748e * f4));
                f6 = (f2 - rectF.left) / f4;
            }
            if (f6 > this.f19750g) {
                f2 = Math.min(rectF2.right, rectF.left + (this.f19750g * f4));
                f6 = (f2 - rectF.left) / f4;
            }
            if (!z || !z2) {
    ...
    public final void b(RectF rectF, float f2, RectF rectF2, float f3, float f4, boolean z, boolean z2) {
        if (f2 < 0.0f) {
            f2 /= 1.05f;
            this.f19746b.y -= f2 / 1.1f;
        }
        if (f2 < rectF2.top) {
            this.f19746b.y -= (f2 - rectF2.top) / 2.0f;
        }
        if (f2 - rectF2.top < f3) {
            f2 = rectF2.top;
        }
        if (rectF.bottom - f2 < this.f19748e) {
            f2 = rectF.bottom - this.f19748e;
        }
        if (rectF.bottom - f2 > this.f19750g) {
            f2 = rectF.bottom - this.f19750g;
        }
        if (f2 - rectF2.top < f3) {
            f2 = rectF2.top;
        }
        if (f4 > 0.0f) {
            ...
            if (f5 < this.f19747d) {
                f2 = Math.max(rectF2.top, rectF.bottom - (this.f19747d / f4));
                f5 = (rectF.bottom - f2) * f4;
            }
            if (f5 > this.f19749f) {
                f2 = Math.max(rectF2.top, rectF.bottom - (this.f19749f / f4));
                f5 = (rectF.bottom - f2) * f4;
            }
            if (!z || !z2) {
    ...
    public final void b(RectF rectF, float f2, RectF rectF2, int i2, float f3, float f4, boolean z, boolean z2) {
        ...
        if (f2 > f5) {
            f2 = ((f2 - f5) / 1.05f) + f5;
            this.f19746b.y -= (f2 - f5) / 1.1f;
        }
        if (f2 > rectF2.bottom) {
            this.f19746b.y -= (f2 - rectF2.bottom) / 2.0f;
        }
        if (rectF2.bottom - f2 < f3) {
            f2 = rectF2.bottom;
        }
        if (f2 - rectF.top < this.f19748e) {
            f2 = rectF.top + this.f19748e;
        }
        if (f2 - rectF.top > this.f19750g) {
            f2 = rectF.top + this.f19750g;
        }
        if (rectF2.bottom - f2 < f3) {
            f2 = rectF2.bottom;
        }
        if (f4 > 0.0f) {
            ...
            if (f6 < this.f19747d) {
                f2 = Math.min(rectF2.bottom, rectF.top + (this.f19747d / f4));
                f6 = (f2 - rectF.top) * f4;
            }
            if (f6 > this.f19749f) {
                f2 = Math.min(rectF2.bottom, rectF.top + (this.f19749f / f4));
                f6 = (f2 - rectF.top) * f4;
            }
            if (!z || !z2) {
