...
public final class a extends f implements View.OnClickListener {
    ...
    private EditText f55433f;

    /* renamed from: g  reason: collision with root package name */
    private TextInputLayout f55434g;

    /* renamed from: h  reason: collision with root package name */
    private ImageView f55435h;

    /* renamed from: i  reason: collision with root package name */
    private HashMap f55436i;
    ...
    public final android.view.View onCreateView(android.view.LayoutInflater r5, android.view.ViewGroup r6, android.os.Bundle r7) {
        /*
            ...
            int r7 = net.one97.paytm.moneytransfer.R.layout.mt_confirm_bank_account_bottom_sheet
            r0 = 0
            ...
            java.lang.String r3 = r4.f55431d
            java.lang.CharSequence r3 = (java.lang.CharSequence) r3
            r2.setText(r3)
        L_0x0071:
            if (r6 == 0) goto L_0x007a
            java.lang.String r2 = r4.f55430c
            java.lang.CharSequence r2 = (java.lang.CharSequence) r2
            r6.setText(r2)
        L_0x007a:
            if (r7 == 0) goto L_0x0083
            java.lang.String r6 = r4.f55430c
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6
            r7.setText(r6)
        L_0x0083:
            if (r1 == 0) goto L_0x008c
            java.lang.String r6 = r4.f55429b
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6
            r1.setText(r6)
        L_0x008c:
            java.lang.String r6 = r4.f55428a
            ...
            int r6 = r6.length()
            if (r6 != 0) goto L_0x00c6
            android.widget.EditText r6 = r4.f55433f
        ...
        L_0x00dd:
            ...
            android.widget.ImageView r6 = r4.f55435h
            if (r6 == 0) goto L_0x00f1
            r6.setVisibility(r0)
        L_0x00f1:
            java.lang.String r6 = r4.f55429b
            if (r6 == 0) goto L_0x0196
            android.widget.ImageView r7 = r4.f55435h
        ...
        L_0x0196:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: net.one97.paytm.moneytransferv4.home.presentation.a.a.onCreateView(android.view.LayoutInflater, android.view.ViewGroup, android.os.Bundle):android.view.View");
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        if (onCreateDialog != null) {
            ...
            aVar.setOnShowListener(new C1025a(this));
            return aVar;
        }
        throw new u("null cannot be cast to non-null type com.google.android.material.bottomsheet.BottomSheetDialog");
    }

    /* renamed from: net.one97.paytm.moneytransferv4.home.presentation.a.a$a  reason: collision with other inner class name */
    static final class C1025a implements DialogInterface.OnShowListener {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ a f55437a;
        ...
        public final void onShow(DialogInterface dialogInterface) {
            if (dialogInterface != null) {
                ...
                if (frameLayout != null) {
                    frameLayout.setBackgroundColor(this.f55437a.getResources().getColor(R.color.transparent));
                }
                if (frameLayout != null) {
    ...
    public final void onClick(View view) {
        if (view != null && view.getId() == R.id.cross_iv) {
            ...
            EditText editText = this.f55433f;
            String valueOf = String.valueOf(editText != null ? editText.getText() : null);
            if (TextUtils.isEmpty(valueOf)) {
                TextInputLayout textInputLayout = this.f55434g;
                if (textInputLayout != null) {
                    textInputLayout.setError(getString(R.string.money_transfer_re_entr_acc_no));
                }
            } else if (valueOf.equals(this.f55428a)) {
                ...
                if (activity != null) {
                    ...
                    net.one97.paytm.moneytransferv4.a.a.a a2 = a.C0982a.a(PaymentManager.a(str, str2, str3, str4, (String) null, (String) null, str5, 112), activity, 12);
                    k.a((Object) activity, "it");
                    m.a(R.id.container, (Fragment) a2, "BeneficiaryHistoryFragment", activity.getSupportFragmentManager());
                }
            } else {
                TextInputLayout textInputLayout2 = this.f55434g;
                if (textInputLayout2 != null) {
                    textInputLayout2.setError(getString(R.string.bank_account_different_text));
                }
            }
            net.one97.paytm.moneytransfer.utils.f.a(getContext(), "mt_p2p_new_v1", CJRGTMConstants.MT_V4_CONFIRM_CLICKED, CJRGTMConstants.MT_V4_TO_BANK_AACCOUNT_SCREEN_NAME, String.valueOf(m.b(getContext())), "");
        }
    }

    public final /* synthetic */ void onDestroyView() {
        super.onDestroyView();
        HashMap hashMap = this.f55436i;
        if (hashMap != null) {
            hashMap.clear();
        }
    }
