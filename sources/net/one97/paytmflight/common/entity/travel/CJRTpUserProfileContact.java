...
public class CJRTpUserProfileContact implements Cloneable, IJRDataModel {
    ...
    private String birth_country_displayname;
    ...
    private String nationality_displayname;
    private String passport_country;
    private String passport_country_code;
    private String passport_country_displayname;
    ...
    public String getPassport_country_code() {
        return this.passport_country_code;
    }

    public void setPassport_country_code(String str) {
        this.passport_country_code = str;
    }
    ...
    public String getPassport_country_displayname() {
        return this.passport_country_displayname;
    }

    public void setPassport_country_displayname(String str) {
        this.passport_country_displayname = str;
    }

    public String getNationality_displayname() {
        return this.nationality_displayname;
    }

    public void setNationality_displayname(String str) {
        this.nationality_displayname = str;
    }

    public String getBirth_country_displayname() {
        return this.birth_country_displayname;
    }

    public void setBirth_country_displayname(String str) {
        this.birth_country_displayname = str;
    }
}
