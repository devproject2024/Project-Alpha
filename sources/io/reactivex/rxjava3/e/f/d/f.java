...
public final class f<T, R> extends p<R> {
    ...
    final h<? super T, ? extends n<? extends R>> f46895b;

    /* renamed from: c  reason: collision with root package name */
    final boolean f46896c;

    public f(p<T> pVar, h<? super T, ? extends n<? extends R>> hVar, boolean z) {
        this.f46894a = pVar;
        this.f46895b = hVar;
        this.f46896c = z;
    }
    ...
    public final void subscribeActual(w<? super R> wVar) {
        if (!h.a((Object) this.f46894a, this.f46895b, wVar)) {
            this.f46894a.subscribe(new a(wVar, this.f46895b, this.f46896c));
        }
    }

    static final class a<T, R> extends AtomicInteger implements w<T>, c {
        static final C0799a<Object> INNER_DISPOSED = new C0799a<>((a) null);
        ...
        final AtomicReference<C0799a<R>> inner = new AtomicReference<>();
        ...
        public final void disposeInner() {
            C0799a<Object> andSet = this.inner.getAndSet(INNER_DISPOSED);
        ...
        /* access modifiers changed from: package-private */
        public final void innerError(C0799a<R> aVar, Throwable th) {
        ...
        /* access modifiers changed from: package-private */
        public final void innerComplete(C0799a<R> aVar) {
            if (this.inner.compareAndSet(aVar, (Object) null)) {
                drain();
            }
        }
        ...
        public final void drain() {
            if (getAndIncrement() == 0) {
                ...
                AtomicReference<C0799a<R>> atomicReference = this.inner;
                int i2 = 1;
                while (!this.cancelled) {
                    if (cVar.get() == null || this.delayErrors) {
                        boolean z = this.done;
                        C0799a aVar = atomicReference.get();
        ...
        /* renamed from: io.reactivex.rxjava3.e.f.d.f$a$a  reason: collision with other inner class name */
        static final class C0799a<R> extends AtomicReference<c> implements m<R> {
