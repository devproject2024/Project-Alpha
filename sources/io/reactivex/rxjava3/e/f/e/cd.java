...
public final class cd<T> extends a<T, T> {
    ...
    final n<? extends T> f47156b;

    public cd(p<T> pVar, n<? extends T> nVar) {
        super(pVar);
        this.f47156b = nVar;
    }
    ...
    public final void subscribeActual(w<? super T> wVar) {
        ...
        this.f47156b.a(aVar.otherObserver);
    }
    ...
    static final class a<T> extends AtomicInteger implements w<T>, c {
        ...
        final C0809a<T> otherObserver = new C0809a<>(this);
        ...
        /* renamed from: io.reactivex.rxjava3.e.f.e.cd$a$a  reason: collision with other inner class name */
        static final class C0809a<T> extends AtomicReference<c> implements m<T> {
