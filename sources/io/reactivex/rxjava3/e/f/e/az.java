...
public final class az<T, R> extends a<T, R> {
    ...
    final h<? super T, ? extends ac<? extends R>> f47026b;

    /* renamed from: c  reason: collision with root package name */
    final boolean f47027c;

    public az(u<T> uVar, h<? super T, ? extends ac<? extends R>> hVar, boolean z) {
        super(uVar);
        this.f47026b = hVar;
        this.f47027c = z;
    }
    ...
    public final void subscribeActual(w<? super R> wVar) {
        this.f46900a.subscribe(new a(wVar, this.f47026b, this.f47027c));
    }
    ...
    static final class a<T, R> extends AtomicInteger implements w<T>, c {
        ...
        /* renamed from: io.reactivex.rxjava3.e.f.e.az$a$a  reason: collision with other inner class name */
        final class C0807a extends AtomicReference<c> implements aa<R>, c {
