...
public final class cy<T> extends a<T, T> {
    ...
    final h<? super p<Throwable>, ? extends u<?>> f47231b;

    public cy(u<T> uVar, h<? super p<Throwable>, ? extends u<?>> hVar) {
        super(uVar);
        this.f47231b = hVar;
    }
    ...
    public final void subscribeActual(w<? super T> wVar) {
        e e2 = b.a().e();
        try {
            u uVar = (u) Objects.requireNonNull(this.f47231b.apply(e2), "The handler returned a null ObservableSource");
    ...
    static final class a<T> extends AtomicInteger implements w<T>, c {
        ...
        final a<T>.defpackage.a inner = new C0812a();
        final e<Throwable> signaller;
        final u<T> source;
        final AtomicReference<c> upstream = new AtomicReference<>();
        final AtomicInteger wip = new AtomicInteger();

        a(w<? super T> wVar, e<Throwable> eVar, u<T> uVar) {
        ...
        public final void onSubscribe(c cVar) {
            io.reactivex.rxjava3.e.a.c.replace(this.upstream, cVar);
        }
        ...
        /* renamed from: io.reactivex.rxjava3.e.f.e.cy$a$a  reason: collision with other inner class name */
        final class C0812a extends AtomicReference<c> implements w<Object> {
